...
namespace UFIDA.U9.Cust.ChuangYeRenBillImportBP.OtherBillImportBP
{
    ...
    public class TransferFormImportStub : OperationStubBase, ITransferFormImport
    {
        #region ITransferFormImport Members
        ...
        public PublicDataTransObj.PublicReturnDTOData DoEx(ICommonDataContract commonData, System.Int64 iD)
        {
            ...
            try
            {
                BeforeInvoke("UFIDA.U9.Cust.ChuangYeRenBillImportBP.OtherBillImportBP.TransferFormImport");                
                TransferFormImport objectRef = new TransferFormImport();
				...
				DoSerializeKey(resultdata, "UFIDA.U9.Cust.ChuangYeRenBillImportBP.OtherBillImportBP.TransferFormImport");
				return resultdata;
            ...
            {
				FinallyInvoke("UFIDA.U9.Cust.ChuangYeRenBillImportBP.OtherBillImportBP.TransferFormImport");
            }
        }
	#endregion
    }
