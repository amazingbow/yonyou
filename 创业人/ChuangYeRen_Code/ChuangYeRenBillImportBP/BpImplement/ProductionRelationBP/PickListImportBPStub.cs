...
namespace UFIDA.U9.Cust.ChuangYeRenBillImportBP.ProductionRelationBP
{
    ...
    public class PickListImportBPStub : OperationStubBase, IPickListImportBP
    {
        #region IPickListImportBP Members
        ...
        public PublicDataTransObj.PublicReturnDTOData DoEx(ICommonDataContract commonData, System.Int64 relationId, System.Int64 productionId)
        {
            ...
            try
            {
                BeforeInvoke("UFIDA.U9.Cust.ChuangYeRenBillImportBP.ProductionRelationBP.PickListImportBP");                
                PickListImportBP objectRef = new PickListImportBP();
				...
				DoSerializeKey(resultdata, "UFIDA.U9.Cust.ChuangYeRenBillImportBP.ProductionRelationBP.PickListImportBP");
				return resultdata;
            ...
            {
				FinallyInvoke("UFIDA.U9.Cust.ChuangYeRenBillImportBP.ProductionRelationBP.PickListImportBP");
            }
        }
	#endregion
    }
