...
namespace UFIDA.U9.Cust.XMQX.LaserLabScrapUI.LaserLabScrapUIModel
{
    public partial class LaserLabScrapUIFromWebPart
    {
		...
		//MethodName:TabControl2_SelectedIndexChanged ActionName:
        /// <summary>
        ...
        public void TabControl2_SelectedIndexChanged(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,TabControl2_SelectedIndexChanged_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void TabControl2_SelectedIndexChanged_DefaultImpl(object sender, EventArgs e)
        {
        ...
        private void BtnClear_Click_DefaultImpl(object sender, EventArgs e)
        {
			...
			//throw new NotImplementedException() ;
				...
				//MethodName:BtnReturnMaster_Click ActionName:
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void BtnReturnMaster_Click(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,BtnReturnMaster_Click_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void BtnReturnMaster_Click_DefaultImpl(object sender, EventArgs e)
        {
			//Template (tpl) Code here...
