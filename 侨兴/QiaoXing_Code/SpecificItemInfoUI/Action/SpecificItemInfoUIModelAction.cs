/**************************************************************
 * Description:
 * SpecificItemInfoUIModelAction.cs
 * Product: U9
 * Co.    : UFIDA Group
...
{
	public partial class SpecificItemInfoUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(SpecificItemInfoUIModelAction));
		//强类型化基类Model属性.
		public new SpecificItemInfoUIModelModel CurrentModel 
		{
			get {
				return (SpecificItemInfoUIModelModel)base.CurrentModel;
			}
			set {
		...
		public SpecificItemInfoUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public SpecificItemInfoUIModelAction(SpecificItemInfoUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 
