...
{
    public partial class AdvApplyListBListUIModelAction
    {
        ...
        {
            string dataId = this.CurrentModel.AdvApplyBE.FocusedRecord["mainid"].ToString();
            OnNavigatCard("Browse", dataId, "UFIDA.U9.Cust.AdvApplyUI.AdvApplyURI");	
        ...
        {
            this.CurrentPart.NavigatePage("UFIDA.U9.Cust.AdvApplyUI.AdvApplyURI", null);
            //调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
