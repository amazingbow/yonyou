...
{
	public partial class SpecialApplyUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(SpecialApplyUIModelAction));
		//强类型化基类Model属性.
		public new SpecialApplyUIModelModel CurrentModel 
		{
			get {
				return (SpecialApplyUIModelModel)base.CurrentModel;
			}
			set {
		...
		public SpecialApplyUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public SpecialApplyUIModelAction(SpecialApplyUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 
		...
		/// Help: 弃审
		/// </summary>
		public void UndoApprove(object sender, UIActionEventArgs e)
		{
			//调用基类委托..
			this.InvokeAction(sender,e,this.UndoApprove_Extend);
		}
		private void UndoApprove_DefaultImpl(object sender, UIActionEventArgs e)
		{
