...
{
	public partial class AdvApplyBE:IStateMachineEntity
	{
		private AdvApplyBEStateMachine _statemachineInstance;
		private static object _lockObject=new object();
		public AdvApplyBEStateMachine StateMachineInstance
		{
			get
			{
				if (_statemachineInstance == null)
				{
					lock(_lockObject)
					{
						if(_statemachineInstance==null)
						{
							_statemachineInstance = new AdvApplyBEStateMachine(this);
						}
					}
				}
		...
		public partial class AdvApplyBEStateMachine:EntityStateMachine
		{
			public AdvApplyBEStateMachine(AdvApplyBE entity)
			{
				_entity = entity;
			}
			public enum State
			...
			#region Properties
			private AdvApplyBE _entity;
			protected AdvApplyBE Entity
			{
				get
				{
					return _entity;
			...
			public void OpenLState_SubmitEventDriven(UFIDA.U9.Cust.SeeBestAdvertisementBE.AdvertisementApplyBE.SubmitEvent ev)
			{
				...
				else 
				{
				    ...
				    {
				        UFSoft.UBF.PL.EntityBeenModifiedException e = new UFSoft.UBF.PL.EntityBeenModifiedException("34b34c55-0b84-4313-8595-ec236b56752e","已经被其他人操作并保存，当前操作不能保存。");
				        throw e;
				    }
				}
			}
			...
			public void ApprovedState_UndoApproveEventDriven(UFIDA.U9.Cust.SeeBestAdvertisementBE.AdvertisementApplyBE.UndoApproveEvent ev)
			{
