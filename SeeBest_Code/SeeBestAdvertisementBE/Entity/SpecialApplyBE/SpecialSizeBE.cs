...
namespace UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE
{
	...
	/// </summary>
	[Serializable]	
	public  partial class SpecialSizeBE : UFSoft.UBF.Business.BusinessEntity
	{
		...
		public  static SpecialSizeBE Create(UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialApplyBE parentEntity) {
			SpecialSizeBE entity = (SpecialSizeBE)UFSoft.UBF.Business.Entity.Create(CurrentClassKey, parentEntity);
			if (parentEntity == null)
				throw new ArgumentNullException("parentEntity");
			entity.SpecialApplyBE = parentEntity ;
			parentEntity.SpecialSizeBE.Add(entity) ;
			return entity;
		}
		...
		/// </summary>
		protected SpecialSizeBE(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			:base(info,context)
		{
		}
		...
		public  static SpecialSizeBE CreateDefault(UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialApplyBE parentEntity) {
		#if Test		
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialSizeBE");
			}
		}
		...
		#region EntityKey
		/// <summary>
		/// Strong Class SpecialSizeBE EntityKey 
		/// </summary>
		[Serializable()]
	    [DataContract(Name = "EntityKey", Namespace = "UFSoft.UBF.Business.BusinessEntity")]
		public new partial class EntityKey : UFSoft.UBF.Business.BusinessEntity.EntityKey
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialSizeBE")
			{}
			...
			/// </summary>
			public new SpecialSizeBE GetEntity()
			{
				return (SpecialSizeBE)base.GetEntity();
			}
		...
		/// </summary>
		public new partial class EntityFinder : UFSoft.UBF.Business.BusinessEntity.EntityFinder<SpecialSizeBE> 
		{
		...
		/// EntityList
		/// </summary>
		public partial class EntityList :UFSoft.UBF.Business.Entity.EntityList<SpecialSizeBE>{
		    #region constructor 
		    /// <summary>
		...
		{
		    //private SpecialSizeBE ContainerEntity ;
		    public  new SpecialSizeBE ContainerEntity 
		    {
				get { return  (SpecialSizeBE)base.ContainerEntity ;}
				set { base.ContainerEntity = value ;}
		    }
		    
		    public EntityOriginal(SpecialSizeBE container)
		    {
				if (container == null )
			...
			/// <summary>
			///  OrginalData属性。只可读。
			/// 展示产品类型 (该属性不可为空,且无默认值)
			/// 专柜尺寸.Misc.展示产品类型
			/// </summary>
			/// <value></value>
			public  UFIDA.U9.Base.FlexField.ValueSet.DefineValue DisplayProductType
			{
				get
				{
					if (DisplayProductTypeKey == null)
						return null ;
					UFIDA.U9.Base.FlexField.ValueSet.DefineValue value =  (UFIDA.U9.Base.FlexField.ValueSet.DefineValue)DisplayProductTypeKey.GetEntity();
					return value ;
				}
			}
   		...
   		private UFIDA.U9.Base.FlexField.ValueSet.DefineValue.EntityKey m_DisplayProductTypeKey ;
		/// <summary>
		/// EntityKey 属性
		/// 展示产品类型 的Key (该属性不可为空,且无默认值)
		/// 专柜尺寸.Misc.展示产品类型
		/// </summary>
		/// <value></value>
		public  UFIDA.U9.Base.FlexField.ValueSet.DefineValue.EntityKey DisplayProductTypeKey
		{
			get 
			{
				object obj = base.GetValue("DisplayProductType") ;
				if (obj == null || (Int64)obj==UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag || (Int64)obj==0)
					return null ;
				Int64 key = (System.Int64)obj ;
				if (m_DisplayProductTypeKey==null || m_DisplayProductTypeKey.ID != key )
					m_DisplayProductTypeKey = new UFIDA.U9.Base.FlexField.ValueSet.DefineValue.EntityKey(key); 
				return m_DisplayProductTypeKey ;
			}
		}
			...
			/// </summary>
			/// <value></value>
			public  UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialApplyBE SpecialApplyBE
			{
				get
				{
					if (SpecialApplyBEKey == null)
						return null ;
					UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialApplyBE value =  (UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialApplyBE)SpecialApplyBEKey.GetEntity();
					return value ;
				}
			}
   		...
   		private UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialApplyBE.EntityKey m_SpecialApplyBEKey ;
		/// <summary>
		/// EntityKey 属性
		/// 专柜申请单 的Key (该属性可为空,且无默认值)
		/// 专柜尺寸.Misc.专柜申请单
		/// </summary>
		/// <value></value>
		public  UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialApplyBE.EntityKey SpecialApplyBEKey
		{
			get 
			{
				object obj = base.GetValue("SpecialApplyBE") ;
				if (obj == null || (Int64)obj==UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag || (Int64)obj==0)
					return null ;
				Int64 key = (System.Int64)obj ;
				if (m_SpecialApplyBEKey==null || m_SpecialApplyBEKey.ID != key )
					m_SpecialApplyBEKey = new UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialApplyBE.EntityKey(key); 
				return m_SpecialApplyBEKey ;
			}
		}
			...
			public  UFIDA.U9.Base.FlexField.ValueSet.DefineValue DisplayProductType
		{
			get
			{
				object  obj = this.GetRelation("DisplayProductType");
				if (obj == null)
				{
					return null ;
				}
				...
				set
			{
				...
				this.SetRelation("DisplayProductType", value);
		...
		public  UFIDA.U9.Base.FlexField.ValueSet.DefineValue.EntityKey DisplayProductTypeKey
		{
			...
			set
			{	
				if (DisplayProductTypeKey==value)
					return ;
				this.SetRelation("DisplayProductType", null);
				m_DisplayProductTypeKey = value ;
				if (value != null) 
				{
					base.SetValue("DisplayProductType",value.ID);
				}
				else
					base.SetValue("DisplayProductType",UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag);
			}
		}
			...
			public  UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialApplyBE SpecialApplyBE
		{
			get
			{
				object  obj = this.GetRelation("SpecialApplyBE");
				if (obj == null)
				{
					return null ;
				}
				...
				{
					UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialApplyBE value  = (UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialApplyBE)obj;
					return value;
				 }
			}
				internal set
			{
				...
				this.SetRelation("SpecialApplyBE", value);
		...
		public  UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialApplyBE.EntityKey SpecialApplyBEKey
		{
			...
			set
			{	
				if (SpecialApplyBEKey==value)
					return ;
				this.SetRelation("SpecialApplyBE", null);
				m_SpecialApplyBEKey = value ;
				if (value != null) 
				{
					base.SetValue("SpecialApplyBE",value.ID);
				}
				else
					base.SetValue("SpecialApplyBE",UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag);
			}
		}
		...
		/// </summary>
		[Obsolete("")]
		public  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialSizeBE")  ;}	}
		#endregion 		
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("DisplayProductType")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_DisplayProductType　{ get { return EntityRes.GetResource("DisplayProductType");　}　}
		/// <summary>
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("SpecialApplyBE")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_SpecialApplyBE　{ get { return EntityRes.GetResource("SpecialApplyBE");　}　}
		/// <summary>
		...
		public class EntityRes
		{
			...
			/// EntityName的名称
			/// </summary>
			public static string BE_Name { get { return "SpecialSizeBE";　}　}
			
			/// <summary>
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialSizeBE";　}　}
			...
			/// 属性: 展示产品类型 的名称
			/// </summary>
			public static string DisplayProductType　{ get { return "DisplayProductType";　}　}
			...
			/// 属性: 专柜申请单 的名称
			/// </summary>
			public static string SpecialApplyBE　{ get { return "SpecialApplyBE";　}　}
        ...
        public override void IniData()
        {
			...
			this.exdMultiLangAttrs.Add("DisplayProductType","DisplayProductType");
			...
			this.exdMultiLangAttrs.Add("SpecialApplyBE","SpecialApplyBE");
		...
		private void DeSerializeKey(SpecialSizeBEData data)
		{
			...
			if (data.DisplayProductType == -1 && data.DisplayProductType_SKey!=null)
				data.DisplayProductType = data.DisplayProductType_SKey.GetEntity().ID ;
        ...
        {
			SpecialSizeBEData data = dto as SpecialSizeBEData ;
			if (data == null)
				return ;
		...
		/// </summary>
		public void FromEntityData(SpecialSizeBEData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(SpecialSizeBEData data,IDictionary dict)
		{
			if (data == null)
				return;
			...
			//ID与系统字段不处理 --Sysversion需要处理。
								...
								this.SetTypeValue("DisplayProductType",data.DisplayProductType);
			...
			#region 组件内属性
					...
					if (data.SpecialApplyBE!=null)
			{
				UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialApplyBE child = dict[data.SpecialApplyBE] as UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialApplyBE ;
				if (child == null)
				{
					if (data.SpecialApplyBE.ID>0)
					{
						if (data.SpecialApplyBE.SysState != UFSoft.UBF.PL.Engine.ObjectState.Inserted)
							child = (UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialApplyBE)(new UFSoft.UBF.Business.BusinessEntity.EntityKey(data.SpecialApplyBE.ID,data.SpecialApplyBE.SysEntityType).GetEntity());
						if (child==null) child = (UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialApplyBE)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(data.SpecialApplyBE.SysEntityType,null,data.SpecialApplyBE.ID,true) ;
					}
					else
					{
 						child = (UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialApplyBE)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(data.SpecialApplyBE.SysEntityType,null,null,true) ;				
 					}
					
					child.FromEntityData(data.SpecialApplyBE,dict);
				}
				this.SpecialApplyBE = child ;
			}
		...
		/// </summary>
		public SpecialSizeBEData ToEntityData()
		{
		...
		/// </summary>
		public SpecialSizeBEData ToEntityData(SpecialSizeBEData data, IDictionary dict){
			if (data == null)
				data = new SpecialSizeBEData();
			
			if (dict == null ) dict = new Hashtable() ;
			//就直接用ID,如果不同实体会出现相同ID，则到时候要改进。? ID一定要有。
			dict["UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialSizeBE"+this.ID.ToString()] = data;
			...
			{
				object obj =this.GetValue("DisplayProductType");
				if (obj != null)
					data.DisplayProductType=(System.Int64)obj;
			}
			...
			{
				object oID = this.GetValue("SpecialApplyBE");
				if (oID != null && (Int64)oID > 0 )
				{
					UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialApplyBEData _SpecialApplyBE = dict["UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialApplyBE"+oID.ToString()] as UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialApplyBEData;			
					data.SpecialApplyBE = (_SpecialApplyBE != null) ? _SpecialApplyBE : (this.SpecialApplyBE==null?null:this.SpecialApplyBE.ToEntityData(null,dict));
				}
			}
	...
	//实体检验： 含自身检验器检验，内嵌属性类型的检验以及属性类型上的校验器的检验。
		...
		public override void SelfNullableVlidator()
		{
			...
			if (Convert.ToInt64(base.GetValue("DisplayProductType")) == UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag){
				UFSoft.UBF.Business.AttributeInValidException DisplayProductType_Exception = new UFSoft.UBF.Business.AttributeInValidException("UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SpecialSizeBE","DisplayProductType","9e3c22af-12bc-4e81-a646-b437823709ad");
