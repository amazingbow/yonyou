...
namespace UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.TestSuite{
	...
	/// <summary>
	/// SpecialApplyBE Auto Test Class
	/// </summary>
	[TestFixture]
	public partial class SpecialApplyBETest{
		/// <summary>
		/// test Create
		/// </summary>
		//[Test]
		public void SpecialApplyBECRUD() {
		/*	using (TransactionScope scope = new TransactionScope())
			{
				...
				using (ISession session = Session.Open()) {
					#region __merge RemoveSpecialApplyBE	
					obj.Remove();
