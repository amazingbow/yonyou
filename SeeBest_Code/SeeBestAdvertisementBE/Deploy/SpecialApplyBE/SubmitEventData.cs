...
namespace UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE
{
	...
	public partial class SubmitEventData : UFSoft.UBF.Eventing.EventData
	{
		...
		/// Default Constructor
		/// </summary>
		//public SubmitEventData():this("UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SubmitEvent,UFIDA.U9.Cust.SeeBestAdvertisementBE")
		//{
		//}
		...
		public override string EventType {
			get {
				return "UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SubmitEvent";
			}
		}
