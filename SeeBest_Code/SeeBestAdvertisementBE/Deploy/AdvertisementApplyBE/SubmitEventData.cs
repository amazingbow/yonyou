...
namespace UFIDA.U9.Cust.SeeBestAdvertisementBE.AdvertisementApplyBE
{
	...
	public partial class SubmitEventData : UFSoft.UBF.Eventing.EventData
	{
		...
		/// Default Constructor
		/// </summary>
		//public SubmitEventData():this("UFIDA.U9.Cust.SeeBestAdvertisementBE.AdvertisementApplyBE.SubmitEvent,UFIDA.U9.Cust.SeeBestAdvertisementBE")
		//{
		//}
		...
		public override string EventType {
			get {
				return "UFIDA.U9.Cust.SeeBestAdvertisementBE.AdvertisementApplyBE.SubmitEvent";
			}
		}
