...
/***********************************************************************************************
 * Form ID:21255ecd-ec88-445a-8fbf-2468d4c85d54 
 * Form Name:AdvApproveBListUIForm
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace UFIDA.U9.Cust.AdvApproveBListUIModel
{
	[FormRegister("UFIDA.U9.Cust.AdvApproveListUI","UFIDA.U9.Cust.AdvApproveBListUIModel.AdvApproveBListUIFormWebPart", "UFIDA.U9.Cust.AdvApproveListUI.WebPart", "21255ecd-ec88-445a-8fbf-2468d4c85d54","WebPart", "True", 992, 504)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.AdvApproveListUI', 'UFIDA.U9.Cust.AdvApproveBListUIModel.AdvApproveBListUIFormWebPart', 'UFIDA.U9.Cust.AdvApproveListUI.WebPart', '21255ecd-ec88-445a-8fbf-2468d4c85d54')
	///<siteMapNode url="~/erp/simple.aspx?lnk=21255ecd-ec88-445a-8fbf-2468d4c85d54" title="AdvApproveBListUIForm"/>
    public partial class AdvApproveBListUIFormWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(AdvApproveBListUIFormWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new AdvApproveBListUIModelAction Action
		{
			get { return (AdvApproveBListUIModelAction)base.Action; }
			set { base.Action = value; }
		}
		AdvApproveBListUIModelModel _uimodel=null;
		public new AdvApproveBListUIModelModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new AdvApproveBListUIModelModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as AdvApproveBListUIModelModel;
            }
        }
		#endregion 
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new AdvApproveBListUIModelModel();
				}
			...
			{
				//去除.已经移入到OnInit()中.
				//this.Model = (AdvApproveBListUIModelModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new AdvApproveBListUIModelAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"AdvApproveBListUIForm",true,992,504);
        ...
        private void _BuilderControl_Toolbar1(IUFContainer container)
        {
            ...
            ///foreach Toolbar下的所有控件，增加到此容器
                            this.BtnNew = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnNew", "True", "True", 35, 28,"1", "N",true,false,"19478b02-d2a9-4d7e-b7af-00070c61ff2d","19478b02-d2a9-4d7e-b7af-00070c61ff2d","46c7948a-e334-4d45-8fcf-7f25b9ddd827");
		
            UIControlBuilder.SetButtonAccessKey(this.BtnNew);
            this.BtnNew.UIModel = this.Model.ElementID;
            this.BtnNew.Action = "OnNew";
	                            this.BtnDelete = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnDelete", "True", "True", 35, 28,"2", "R",true,false,"0467218f-229b-4954-b2d4-3c5976467f76","0467218f-229b-4954-b2d4-3c5976467f76","1b716fae-d9ba-44f0-aadc-2c9704b625af");
            ...
            this.BtnDelete.Action = "OnDelete";
	                            _Toolbar.Controls.Add(new UFWebToolbarSeparatorAdapter());
			                            this.BtnOutPut = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnOutPut", "True", "True", 35, 28,"4", "O",true,false,"688fd549-5a92-49cc-8072-6d5377f6409a","688fd549-5a92-49cc-8072-6d5377f6409a","0c43c54b-a9ac-436f-9d63-fa11033e75ed");
            ...
            this.BtnOutPut.Action = "OnOutPut";
	                            this.BtnPrint = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnPrint", "True", "True", 35, 28,"5", "P",true,false,"27b5c615-cde5-458c-be74-833317249568","27b5c615-cde5-458c-be74-833317249568","5bd9f36b-16f7-4ef9-9e60-345716d19924");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card0",false,"FunctionBar", true, true, "3","","8b541952-4b55-41ea-bc46-b432ccf20e1e");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 80, 20, 13, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","74c4ee6f-5bf0-4edf-a4d6-11bdc06fbf43");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "2");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 120, 20, 15, 0, 1, 1, "100",true,false,"","","9b3bd308-7b68-4116-b8e5-7e50455b84fa");
			...
			UIControlBuilder.BuilderUFControl(this.DDLCase, "3");		
				...
				this.OnLookCase = UIControlBuilder.BuilderUFButton(_UFCard, true, "OnLookCase", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"OnLookCase",false,"83e58b60-7a75-4038-ba62-b721c2d0acea","83e58b60-7a75-4038-ba62-b721c2d0acea","b646bb0b-3abe-4e34-8107-aab34483327e");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card3",false,"none", true, true, "2","","ef85eed9-84e1-4712-aa1d-605568b06200");
		...
		{
			QryService.BindEnum("DDLCase", this, "5e7ff1a5-d073-45f0-a5ef-9b9f89c5531a");
		}
