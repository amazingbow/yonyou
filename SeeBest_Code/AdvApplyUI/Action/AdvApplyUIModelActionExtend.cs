...
{
    public partial class AdvApplyUIModelAction
    {
        ...
        {
            if (this.CurrentModel.AdvApplyBE.FocusedRecord != null)
            {
                ModifyAdvApplyStatusBPProxy proxy = new ModifyAdvApplyStatusBPProxy();
                proxy.ID = this.CurrentModel.AdvApplyBE.FocusedRecord.ID;
                proxy.SysVersion = this.CurrentModel.AdvApplyBE.FocusedRecord.SysVersion ?? 00;
