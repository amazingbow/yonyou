...
/***********************************************************************************************
 * Form ID:1b2ec0e6-2010-418e-b213-3b43ce9aa982 
 * Form Name:LaserLabQryBListUIForm
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace UFIDA.U9.Cust.XMQX.LaserQryUI.LaserLabQryBListUIModel
{
	[FormRegister("UFIDA.U9.Cust.XMQX.LaserQryUI","UFIDA.U9.Cust.XMQX.LaserQryUI.LaserLabQryBListUIModel.LaserLabQryBListUIFormWebPart", "UFIDA.U9.Cust.XMQX.LaserQryUI.WebPart", "1b2ec0e6-2010-418e-b213-3b43ce9aa982","WebPart", "True", 992, 504)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.XMQX.LaserQryUI', 'UFIDA.U9.Cust.XMQX.LaserQryUI.LaserLabQryBListUIModel.LaserLabQryBListUIFormWebPart', 'UFIDA.U9.Cust.XMQX.LaserQryUI.WebPart', '1b2ec0e6-2010-418e-b213-3b43ce9aa982')
	///<siteMapNode url="~/erp/simple.aspx?lnk=1b2ec0e6-2010-418e-b213-3b43ce9aa982" title="LaserLabQryBListUIForm"/>
    public partial class LaserLabQryBListUIFormWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(LaserLabQryBListUIFormWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new LaserLabQryBListUIModelAction Action
		{
			get { return (LaserLabQryBListUIModelAction)base.Action; }
			set { base.Action = value; }
		}
		LaserLabQryBListUIModelModel _uimodel=null;
		public new LaserLabQryBListUIModelModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new LaserLabQryBListUIModelModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as LaserLabQryBListUIModelModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public LaserLabQryBListUIFormWebPart()
        {
            FormID = "1b2ec0e6-2010-418e-b213-3b43ce9aa982";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new LaserLabQryBListUIModelModel();
				}
			...
			{
				//去除.已经移入到OnInit()中.
				//this.Model = (LaserLabQryBListUIModelModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new LaserLabQryBListUIModelAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"LaserLabQryBListUIForm",true,992,504);
        ...
        private void _BuilderControl_Toolbar1(IUFContainer container)
        {
            ...
            ///foreach Toolbar下的所有控件，增加到此容器
                            this.BtnNew = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnNew", "True", "True", 35, 28,"1", "N",true,false,"19478b02-d2a9-4d7e-b7af-00070c61ff2d","19478b02-d2a9-4d7e-b7af-00070c61ff2d","211a941f-dc36-410f-86a5-fefde0439bf6");
		
            UIControlBuilder.SetButtonAccessKey(this.BtnNew);
            this.BtnNew.UIModel = this.Model.ElementID;
            this.BtnNew.Action = "OnNew";
	                            this.BtnDelete = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnDelete", "True", "True", 35, 28,"2", "R",true,false,"0467218f-229b-4954-b2d4-3c5976467f76","0467218f-229b-4954-b2d4-3c5976467f76","ee44facb-7d35-4dfe-86c4-36e3ec103eed");
            ...
            this.BtnDelete.Action = "OnDelete";
	                            _Toolbar.Controls.Add(new UFWebToolbarSeparatorAdapter());
			                            this.BtnOutPut = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnOutPut", "True", "True", 35, 28,"4", "O",true,false,"688fd549-5a92-49cc-8072-6d5377f6409a","688fd549-5a92-49cc-8072-6d5377f6409a","8a1b72d7-a0dd-45df-aaca-b3c3498a600d");
            ...
            this.BtnOutPut.Action = "OnOutPut";
	                            this.BtnPrint = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnPrint", "True", "True", 35, 28,"5", "P",true,false,"27b5c615-cde5-458c-be74-833317249568","27b5c615-cde5-458c-be74-833317249568","8bfdda76-ed7f-49ca-8a05-ded9237563e2");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card0",false,"FunctionBar", true, true, "3","","b248d260-2e63-403b-bc93-8b8e07687ee7");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 80, 20, 13, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","888ab88f-cf53-4bfc-82b4-5d2bcc14afed");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "2");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 120, 20, 15, 0, 1, 1, "100",true,false,"","","1e9c5754-9ee6-4c4e-878b-fb348b2e9d1a");
			...
			UIControlBuilder.BuilderUFControl(this.DDLCase, "3");		
				...
				this.OnLookCase = UIControlBuilder.BuilderUFButton(_UFCard, true, "OnLookCase", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"OnLookCase",false,"ab3776ce-5cac-433e-8fa7-cbccae59fbaf","ab3776ce-5cac-433e-8fa7-cbccae59fbaf","5b4bae2b-88f6-49fc-9502-e769efe1bbaf");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card3",false,"none", true, true, "2","","e657e565-21d5-4cb2-89db-21ab8eeaeb3a");
		...
		{
			QryService.BindEnum("DDLCase", this, "13037355-f941-4828-9745-7ffaa4aa22f4");
		}
