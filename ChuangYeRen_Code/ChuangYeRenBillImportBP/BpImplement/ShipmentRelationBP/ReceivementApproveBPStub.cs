...
namespace UFIDA.U9.Cust.ChuangYeRenBillImportBP.ShipmentRelationBP
{
    ...
    public class ReceivementApproveBPStub : OperationStubBase, IReceivementApproveBP
    {
        #region IReceivementApproveBP Members
        ...
        public PublicDataTransObj.PublicReturnDTOData DoEx(ICommonDataContract commonData, System.Int64 relationU9Id)
        {
            ...
            try
            {
                BeforeInvoke("UFIDA.U9.Cust.ChuangYeRenBillImportBP.ShipmentRelationBP.ReceivementApproveBP");                
                ReceivementApproveBP objectRef = new ReceivementApproveBP();
				...
				DoSerializeKey(resultdata, "UFIDA.U9.Cust.ChuangYeRenBillImportBP.ShipmentRelationBP.ReceivementApproveBP");
				return resultdata;
            ...
            {
				FinallyInvoke("UFIDA.U9.Cust.ChuangYeRenBillImportBP.ShipmentRelationBP.ReceivementApproveBP");
            }
        }
	#endregion
    }
