...
namespace UFIDA.U9.Cust.ChuangYeRenBillImportBP.ShipmentRelationBP
{
    ...
    public class ReceivementImportBPStub : OperationStubBase, IReceivementImportBP
    {
        #region IReceivementImportBP Members
        ...
        public PublicDataTransObj.PublicReturnDTOData DoEx(ICommonDataContract commonData, System.Int64 relationId)
        {
            ...
            try
            {
                BeforeInvoke("UFIDA.U9.Cust.ChuangYeRenBillImportBP.ShipmentRelationBP.ReceivementImportBP");                
                ReceivementImportBP objectRef = new ReceivementImportBP();
				...
				DoSerializeKey(resultdata, "UFIDA.U9.Cust.ChuangYeRenBillImportBP.ShipmentRelationBP.ReceivementImportBP");
				return resultdata;
            ...
            {
				FinallyInvoke("UFIDA.U9.Cust.ChuangYeRenBillImportBP.ShipmentRelationBP.ReceivementImportBP");
            }
        }
	#endregion
    }
