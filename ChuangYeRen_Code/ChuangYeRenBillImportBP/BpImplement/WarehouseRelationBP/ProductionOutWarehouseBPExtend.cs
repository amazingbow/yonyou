namespace UFIDA.U9.Cust.ChuangYeRenBillImportBP.WarehouseRelationBP
{
	...
	internal partial class ProductionOutWarehouseBPImpementStrategy : BaseStrategy
	{
        ...
        private PublicReturnDTO CreateRcvRpt(ProductionOutWarehouseBP bpObj)
        {
            ...
            {
                pub.Flag = false;
                pub.Message = "创建成品出库单失败：" + ex.Message;
                return pub;
            }
            #endregion
            #region 审核成品出库单
            ...
            {
                pub.Flag = false;
                pub.Message += "审核成品出库单失败：" + ex.Message;
                return pub;
            }
            #endregion
            return pub;
