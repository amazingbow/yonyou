...
namespace UFIDA.U9.Cust.ChuangYeRenBillImportBP.WarehouseRelationBP
{
    ...
    public class MiscTranInProcessBPStub : OperationStubBase, IMiscTranInProcessBP
    {
        ...
        public void DoEx(ICommonDataContract commonData)
        {
            ...
            {
				FinallyInvoke("UFIDA.U9.Cust.ChuangYeRenBillImportBP.WarehouseRelationBP.MiscTranInProcessBP");
            }
        }
	#endregion
    }
