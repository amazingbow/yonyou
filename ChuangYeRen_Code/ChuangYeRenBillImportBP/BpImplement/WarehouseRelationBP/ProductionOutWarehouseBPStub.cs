...
namespace UFIDA.U9.Cust.ChuangYeRenBillImportBP.WarehouseRelationBP
{
    ...
    public class ProductionOutWarehouseBPStub : OperationStubBase, IProductionOutWarehouseBP
    {
        #region IProductionOutWarehouseBP Members
        ...
        public PublicDataTransObj.PublicReturnDTOData DoEx(ICommonDataContract commonData, System.Int64 relationId)
        {
            ...
            try
            {
                BeforeInvoke("UFIDA.U9.Cust.ChuangYeRenBillImportBP.WarehouseRelationBP.ProductionOutWarehouseBP");                
                ProductionOutWarehouseBP objectRef = new ProductionOutWarehouseBP();
				...
				DoSerializeKey(resultdata, "UFIDA.U9.Cust.ChuangYeRenBillImportBP.WarehouseRelationBP.ProductionOutWarehouseBP");
				return resultdata;
            ...
            {
				FinallyInvoke("UFIDA.U9.Cust.ChuangYeRenBillImportBP.WarehouseRelationBP.ProductionOutWarehouseBP");
            }
        }
	#endregion
    }
