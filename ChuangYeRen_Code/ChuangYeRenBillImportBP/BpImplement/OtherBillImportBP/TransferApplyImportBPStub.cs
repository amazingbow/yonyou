...
namespace UFIDA.U9.Cust.ChuangYeRenBillImportBP.OtherBillImportBP
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace = "http://www.UFIDA.org", Name="UFIDA.U9.Cust.ChuangYeRenBillImportBP.OtherBillImportBP.ITransferApplyImportBP")]
    public interface ITransferApplyImportBP
    {
    ...
    public class TransferApplyImportBPStub : OperationStubBase, ITransferApplyImportBP
    {
        ...
        public PublicDataTransObj.PublicReturnDTOData DoEx(ICommonDataContract commonData, System.Int64 iD)
        {
            ...
            try
            {
				...
				DoSerializeKey(resultdata, "UFIDA.U9.Cust.ChuangYeRenBillImportBP.OtherBillImportBP.TransferApplyImportBP");
				return resultdata;
            ...
            {
				FinallyInvoke("UFIDA.U9.Cust.ChuangYeRenBillImportBP.OtherBillImportBP.TransferApplyImportBP");
            }
        }
	#endregion
    }
