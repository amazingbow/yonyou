...
namespace UFIDA.U9.Cust.ChuangYeRenBillImportBP.ProductionRelationBP
{
    ...
    public class RejProductionIssueProcessBPStub : OperationStubBase, IRejProductionIssueProcessBP
    {
        ...
        public void DoEx(ICommonDataContract commonData)
        {
            ...
            {
				FinallyInvoke("UFIDA.U9.Cust.ChuangYeRenBillImportBP.ProductionRelationBP.RejProductionIssueProcessBP");
            }
        }
	#endregion
    }
