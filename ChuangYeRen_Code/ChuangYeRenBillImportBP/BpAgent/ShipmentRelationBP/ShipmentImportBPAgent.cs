...
namespace UFIDA.U9.Cust.ChuangYeRenBillImportBP.ShipmentRelationBP.Proxy
{
	...
	[Serializable]    
    public class ShipmentImportBPProxy : OperationProxyBase//, UFIDA.U9.Cust.ChuangYeRenBillImportBP.ShipmentRelationBP.Proxy.IShipmentImportBP
    {
	#region Fields	
	...
	#region Constructors
        ...
        {
  			InitKeyList() ;
 			PublicDataTransObj.PublicReturnDTOData result = (PublicDataTransObj.PublicReturnDTOData)InvokeAgent<UFIDA.U9.Cust.ChuangYeRenBillImportBP.ShipmentRelationBP.Proxy.IShipmentImportBP>();
		...
		protected override object InvokeImplement<T>(T oChannel)
        {
            ...
            IShipmentImportBP channel = oChannel as IShipmentImportBP;
            if (channel != null)
            {
