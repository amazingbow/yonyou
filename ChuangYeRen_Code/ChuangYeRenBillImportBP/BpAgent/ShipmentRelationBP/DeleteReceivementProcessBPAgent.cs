...
namespace UFIDA.U9.Cust.ChuangYeRenBillImportBP.ShipmentRelationBP.Proxy
{
	...
	[Serializable]    
    public class DeleteReceivementProcessBPProxy : OperationProxyBase//, UFIDA.U9.Cust.ChuangYeRenBillImportBP.ShipmentRelationBP.Proxy.IDeleteReceivementProcessBP
    {
	#region Fields	
	...
	#region Constructors
        public DeleteReceivementProcessBPProxy()
        {
        }
        #endregion
        ...
        {
  			InitKeyList() ;
 			PublicDataTransObj.PublicReturnDTOData result = (PublicDataTransObj.PublicReturnDTOData)InvokeAgent<UFIDA.U9.Cust.ChuangYeRenBillImportBP.ShipmentRelationBP.Proxy.IDeleteReceivementProcessBP>();
		...
		protected override object InvokeImplement<T>(T oChannel)
        {
            ...
            IDeleteReceivementProcessBP channel = oChannel as IDeleteReceivementProcessBP;
            if (channel != null)
            {
