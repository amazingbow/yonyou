...
namespace UFIDA.U9.Cust.ChuangYeRenBillImportBP.ProductionRelationBP.Proxy
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace = "http://www.UFIDA.org", Name="UFIDA.U9.Cust.ChuangYeRenBillImportBP.ProductionRelationBP.IRejProductionIssueProcessBP")]
    public interface IRejProductionIssueProcessBP
    {
	...
	#region Constructors
        public RejProductionIssueProcessBPProxy()
        {
        }
        #endregion
        ...
        {
  			InitKeyList() ;
 			PublicDataTransObj.PublicReturnDTOData result = (PublicDataTransObj.PublicReturnDTOData)InvokeAgent<UFIDA.U9.Cust.ChuangYeRenBillImportBP.ProductionRelationBP.Proxy.IRejProductionIssueProcessBP>();
		...
		protected override object InvokeImplement<T>(T oChannel)
        {
            ...
            IRejProductionIssueProcessBP channel = oChannel as IRejProductionIssueProcessBP;
            if (channel != null)
            {
