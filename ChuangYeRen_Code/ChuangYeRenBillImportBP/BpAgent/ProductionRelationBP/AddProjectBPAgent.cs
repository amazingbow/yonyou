...
namespace UFIDA.U9.Cust.ChuangYeRenBillImportBP.ProductionRelationBP.Proxy
{
	...
	[Serializable]    
    public class AddProjectBPProxy : OperationProxyBase//, UFIDA.U9.Cust.ChuangYeRenBillImportBP.ProductionRelationBP.Proxy.IAddProjectBP
    {
	#region Fields	
	...
	#region Constructors
        ...
        {
  			InitKeyList() ;
 			PublicDataTransObj.PublicReturnDTOData result = (PublicDataTransObj.PublicReturnDTOData)InvokeAgent<UFIDA.U9.Cust.ChuangYeRenBillImportBP.ProductionRelationBP.Proxy.IAddProjectBP>();
		...
		protected override object InvokeImplement<T>(T oChannel)
        {
            ...
            IAddProjectBP channel = oChannel as IAddProjectBP;
            if (channel != null)
            {
