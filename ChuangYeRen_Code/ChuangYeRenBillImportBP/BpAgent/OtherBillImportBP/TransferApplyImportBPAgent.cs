...
namespace UFIDA.U9.Cust.ChuangYeRenBillImportBP.OtherBillImportBP.Proxy
{
	...
	#region Constructors
        public TransferApplyImportBPProxy()
        {
        }
        #endregion
        ...
        {
  			InitKeyList() ;
 			PublicDataTransObj.PublicReturnDTOData result = (PublicDataTransObj.PublicReturnDTOData)InvokeAgent<UFIDA.U9.Cust.ChuangYeRenBillImportBP.OtherBillImportBP.Proxy.ITransferApplyImportBP>();
