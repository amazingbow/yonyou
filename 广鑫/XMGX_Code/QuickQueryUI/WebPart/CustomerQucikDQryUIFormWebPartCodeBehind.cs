...
namespace UFIDA.U9.Cust.FJGX.CustomerQucikDQryUIModel
{
    public partial class CustomerQucikDQryUIFormWebPart
    {
		...
		//MethodName:TabControl0_SelectedIndexChanged ActionName:
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void TabControl0_SelectedIndexChanged(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,TabControl0_SelectedIndexChanged_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void TabControl0_SelectedIndexChanged_DefaultImpl(object sender, EventArgs e)
        {
			//Template (tpl) Code here...
