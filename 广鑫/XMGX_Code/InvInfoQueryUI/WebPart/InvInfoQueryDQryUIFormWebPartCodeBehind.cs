...
//Tree控件事件
				//MethodName:CategoryTree0_NodeClick ActionName:
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void CategoryTree0_NodeClick(object sender, RadTreeNodeEventArgs e)
        {
			...
			this.IsConsuming = false;
					try
			{				
				CategoryTree0_NodeClick_Extend(sender,e) ;			
			}
			catch(Exception ex)
			{
        ...
        //default implement by tpl ...
        private void CategoryTree0_NodeClick_DefaultImpl(object sender, RadTreeNodeEventArgs e)
        {
			//Template (tpl) Code here...
...
//Tree控件事件
				//MethodName:CategoryTree0_NodeExpand ActionName:
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void CategoryTree0_NodeExpand(object sender, RadTreeNodeEventArgs e)
        {
			...
			this.IsConsuming = false;
					try
			{				
				CategoryTree0_NodeExpand_Extend(sender,e) ;			
			}
			catch(Exception ex)
			{
				if (UFSoft.UBF.Exceptions.ExceptionHelper.IsUnknownException(ex, true)) {
        ...
        //default implement by tpl ...
        private void CategoryTree0_NodeExpand_DefaultImpl(object sender, RadTreeNodeEventArgs e)
        {
			//Template (tpl) Code here...
