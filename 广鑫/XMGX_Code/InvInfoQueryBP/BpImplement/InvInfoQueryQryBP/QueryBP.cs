...
namespace UFIDA.U9.Cust.FJGX.InvInfoQueryQryBP
{
	...
	public partial class QueryBP
	{
		...
		[Logger]
		[Authorize]
		public List<UFIDA.U9.Cust.FJGX.InvInfoQueryQryBP.InvInfoQueryQryDTO> Do()
		{	
		    BaseStrategy selector = Select();	
				List<UFIDA.U9.Cust.FJGX.InvInfoQueryQryBP.InvInfoQueryQryDTO> result =  (List<UFIDA.U9.Cust.FJGX.InvInfoQueryQryBP.InvInfoQueryQryDTO>)selector.Execute(this);	
