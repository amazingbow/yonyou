...
/***********************************************************************************************
 * Form ID:78a77467-e297-4a91-88f7-cd73ae82adea 
 * Form Name:CustomerVoucherDQryUIForm
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace UFIDA.U9.Cust.FJGX.CustomerVoucherDQryUIModel
{
	[FormRegister("UFIDA.U9.Cust.FJGX.CustomerQueryUI","UFIDA.U9.Cust.FJGX.CustomerVoucherDQryUIModel.CustomerVoucherDQryUIFormWebPart", "UFIDA.U9.Cust.FJGX.CustomerQueryUI.WebPart", "78a77467-e297-4a91-88f7-cd73ae82adea","WebPart", "True", 700, 250)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.FJGX.CustomerQueryUI', 'UFIDA.U9.Cust.FJGX.CustomerVoucherDQryUIModel.CustomerVoucherDQryUIFormWebPart', 'UFIDA.U9.Cust.FJGX.CustomerQueryUI.WebPart', '78a77467-e297-4a91-88f7-cd73ae82adea')
	///<siteMapNode url="~/erp/simple.aspx?lnk=78a77467-e297-4a91-88f7-cd73ae82adea" title="CustomerVoucherDQryUIForm"/>
    public partial class CustomerVoucherDQryUIFormWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(CustomerVoucherDQryUIFormWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new CustomerVoucherDQryUIModelAction Action
		{
			get { return (CustomerVoucherDQryUIModelAction)base.Action; }
			set { base.Action = value; }
		}
		CustomerVoucherDQryUIModelModel _uimodel=null;
		public new CustomerVoucherDQryUIModelModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new CustomerVoucherDQryUIModelModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as CustomerVoucherDQryUIModelModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public CustomerVoucherDQryUIFormWebPart()
        {
            FormID = "78a77467-e297-4a91-88f7-cd73ae82adea";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new CustomerVoucherDQryUIModelModel();
				}
			...
			{
				//去除.已经移入到OnInit()中.
				//this.Model = (CustomerVoucherDQryUIModelModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new CustomerVoucherDQryUIModelAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"CustomerVoucherDQryUIForm",true,700,250);
        ...
        private void _BuilderControl_Toolbar1(IUFContainer container)
        {
            ...
            ///foreach Toolbar下的所有控件，增加到此容器
                            this.BtnOutPut = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnOutPut", "True", "True", 35, 1,"1", "",true,false,"688fd549-5a92-49cc-8072-6d5377f6409a","688fd549-5a92-49cc-8072-6d5377f6409a","da54bd5f-30cf-44a0-9e84-11046c030c90");
            ...
            this.BtnOutPut.Action = "OnOutPut";
	                            this.BtnPrint = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnPrint", "True", "True", 35, 1,"2", "",true,false,"27b5c615-cde5-458c-be74-833317249568","27b5c615-cde5-458c-be74-833317249568","228ae077-d94b-4f2c-bdd7-53e0c9ace492");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card0",false,"none", true, true, "4","","12bd7064-f163-41e5-9f89-00af2ec3af02");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 55, 20, 2, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","cc1de0f0-9efe-4103-9375-cd86a14b6f29");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "4");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 100, 20, 4, 0, 1, 1, "100",true,false,"","","3163640a-dc9a-4793-babc-c75ee577a38e");
			...
			UIControlBuilder.BuilderUFControl(this.DDLCase, "5");		
				...
				this.OnLookCase = UIControlBuilder.BuilderUFButton(_UFCard, true, "OnLookCase", true, true, 40, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"OnLookCase",false,"2ff1e8e2-1dc2-4735-9d62-93c4bc4446a2","2ff1e8e2-1dc2-4735-9d62-93c4bc4446a2","cd856de1-cbbc-4bdb-85a2-0d15822909be");
			...
			UIControlBuilder.BuilderUFControl(this.OnLookCase, "6");		
				...
				this.Label2 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label2", "", "True", "True", "Left", 384, 20, 8, 0, 1, 1, "100","b4dad7c6-ef51-4f85-bf8c-09e577dffa95","b4dad7c6-ef51-4f85-bf8c-09e577dffa95");


								

		
			UIControlBuilder.BuilderUFControl(this.Label2, "6");		


				this.btnSaveCurrentQueryCase = UIControlBuilder.BuilderUFButton(_UFCard, true, "btnSaveCurrentQueryCase", true, true, 60, 20, 6, 0, 1, 1, "100","", this.Model.ElementID,"btnSaveCurrentQueryCase",false,"e206c256-68ed-4872-85bc-dd916d5b1307","e206c256-68ed-4872-85bc-dd916d5b1307","680fa62e-f5a9-496e-8fbb-422aa9b200d7");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card3",false,"none", true, true, "5","","b7e2677d-608c-4cea-85e3-d68857038f45");
			...
			InitViewBindingContainer(this, _UFCard,  null, "", "", null, 1, "");
			UIControlBuilder.BuildContainerGridLayout(_UFCard, 5,new GridColumnDef[]{new GridColumnDef(680,bool.Parse("True")),new GridColumnDef(10,bool.Parse("False")),},new GridRowDef[]{new GridRowDef(203,bool.Parse("True")),new GridRowDef(1,bool.Parse("False")),});
            this.Card3 = _UFCard;
       ...
       private void BeforeUIModelBinding_Qry_DefaultImpl()
        ...
        {
            QryService.BindEnum("DDLCase", this, "6de4cc91-9677-4aae-9880-bd1282141a4a");
        }
	...
	private void AttachMakePageEvent()
	{
            ...
            ((UFSoft.UBF.UI.WebControlAdapter.UFWebDataGridAdapter)this.DataGrid1).GridMakePageEventHandler += new GridMakePageDelegate(CustomerVoucherDQryUIFormWebPart_GridMakePageEventHandler);

	}

        void CustomerVoucherDQryUIFormWebPart_GridMakePageEventHandler(object sender, GridMakePageEventArgs e)
        {
            GridNavigateAction action = new GridNavigateAction(this.DataGrid1, new UFIDA.U9.Cust.FJGX.CustomerVoucherQryBP.Proxy.QueryBPProxy(), "QryInParameter");
