...
{
    public partial class CustomerDocLineListDQryUIFormWebPart
    {
        ...
        {
            if (NavigateManager.IsModelPopup(this))
            {
                IGridLayout layOut = (IGridLayout)this.TopLevelContainer.Layout;
                TopLevelContainer.Height = 504;
                TopLevelContainer.Width = 992;
                layOut.Rows[1].Height = 448;
                layOut.Columns[0].Width = 992;
                this.Card3.Height = 448;
                this.Card3.Width = 992;
                ((IGridLayout)this.Card3.Layout).Rows[0].Height = 440;
                ((IGridLayout)this.Card3.Layout).Columns[0].Width = 982;
            }
