...
{
    public partial class CustomerDQryUIModelAction
    {
        ...
        private void BtnShowCustomerDocLine_Extend(object sender, UIActionEventArgs e)
        {

            //调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
            this.BtnShowCustomerDocLine_DefaultImpl(sender, e);
        }
        ...
        private void BtnOperatorsDaily_Extend(object sender, UIActionEventArgs e)
        {

            //调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
            this.BtnOperatorsDaily_DefaultImpl(sender, e);
        }
