...
{
	[Serializable]
	public partial class CustomerDocLineListDQryUIModelModel : UIModel
	{
		#region Constructor
		public CustomerDocLineListDQryUIModelModel() : base("CustomerDocLineListDQryUIModel")
		{
			InitClass();
			this.SetResourceInfo("ced4253c-8729-4232-9460-67f7c29ff12f");
            try{
			    AfterInitModel();
		...
		//just for Clone 
		private CustomerDocLineListDQryUIModelModel(bool isInit) : base("CustomerDocLineListDQryUIModel")
		{}
		protected override IUIModel CreateCloneInstance()
		{
			return new CustomerDocLineListDQryUIModelModel(false);
		}
		#endregion
		#region member
		#region views
		...
		private void InitClass()
		{
			...
			this.viewQueryView.SetResourceInfo("9b7af6d5-eaf2-461d-8706-7b1fe79c2085");
	...
	public partial class QueryViewView : UIView
	{
		...
		private void InitClass()
		{
			UIModelRuntimeFactory.AddNewUIField(this,"ID", typeof(Int64), false,"","System.Int64", "", false,false, false, "",false,(UIFieldType)1,"ba391065-6c27-4c82-acc8-b52b1c93a910","f212df76-8312-4041-8751-d56c57163198");
	...
	public class QueryViewDefaultFilterFilter : UIFilter
	{
		...
		public QueryViewDefaultFilterFilter(IUIView view) 
			: base("DefaultFilter",view,@"#Doc#.ID=@DocID",@"")
		{
			InitClass();
		}
		...
		#region property
		private IUIParameter @DocID;
		#endregion
		
		#region function
		private void InitClass()
		{
			this.@DocID = new UIParameter("@DocID",System.Data.DbType.Int64);
			this.Parameters.Add(this.@DocID);
		}
		#endregion
