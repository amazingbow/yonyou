...
{
	[Serializable]
	public partial class CustomerDocListDQryUIModelModel : UIModel
	{
		#region Constructor
		public CustomerDocListDQryUIModelModel() : base("CustomerDocListDQryUIModel")
		{
			InitClass();
			this.SetResourceInfo("3a7a053e-d46d-4828-bb5e-cd7015ace973");
            try{
			    AfterInitModel();
		...
		//just for Clone 
		private CustomerDocListDQryUIModelModel(bool isInit) : base("CustomerDocListDQryUIModel")
		{}
		protected override IUIModel CreateCloneInstance()
		{
			return new CustomerDocListDQryUIModelModel(false);
		}
		#endregion
		#region member
		#region views
		...
		private void InitClass()
		{
			...
			this.viewQueryView.SetResourceInfo("0a6b7378-59b8-4e92-afe3-05bb47edafa0");
	...
	public partial class QueryViewView : UIView
	{
		...
		private void InitClass()
		{
			UIModelRuntimeFactory.AddNewUIField(this,"ID", typeof(Int64), false,"","System.Int64", "", false,false, false, "",false,(UIFieldType)1,"ba391065-6c27-4c82-acc8-b52b1c93a910","e743cc3f-b0e9-4bf1-829c-235516ac180b");
