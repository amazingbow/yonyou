...
{
	[Serializable]
	public partial class CustomerVoucherDQryUIModelModel : UIModel
	{
		#region Constructor
		public CustomerVoucherDQryUIModelModel() : base("CustomerVoucherDQryUIModel")
		{
			InitClass();
			this.SetResourceInfo("cd50ffb1-7d7e-4f99-a971-388cd7545a20");
            try{
			    AfterInitModel();
		...
		//just for Clone 
		private CustomerVoucherDQryUIModelModel(bool isInit) : base("CustomerVoucherDQryUIModel")
		{}
		protected override IUIModel CreateCloneInstance()
		{
			return new CustomerVoucherDQryUIModelModel(false);
		}
		#endregion
		#region member
		#region views
		...
		private void InitClass()
		{
			...
			this.viewQueryView.SetResourceInfo("f6413d95-c962-4407-be0c-d57c6d5e485d");
	...
	public partial class QueryViewView : UIView
	{
		...
		private void InitClass()
		{
			UIModelRuntimeFactory.AddNewUIField(this,"ID", typeof(Int64), false,"","System.Int64", "", false,false, false, "",false,(UIFieldType)1,"ba391065-6c27-4c82-acc8-b52b1c93a910","97ed3ca5-149b-4bc5-adf3-3f112bbb14b1");
	...
	public class QueryViewDefaultFilterFilter : UIFilter
	{
		...
		public QueryViewDefaultFilterFilter(IUIView view) 
			: base("DefaultFilter",view,@"Customer.Code in ( select A.Code from UFIDA::U9::CBO::SCM::Customer::Customer A where A.ID = @CustomerID)",@"")
		{
			InitClass();
		}
