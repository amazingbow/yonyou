...
{
	[Serializable]
	public partial class SupplierDocLineListDQryUIModelModel : UIModel
	{
		#region Constructor
		public SupplierDocLineListDQryUIModelModel() : base("SupplierDocLineListDQryUIModel")
		{
			InitClass();
			this.SetResourceInfo("4574eca0-28e1-4f1f-ad2c-82bb754e1357");
            try{
			    AfterInitModel();
		...
		//just for Clone 
		private SupplierDocLineListDQryUIModelModel(bool isInit) : base("SupplierDocLineListDQryUIModel")
		{}
		protected override IUIModel CreateCloneInstance()
		{
			return new SupplierDocLineListDQryUIModelModel(false);
		}
		#endregion
		#region member
		#region views
		...
		private void InitClass()
		{
			...
			this.viewQueryView.SetResourceInfo("024f47a6-9749-4259-9039-c26a353dc5c3");
	...
	public partial class QueryViewView : UIView
	{
		...
		private void InitClass()
		{
			UIModelRuntimeFactory.AddNewUIField(this,"ID", typeof(Int64), false,"","System.Int64", "", false,false, false, "",false,(UIFieldType)1,"ba391065-6c27-4c82-acc8-b52b1c93a910","530f04c6-fb73-4e3f-9a32-0a380e9d1da0");
	...
	public class QueryViewDefaultFilterFilter : UIFilter
	{
		...
		public QueryViewDefaultFilterFilter(IUIView view) 
			: base("DefaultFilter",view,@"Rcv.ID=@DocID",@"")
		{
			InitClass();
		}
