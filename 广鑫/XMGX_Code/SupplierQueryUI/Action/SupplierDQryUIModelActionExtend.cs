...
{
    public partial class SupplierDQryUIModelAction
    {
        ...
        private void BtnShowSupplierDocLine_Extend(object sender, UIActionEventArgs e)
        {
            //调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
            this.BtnShowSupplierDocLine_DefaultImpl(sender, e);
        }
