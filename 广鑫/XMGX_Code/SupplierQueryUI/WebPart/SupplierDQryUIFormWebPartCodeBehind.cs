...
namespace UFIDA.U9.Cust.FJGX.SupplierDQryUIModel
{
    public partial class SupplierDQryUIFormWebPart
    {
		...
		Action.OnLookCase(sender,new UIActionEventArgs());
				...
				//MethodName:BtnShowSupplierDocLine_Click ActionName:BtnShowSupplierDocLine
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void BtnShowSupplierDocLine_Click(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,BtnShowSupplierDocLine_Click_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void BtnShowSupplierDocLine_Click_DefaultImpl(object sender, EventArgs e)
        {
			//Template (tpl) Code here...
		...
		Action.BtnShowSupplierDocLine(sender,new UIActionEventArgs());
