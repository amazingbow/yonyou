...
/***********************************************************************************************
 * Form ID:5cc7ff9c-c51f-4e92-b8cf-48b0dfa80aef 
 * Form Name:SupplierDocListDQryUIForm
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace UFIDA.U9.Cust.FJGX.SupplierDocListDQryUIModel
{
	[FormRegister("UFIDA.U9.Cust.FJGX.SupplierQueryUI","UFIDA.U9.Cust.FJGX.SupplierDocListDQryUIModel.SupplierDocListDQryUIFormWebPart", "UFIDA.U9.Cust.FJGX.SupplierQueryUI.WebPart", "5cc7ff9c-c51f-4e92-b8cf-48b0dfa80aef","WebPart", "True", 700, 250)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.FJGX.SupplierQueryUI', 'UFIDA.U9.Cust.FJGX.SupplierDocListDQryUIModel.SupplierDocListDQryUIFormWebPart', 'UFIDA.U9.Cust.FJGX.SupplierQueryUI.WebPart', '5cc7ff9c-c51f-4e92-b8cf-48b0dfa80aef')
	///<siteMapNode url="~/erp/simple.aspx?lnk=5cc7ff9c-c51f-4e92-b8cf-48b0dfa80aef" title="SupplierDocListDQryUIForm"/>
    public partial class SupplierDocListDQryUIFormWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(SupplierDocListDQryUIFormWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new SupplierDocListDQryUIModelAction Action
		{
			get { return (SupplierDocListDQryUIModelAction)base.Action; }
			set { base.Action = value; }
		}
		SupplierDocListDQryUIModelModel _uimodel=null;
		public new SupplierDocListDQryUIModelModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new SupplierDocListDQryUIModelModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as SupplierDocListDQryUIModelModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public SupplierDocListDQryUIFormWebPart()
        {
            FormID = "5cc7ff9c-c51f-4e92-b8cf-48b0dfa80aef";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new SupplierDocListDQryUIModelModel();
				}
				OnLoadConsumer(new InParameterModel[]{new InParameterModel("QueryView"),},new InParameterModel[]{new InParameterModel("QueryView","@SupplierID","@Parameter0"),});
				OnLoadData(this);
			...
			{
				//去除.已经移入到OnInit()中.
				//this.Model = (SupplierDocListDQryUIModelModel)this.CurrentState[this.TaskId.ToString()];
			}
        ...
        protected override void OnPreRenderDo(EventArgs e)
        {
			...
			{
				OnPreRenderConsumer(new InParameterModel[]{new InParameterModel("QueryView"),},new InParameterModel[]{new InParameterModel("QueryView","@SupplierID","@Parameter0"),});
				OnLoadData(this);//对吗？
			}
		...
		{			 
            ...
            this.Action = new SupplierDocListDQryUIModelAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"SupplierDocListDQryUIForm",true,700,250);
        ...
        private void _BuilderControl_Toolbar1(IUFContainer container)
        {
            ...
            ///foreach Toolbar下的所有控件，增加到此容器
                            this.BtnOutPut = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnOutPut", "True", "True", 35, 1,"1", "",true,false,"688fd549-5a92-49cc-8072-6d5377f6409a","688fd549-5a92-49cc-8072-6d5377f6409a","b3b7ef5e-d672-4431-a978-984680de386a");
            ...
            this.BtnOutPut.Action = "OnOutPut";
	                            this.BtnPrint = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnPrint", "True", "True", 35, 1,"2", "",true,false,"27b5c615-cde5-458c-be74-833317249568","27b5c615-cde5-458c-be74-833317249568","210cab43-ca9a-4e98-8dc1-25ba87cd0a26");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card0",false,"none", true, true, "4","","e3b161eb-1e3f-482c-b34a-0f8a8f740dad");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 55, 20, 2, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","0709d8b9-a937-4727-bbfa-61e616d81d5f");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "4");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 100, 20, 4, 0, 1, 1, "100",true,false,"","","37f087ed-6e45-4c46-9138-8769896dcd0b");
			...
			UIControlBuilder.BuilderUFControl(this.DDLCase, "5");		
				...
				this.OnLookCase = UIControlBuilder.BuilderUFButton(_UFCard, true, "OnLookCase", true, true, 40, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"OnLookCase",false,"87dd2c52-e8f0-4f91-a797-9dd707db6805","87dd2c52-e8f0-4f91-a797-9dd707db6805","901fb80a-f335-4e1e-8235-83840cd6dbe6");
			...
			UIControlBuilder.BuilderUFControl(this.OnLookCase, "6");		
				...
				this.Label2 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label2", "", "True", "True", "Left", 384, 20, 8, 0, 1, 1, "100","e98c31e5-4e46-4c8a-bae6-3d601df02beb","e98c31e5-4e46-4c8a-bae6-3d601df02beb");
			...
			UIControlBuilder.BuilderUFControl(this.Label2, "9");		
				...
				this.btnSaveCurrentQueryCase = UIControlBuilder.BuilderUFButton(_UFCard, true, "btnSaveCurrentQueryCase", true, true, 60, 20, 6, 0, 1, 1, "100","", this.Model.ElementID,"btnSaveCurrentQueryCase",false,"f2a006d7-2264-402e-b065-148d2b6cae4f","f2a006d7-2264-402e-b065-148d2b6cae4f","4823d585-1b66-4fb5-8a99-dc1b73e881bf");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card3",false,"none", true, true, "5","","72786c59-d5f3-4ae5-8673-5db24c598f45");
       ...
       private void BeforeUIModelBinding_Qry_DefaultImpl()
        ...
        {
            QryService.BindEnum("DDLCase", this, "35d1fcae-9379-4d03-b0ea-3f47d02895b9");
        }
	...
	private void AttachMakePageEvent()
	{
            ...
            ((UFSoft.UBF.UI.WebControlAdapter.UFWebDataGridAdapter)this.DataGrid1).GridMakePageEventHandler += new GridMakePageDelegate(SupplierDocListDQryUIFormWebPart_GridMakePageEventHandler);

	}

        void SupplierDocListDQryUIFormWebPart_GridMakePageEventHandler(object sender, GridMakePageEventArgs e)
        {
            GridNavigateAction action = new GridNavigateAction(this.DataGrid1, new UFIDA.U9.Cust.FJGX.SupplierDocListQryBP.Proxy.QueryBPProxy(), "QryInParameter");
