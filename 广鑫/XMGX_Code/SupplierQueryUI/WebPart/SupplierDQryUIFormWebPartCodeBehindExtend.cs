...
{
    public partial class SupplierDQryUIFormWebPart
    {
        ...
        //OnLookCase_Click...
        private void BtnShowSupplierDocLine_Click_Extend(object sender, EventArgs e)
        {
            //调用模版提供的默认实现.--默认实现可能会调用相应的Action.
            BtnShowSupplierDocLine_Click_DefaultImpl(sender, e);
            if (this.Model.QueryView.FocusedRecord == null) return;
            NameValueCollection nv = new NameValueCollection();
            nv.Add("SupplierID", this.Model.QueryView.FocusedRecord["ID"].ToString());
            this.ShowModalDialog("9b56f165-8ab1-4d8f-b89d-4108fb4ddd75", "入库记录", "700", "250", null, nv,
                false, true, false);
        }
        ...
        {
            decimal sumAPTotalMoney = this.Model.QueryView.Records.Count == 0 ? 0 :
               decimal.Parse(this.Model.QueryView.Records[0]["SumAPTotalMoney"].ToString());
            this.Label2.Text = "应付余额:" + sumAPTotalMoney.ToString("F2");
        }
