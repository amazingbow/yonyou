...
namespace UIFIA.U9.Cust.FJGX.RcvHeadQryBP
{
	...
	public partial class QueryBP
	{
		...
		[Logger]
		[Authorize]
		public List<UIFIA.U9.Cust.FJGX.RcvHeadQryBP.RcvHeadQryDTO> Do()
		{	
		    BaseStrategy selector = Select();	
				List<UIFIA.U9.Cust.FJGX.RcvHeadQryBP.RcvHeadQryDTO> result =  (List<UIFIA.U9.Cust.FJGX.RcvHeadQryBP.RcvHeadQryDTO>)selector.Execute(this);	
