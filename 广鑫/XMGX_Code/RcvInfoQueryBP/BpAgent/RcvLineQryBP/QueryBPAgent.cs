...
namespace UIFIA.U9.Cust.FJGX.RcvLineQryBP.Proxy
{
	using System;
	...
	[Serializable]    
    public class QueryBPProxy : OperationProxyBase//, UIFIA.U9.Cust.FJGX.RcvLineQryBP.Proxy.IQueryBP
    {
	#region Fields	
	...
	#region Constructors
        ...
        public List<UIFIA.U9.Cust.FJGX.RcvLineQryBP.RcvLineQryDTOData> Do()
        {
  			InitKeyList() ;
 			List<UIFIA.U9.Cust.FJGX.RcvLineQryBP.RcvLineQryDTOData> result = (List<UIFIA.U9.Cust.FJGX.RcvLineQryBP.RcvLineQryDTOData>)InvokeAgent<UIFIA.U9.Cust.FJGX.RcvLineQryBP.Proxy.IQueryBP>();
		...
		private List<UIFIA.U9.Cust.FJGX.RcvLineQryBP.RcvLineQryDTOData> GetRealResult(List<UIFIA.U9.Cust.FJGX.RcvLineQryBP.RcvLineQryDTOData> result)
		{
								return result ;
			}
		#region  Init KeyList 
