/**************************************************************
 * Description:
 * OperatorsDailyUIModelAction.cs
 * Product: U9
 * Co.    : UFIDA Group
...
{
	public partial class OperatorsDailyUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(OperatorsDailyUIModelAction));
		//强类型化基类Model属性.
		public new OperatorsDailyUIModelModel CurrentModel 
		{
			get {
				return (OperatorsDailyUIModelModel)base.CurrentModel;
			}
			set {
		...
		public OperatorsDailyUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public OperatorsDailyUIModelAction(OperatorsDailyUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 
