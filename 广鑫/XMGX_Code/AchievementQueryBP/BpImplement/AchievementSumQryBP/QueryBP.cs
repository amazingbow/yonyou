...
namespace UFIDA.U9.Cust.FJGX.AchievementSumQryBP
{
	...
	public partial class QueryBP
	{
		...
		[Logger]
		[Authorize]
		public List<UFIDA.U9.Cust.FJGX.AchievementSumQryBP.AchievementSumQryDTO> Do()
		{	
		    BaseStrategy selector = Select();	
				List<UFIDA.U9.Cust.FJGX.AchievementSumQryBP.AchievementSumQryDTO> result =  (List<UFIDA.U9.Cust.FJGX.AchievementSumQryBP.AchievementSumQryDTO>)selector.Execute(this);	
