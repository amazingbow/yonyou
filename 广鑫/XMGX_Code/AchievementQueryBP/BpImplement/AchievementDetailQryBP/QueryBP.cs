...
namespace UFIDA.U9.Cust.FJGX.AchievementDetailQryBP
{
	...
	public partial class QueryBP
	{
		...
		[Logger]
		[Authorize]
		public List<UFIDA.U9.Cust.FJGX.AchievementDetailQryBP.AchievementDetailQryDTO> Do()
		{	
		    BaseStrategy selector = Select();	
				List<UFIDA.U9.Cust.FJGX.AchievementDetailQryBP.AchievementDetailQryDTO> result =  (List<UFIDA.U9.Cust.FJGX.AchievementDetailQryBP.AchievementDetailQryDTO>)selector.Execute(this);	
