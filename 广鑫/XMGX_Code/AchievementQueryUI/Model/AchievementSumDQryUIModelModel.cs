...
{
	[Serializable]
	public partial class AchievementSumDQryUIModelModel : UIModel
	{
		#region Constructor
		public AchievementSumDQryUIModelModel() : base("AchievementSumDQryUIModel")
		{
			InitClass();
			this.SetResourceInfo("701d24cb-f81c-44b1-bda3-b4bcd2dbbb61");
            try{
			    AfterInitModel();
		...
		//just for Clone 
		private AchievementSumDQryUIModelModel(bool isInit) : base("AchievementSumDQryUIModel")
		{}
		protected override IUIModel CreateCloneInstance()
		{
			return new AchievementSumDQryUIModelModel(false);
		}
		#endregion
		#region member
		#region views
		...
		private void InitClass()
		{
			...
			this.viewQueryView.SetResourceInfo("ff8e1550-bd31-4e61-a3fc-472acd839321");
	...
	public partial class QueryViewView : UIView
	{
		...
		private void InitClass()
		{
			UIModelRuntimeFactory.AddNewUIField(this,"ID", typeof(Int64), false,"","System.Int64", "", false,false, false, "",false,(UIFieldType)1,"ba391065-6c27-4c82-acc8-b52b1c93a910","37a13ab6-735c-4f6a-89c2-c5780529965f");
