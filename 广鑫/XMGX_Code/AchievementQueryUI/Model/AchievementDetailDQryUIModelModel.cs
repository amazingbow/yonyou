...
{
	[Serializable]
	public partial class AchievementDetailDQryUIModelModel : UIModel
	{
		#region Constructor
		public AchievementDetailDQryUIModelModel() : base("AchievementDetailDQryUIModel")
		{
			InitClass();
			this.SetResourceInfo("c9f7c83a-a4d9-4718-bfed-76a626fa755b");
            try{
			    AfterInitModel();
		...
		//just for Clone 
		private AchievementDetailDQryUIModelModel(bool isInit) : base("AchievementDetailDQryUIModel")
		{}
		protected override IUIModel CreateCloneInstance()
		{
			return new AchievementDetailDQryUIModelModel(false);
		}
		#endregion
		#region member
		#region views
		...
		private void InitClass()
		{
			...
			this.viewQueryView.SetResourceInfo("2e9a54da-3a24-4fa8-88ce-c0571a467c1d");
		...
		{
			get { return "UFIDA.U9.Cust.FJGX.AchievementQueryUI"; }
		}
	...
	public partial class QueryViewView : UIView
	{
		...
		private void InitClass()
		{
			UIModelRuntimeFactory.AddNewUIField(this,"ID", typeof(Int64), false,"","System.Int64", "", false,false, false, "",false,(UIFieldType)1,"ba391065-6c27-4c82-acc8-b52b1c93a910","14fe2c06-27f5-43dc-bc91-fee6274d007c");
	...
	public class QueryViewDefaultFilterFilter : UIFilter
	{
		...
		public QueryViewDefaultFilterFilter(IUIView view) 
			: base("DefaultFilter",view,@"Operators.ID = @OperatorsID",@"")
		{
			InitClass();
		}
		...
		#region property
		private IUIParameter @OperatorsID;
		#endregion
		
		#region function
		private void InitClass()
		{
			this.@OperatorsID = new UIParameter("@OperatorsID",System.Data.DbType.Int64);
			this.Parameters.Add(this.@OperatorsID);
		}
		#endregion
