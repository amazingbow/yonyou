...
namespace UFIDA.U9.Cust.FJGX.SOHeadInfoQryBP.Proxy
{
	using System;
	...
	[Serializable]    
    public class QueryBPProxy : OperationProxyBase//, UFIDA.U9.Cust.FJGX.SOHeadInfoQryBP.Proxy.IQueryBP
    {
	#region Fields	
	...
	#region Constructors
        ...
        public List<UFIDA.U9.Cust.FJGX.SOHeadInfoQryBP.SOHeadInfoQryDTOData> Do()
        {
  			InitKeyList() ;
 			List<UFIDA.U9.Cust.FJGX.SOHeadInfoQryBP.SOHeadInfoQryDTOData> result = (List<UFIDA.U9.Cust.FJGX.SOHeadInfoQryBP.SOHeadInfoQryDTOData>)InvokeAgent<UFIDA.U9.Cust.FJGX.SOHeadInfoQryBP.Proxy.IQueryBP>();
		...
		private List<UFIDA.U9.Cust.FJGX.SOHeadInfoQryBP.SOHeadInfoQryDTOData> GetRealResult(List<UFIDA.U9.Cust.FJGX.SOHeadInfoQryBP.SOHeadInfoQryDTOData> result)
		{
								return result ;
			}
		#region  Init KeyList 
