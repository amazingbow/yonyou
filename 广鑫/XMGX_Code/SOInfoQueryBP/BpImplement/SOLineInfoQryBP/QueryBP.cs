...
namespace UFIDA.U9.Cust.FJGX.SOLineInfoQryBP
{
	...
	public partial class QueryBP
	{
		...
		[Logger]
		[Authorize]
		public List<UFIDA.U9.Cust.FJGX.SOLineInfoQryBP.SOLineInfoQryDTO> Do()
		{	
		    BaseStrategy selector = Select();	
				List<UFIDA.U9.Cust.FJGX.SOLineInfoQryBP.SOLineInfoQryDTO> result =  (List<UFIDA.U9.Cust.FJGX.SOLineInfoQryBP.SOLineInfoQryDTO>)selector.Execute(this);	
