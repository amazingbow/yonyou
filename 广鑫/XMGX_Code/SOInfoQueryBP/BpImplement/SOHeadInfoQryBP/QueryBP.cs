...
namespace UFIDA.U9.Cust.FJGX.SOHeadInfoQryBP
{
	...
	public partial class QueryBP
	{
		...
		[Logger]
		[Authorize]
		public List<UFIDA.U9.Cust.FJGX.SOHeadInfoQryBP.SOHeadInfoQryDTO> Do()
		{	
		    BaseStrategy selector = Select();	
				List<UFIDA.U9.Cust.FJGX.SOHeadInfoQryBP.SOHeadInfoQryDTO> result =  (List<UFIDA.U9.Cust.FJGX.SOHeadInfoQryBP.SOHeadInfoQryDTO>)selector.Execute(this);	
