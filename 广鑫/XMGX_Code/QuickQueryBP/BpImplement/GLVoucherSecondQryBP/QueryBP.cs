...
namespace UFIDA.U9.Cust.FJGX.GLVoucherSecondQryBP
{
	...
	public partial class QueryBP
	{
		...
		[Logger]
		[Authorize]
		public List<UFIDA.U9.Cust.FJGX.GLVoucherSecondQryBP.GLVoucherSecondQryDTO> Do()
		{	
		    BaseStrategy selector = Select();	
				List<UFIDA.U9.Cust.FJGX.GLVoucherSecondQryBP.GLVoucherSecondQryDTO> result =  (List<UFIDA.U9.Cust.FJGX.GLVoucherSecondQryBP.GLVoucherSecondQryDTO>)selector.Execute(this);	
