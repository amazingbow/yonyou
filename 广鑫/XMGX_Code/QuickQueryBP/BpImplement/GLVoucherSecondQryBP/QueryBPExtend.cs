...
namespace UFIDA.U9.Cust.FJGX.GLVoucherSecondQryBP
{
    ...
    internal partial class QueryBPImpementStrategy
    {
       //实体FullName
        ...
        {
             //TODO:
            return "UFIDA.U9.GL.Voucher.Voucher";
        }
        /// <summary>
        ...
        private string DoLogic(UFIDA.U9.Query.QueryCaseBP.QryCommonParaObj bpParameter)
        {
            ...
            //处理From部份，形成From子句
            simpleTool.SetFromClause("UFIDA::U9::GL::Voucher::Voucher as Voucher");//在这里替换From子句中的实体名称
        ...
        {
            UFIDA.UBF.Query.CommonService.QryPaginateService<UFIDA.U9.Cust.FJGX.GLVoucherSecondQryBP.GLVoucherSecondQryDTO> ps = new UFIDA.UBF.Query.CommonService.QryPaginateService<UFIDA.U9.Cust.FJGX.GLVoucherSecondQryBP.GLVoucherSecondQryDTO>(bpParameter, isNeedTempTable());
    ...
    internal partial class QueryBPImpementStrategy
    {
        ...
        public readonly static string ARDocNo = "ARDocNo";
        public readonly static string CreateDate = "CreateDate";
        public readonly static string CreatedBy = "CreatedBy";
        public readonly static string Memo = "Memo";
        public readonly static string AccountedDr = "AccountedDr";
        public readonly static string AccountedCr = "AccountedCr";
        public readonly static string ID = "ID";
        public readonly static string SumDr = "SumDr";
        #endregion

        private void DoMap()
        {
            //公司名称
            map.Add(CompanyName, "Voucher.ClearingCompany.Name");
            //应收单据
            map.Add(ARDocNo, "'测试'");
            //制单日期
            map.Add(CreateDate, "Voucher.CreateDate");
            //制单人
            map.Add(CreatedBy, "Voucher.Poster");
            //摘要
            map.Add(Memo, "''");
            //借方金额
            map.Add(AccountedDr, "Voucher.AccountedDr");
            //贷方金额
            map.Add(AccountedCr, "Voucher.AccountedCr");
            //ID
            map.Add(ID, "ID");
            //小计
            map.Add(SumDr, "(Voucher.AccountedDr - Voucher.AccountedCr)");
        }
    }
    #endregion
