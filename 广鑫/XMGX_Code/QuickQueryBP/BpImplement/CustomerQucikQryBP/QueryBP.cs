...
namespace UFIDA.U9.Cust.FJGX.CustomerQucikQryBP
{
	...
	public partial class QueryBP
	{
		...
		[Logger]
		[Authorize]
		public List<UFIDA.U9.Cust.FJGX.CustomerQucikQryBP.CustomerQucikQryDTO> Do()
		{	
		    BaseStrategy selector = Select();	
				List<UFIDA.U9.Cust.FJGX.CustomerQucikQryBP.CustomerQucikQryDTO> result =  (List<UFIDA.U9.Cust.FJGX.CustomerQucikQryBP.CustomerQucikQryDTO>)selector.Execute(this);	
