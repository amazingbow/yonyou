...
namespace UFIDA.U9.Cust.FJGX.SOSecondQryBP
{
	...
	public partial class QueryBP
	{
		...
		[Logger]
		[Authorize]
		public List<UFIDA.U9.Cust.FJGX.SOSecondQryBP.SOSecondQryDTO> Do()
		{	
		    BaseStrategy selector = Select();	
				List<UFIDA.U9.Cust.FJGX.SOSecondQryBP.SOSecondQryDTO> result =  (List<UFIDA.U9.Cust.FJGX.SOSecondQryBP.SOSecondQryDTO>)selector.Execute(this);	
