...
namespace UFIDA.U9.Cust.FJGX.SuppplierVoucherQryBP
{
	...
	public partial class QueryBP
	{
		...
		[Logger]
		[Authorize]
		public List<UFIDA.U9.Cust.FJGX.SuppplierVoucherQryBP.SuppplierVoucherQryDTO> Do()
		{	
		    BaseStrategy selector = Select();	
				List<UFIDA.U9.Cust.FJGX.SuppplierVoucherQryBP.SuppplierVoucherQryDTO> result =  (List<UFIDA.U9.Cust.FJGX.SuppplierVoucherQryBP.SuppplierVoucherQryDTO>)selector.Execute(this);	
