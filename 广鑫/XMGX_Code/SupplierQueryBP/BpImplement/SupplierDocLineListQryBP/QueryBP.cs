...
namespace UFIDA.U9.Cust.FJGX.SupplierDocLineListQryBP
{
	...
	public partial class QueryBP
	{
		...
		[Logger]
		[Authorize]
		public List<UFIDA.U9.Cust.FJGX.SupplierDocLineListQryBP.SupplierDocLineListQryDTO> Do()
		{	
		    BaseStrategy selector = Select();	
				List<UFIDA.U9.Cust.FJGX.SupplierDocLineListQryBP.SupplierDocLineListQryDTO> result =  (List<UFIDA.U9.Cust.FJGX.SupplierDocLineListQryBP.SupplierDocLineListQryDTO>)selector.Execute(this);	
