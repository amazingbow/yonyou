...
namespace UFIDA.U9.Cust.FJGX.SupplierDocListQryBP
{
	...
	public partial class QueryBP
	{
		...
		[Logger]
		[Authorize]
		public List<UFIDA.U9.Cust.FJGX.SupplierDocListQryBP.SupplierDocListQryDTO> Do()
		{	
		    BaseStrategy selector = Select();	
				List<UFIDA.U9.Cust.FJGX.SupplierDocListQryBP.SupplierDocListQryDTO> result =  (List<UFIDA.U9.Cust.FJGX.SupplierDocListQryBP.SupplierDocListQryDTO>)selector.Execute(this);	
