...
namespace UFIDA.U9.Cust.FJGX.SupplierQryBP
{
	...
	public partial class QueryBP
	{
		...
		[Logger]
		[Authorize]
		public List<UFIDA.U9.Cust.FJGX.SupplierQryBP.SupplierQryDTO> Do()
		{	
		    BaseStrategy selector = Select();	
				List<UFIDA.U9.Cust.FJGX.SupplierQryBP.SupplierQryDTO> result =  (List<UFIDA.U9.Cust.FJGX.SupplierQryBP.SupplierQryDTO>)selector.Execute(this);	
