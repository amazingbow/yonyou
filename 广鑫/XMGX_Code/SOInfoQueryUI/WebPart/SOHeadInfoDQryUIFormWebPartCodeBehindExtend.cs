...
{
    public partial class SOHeadInfoDQryUIFormWebPart
    {
        ...
        {
            decimal sumTotalMoney = this.Model.QueryView.Records.Count == 0 ? 0 :
                          decimal.Parse(this.Model.QueryView.Records[0]["SumTotalMoney"].ToString());
            this.Label2.Text = sumTotalMoney.ToString("F2");

            decimal SumTotalShipMoney = this.Model.QueryView.Records.Count == 0 ? 0 : decimal.Parse(this.Model.QueryView.Records[0]["SumTotalShipMoney"].ToString());
            this.Label4.Text = SumTotalShipMoney.ToString("F2");
