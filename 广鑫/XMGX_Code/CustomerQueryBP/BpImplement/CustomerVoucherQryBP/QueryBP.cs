...
namespace UFIDA.U9.Cust.FJGX.CustomerVoucherQryBP
{
	...
	public partial class QueryBP
	{
		...
		[Logger]
		[Authorize]
		public List<UFIDA.U9.Cust.FJGX.CustomerVoucherQryBP.CustomerVoucherQryDTO> Do()
		{	
		    BaseStrategy selector = Select();	
				List<UFIDA.U9.Cust.FJGX.CustomerVoucherQryBP.CustomerVoucherQryDTO> result =  (List<UFIDA.U9.Cust.FJGX.CustomerVoucherQryBP.CustomerVoucherQryDTO>)selector.Execute(this);	
