...
namespace UFIDA.U9.Cust.FJGX.CustomerDocLineListQryBP
{
	...
	public partial class QueryBP
	{
		...
		[Logger]
		[Authorize]
		public List<UFIDA.U9.Cust.FJGX.CustomerDocLineListQryBP.CustomerDocLineListQryDTO> Do()
		{	
		    BaseStrategy selector = Select();	
				List<UFIDA.U9.Cust.FJGX.CustomerDocLineListQryBP.CustomerDocLineListQryDTO> result =  (List<UFIDA.U9.Cust.FJGX.CustomerDocLineListQryBP.CustomerDocLineListQryDTO>)selector.Execute(this);	
