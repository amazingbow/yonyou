...
namespace UFIDA.U9.Cust.FJGX.CustomerQryBP
{
	...
	public partial class QueryBP
	{
		...
		[Logger]
		[Authorize]
		public List<UFIDA.U9.Cust.FJGX.CustomerQryBP.CustomerQryDTO> Do()
		{	
		    BaseStrategy selector = Select();	
				List<UFIDA.U9.Cust.FJGX.CustomerQryBP.CustomerQryDTO> result =  (List<UFIDA.U9.Cust.FJGX.CustomerQryBP.CustomerQryDTO>)selector.Execute(this);	
