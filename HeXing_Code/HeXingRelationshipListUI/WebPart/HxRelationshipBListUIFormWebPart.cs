...
/***********************************************************************************************
 * Form ID:26612d60-22f3-49cd-8043-b4984c4c0f14 
 * Form Name:HxRelationshipBListUIForm
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace UFIDA.U9.Cust.HeXingRelationshipListUI.HxRelationshipBListUIModel
{
	[FormRegister("UFIDA.U9.Cust.HeXingRelationshipListUI","UFIDA.U9.Cust.HeXingRelationshipListUI.HxRelationshipBListUIModel.HxRelationshipBListUIFormWebPart", "UFIDA.U9.Cust.HeXingRelationshipListUI.WebPart", "26612d60-22f3-49cd-8043-b4984c4c0f14","WebPart", "True", 992, 504)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.HeXingRelationshipListUI', 'UFIDA.U9.Cust.HeXingRelationshipListUI.HxRelationshipBListUIModel.HxRelationshipBListUIFormWebPart', 'UFIDA.U9.Cust.HeXingRelationshipListUI.WebPart', '26612d60-22f3-49cd-8043-b4984c4c0f14')
	///<siteMapNode url="~/erp/simple.aspx?lnk=26612d60-22f3-49cd-8043-b4984c4c0f14" title="HxRelationshipBListUIForm"/>
    public partial class HxRelationshipBListUIFormWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(HxRelationshipBListUIFormWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new HxRelationshipBListUIModelAction Action
		{
			get { return (HxRelationshipBListUIModelAction)base.Action; }
			set { base.Action = value; }
		}
		HxRelationshipBListUIModelModel _uimodel=null;
		public new HxRelationshipBListUIModelModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new HxRelationshipBListUIModelModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as HxRelationshipBListUIModelModel;
            }
        }
		#endregion 
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new HxRelationshipBListUIModelModel();
				}
			...
			{
				//去除.已经移入到OnInit()中.
				//this.Model = (HxRelationshipBListUIModelModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new HxRelationshipBListUIModelAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"HxRelationshipBListUIForm",true,992,504);
        ...
        private void _BuilderControl_Toolbar1(IUFContainer container)
        {
            ...
            ///foreach Toolbar下的所有控件，增加到此容器
                            this.BtnNew = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnNew", "True", "True", 35, 28,"1", "N",true,false,"19478b02-d2a9-4d7e-b7af-00070c61ff2d","19478b02-d2a9-4d7e-b7af-00070c61ff2d","869b4742-e39b-4460-bce8-472e5adc5db0");
		
            UIControlBuilder.SetButtonAccessKey(this.BtnNew);
            this.BtnNew.UIModel = this.Model.ElementID;
            this.BtnNew.Action = "OnNew";
	                            this.BtnDelete = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnDelete", "True", "True", 35, 28,"2", "R",true,false,"0467218f-229b-4954-b2d4-3c5976467f76","0467218f-229b-4954-b2d4-3c5976467f76","e1e5cacb-28b8-4fff-8aa1-fe4ab432b12c");
            ...
            this.BtnDelete.Action = "OnDelete";
	                            _Toolbar.Controls.Add(new UFWebToolbarSeparatorAdapter());
			                            this.BtnOutPut = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnOutPut", "True", "True", 35, 28,"4", "O",true,false,"688fd549-5a92-49cc-8072-6d5377f6409a","688fd549-5a92-49cc-8072-6d5377f6409a","2dcd9265-89f5-46a9-a1f1-453a45426024");
            ...
            this.BtnOutPut.Action = "OnOutPut";
	                            this.BtnPrint = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnPrint", "True", "True", 35, 28,"5", "P",true,false,"27b5c615-cde5-458c-be74-833317249568","27b5c615-cde5-458c-be74-833317249568","e9471b2c-c8c9-4d55-bed8-6c620fcb1241");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card0",false,"FunctionBar", true, true, "3","","a9d987ed-51bf-497f-8d7f-b3da77699dca");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 80, 20, 13, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","6e106564-d0a0-4b19-8599-dd07c8949d5e");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "2");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 120, 20, 15, 0, 1, 1, "100",true,false,"","","df236d33-6037-44bd-8066-b31b69fe062c");
			...
			UIControlBuilder.BuilderUFControl(this.DDLCase, "3");		
				...
				this.OnLookCase = UIControlBuilder.BuilderUFButton(_UFCard, true, "OnLookCase", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"OnLookCase",false,"b9e85f5f-00bf-4711-9bf5-3635ffdb2170","b9e85f5f-00bf-4711-9bf5-3635ffdb2170","f8988aa4-ffa1-445c-a222-9360d4b427ce");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card3",false,"none", true, true, "2","","e7274feb-5584-4251-9195-d5092aeb4a6c");
		...
		{
			QryService.BindEnum("DDLCase", this, "b831d336-4857-43f2-aba0-78974da27eab");
		}
