...
namespace UFIDA.U9.Cust.HeXingProjectSV.HeXingCreateSAPU9GLVoucherSV
{
	...
	/// 
	/// </summary>
	[DataContract(Name = "UFIDA.U9.Cust.HeXingProjectSV.HeXingCreateSAPU9GLVoucherSV.SAPU9GLVoucherDTOData", Namespace = "http://www.UFIDA.org/EntityData",IsReference=true)]
	[Serializable]
	...
	public partial class SAPU9GLVoucherDTOData : UFSoft.UBF.Business.DataTransObjectBase
	{
		public static IList<Type> GetKnownTypes()
        {
            ...
            knownTypes.Add(typeof(List<UFIDA.U9.Cust.HeXingProjectSV.HeXingCreateSAPU9GLVoucherSV.SAPU9GLVoucherLineDTOData>)); 
		...
		public void DoSerializeKeyList(IDictionary dict)
		{
			...
			{
				foreach(UFIDA.U9.Cust.HeXingProjectSV.HeXingCreateSAPU9GLVoucherSV.SAPU9GLVoucherLineDTOData objdata in this.SAPU9GLVoucherLineDTOS)
				{
		...
		/// </summary>
		[DataMember(IsRequired=false)]
		private System.Int64 m_postedPeriod ;
		...
		/// </summary>
		[DataMember(IsRequired=false)]
		private List<UFIDA.U9.Cust.HeXingProjectSV.HeXingCreateSAPU9GLVoucherSV.SAPU9GLVoucherLineDTOData> m_sAPU9GLVoucherLineDTOS ;
		public List<UFIDA.U9.Cust.HeXingProjectSV.HeXingCreateSAPU9GLVoucherSV.SAPU9GLVoucherLineDTOData> SAPU9GLVoucherLineDTOS
		{
			get	
			{	
				if (m_sAPU9GLVoucherLineDTOS == null )
				{
					List<UFIDA.U9.Cust.HeXingProjectSV.HeXingCreateSAPU9GLVoucherSV.SAPU9GLVoucherLineDTOData> n_m_list = new List<UFIDA.U9.Cust.HeXingProjectSV.HeXingCreateSAPU9GLVoucherSV.SAPU9GLVoucherLineDTOData>() ;
