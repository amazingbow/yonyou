...
{
	public partial class HeXingRelationshipUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(HeXingRelationshipUIModelAction));
		//强类型化基类Model属性.
		public new HeXingRelationshipUIModelModel CurrentModel 
		{
			get {
				return (HeXingRelationshipUIModelModel)base.CurrentModel;
			}
			set {
		...
		public HeXingRelationshipUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public HeXingRelationshipUIModelAction(HeXingRelationshipUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 
		...
		/// Help: 执行
		/// </summary>
		public void ExecuteClick(object sender, UIActionEventArgs e)
		{
			//调用基类委托..
			this.InvokeAction(sender,e,this.ExecuteClick_Extend);
		}
		private void ExecuteClick_DefaultImpl(object sender, UIActionEventArgs e)
		{
