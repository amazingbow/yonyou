...
namespace UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV
{
	...
	public  partial class SAPU9GLVoucherLineDTO  : UFSoft.UBF.Business.DTOBase
	{
		...
		/// </summary>
		/// <value>UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV.SAPU9GLVoucherDTO</value>
		public UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV.SAPU9GLVoucherDTO SAPU9GLVoucherDTO
		{
			get	
			{	
				return (UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV.SAPU9GLVoucherDTO)base.GetValue("SAPU9GLVoucherDTO",typeof(UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV.SAPU9GLVoucherDTO));
			}
		...
		public System.Int32 SerialNo
		{
			get	
			{	
				return (System.Int32)base.GetValue("SerialNo",typeof(System.Int32));
			}
		...
		public void FromEntityData(SAPU9GLVoucherLineDTOData data,IDictionary dict)
		{
			...
			{
				UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV.SAPU9GLVoucherDTO temp = dict[data.SAPU9GLVoucherDTO] as UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV.SAPU9GLVoucherDTO ;
				if (temp == null)
				{
					temp = new UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV.SAPU9GLVoucherDTO();
