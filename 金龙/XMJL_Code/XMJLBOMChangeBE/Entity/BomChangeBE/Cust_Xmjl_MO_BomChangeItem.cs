...
namespace UFIDA.U9.Cust.XMJLBomChangeBE
{
	...
	/// </summary>
	[Serializable]	
	public  partial class Cust_Xmjl_MO_BomChangeItem : UFSoft.UBF.Business.BusinessEntity
	{
		...
		/// Constructor
		/// </summary>
		public Cust_Xmjl_MO_BomChangeItem(){
		}
		...
		public  static Cust_Xmjl_MO_BomChangeItem Create(UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChange parentEntity) {
			Cust_Xmjl_MO_BomChangeItem entity = (Cust_Xmjl_MO_BomChangeItem)UFSoft.UBF.Business.Entity.Create(CurrentClassKey, parentEntity);
			if (parentEntity == null)
				throw new ArgumentNullException("parentEntity");
			entity.Cust_Xmjl_MO_BomChange = parentEntity ;
			parentEntity.Cust_Xmjl_MO_BomChangeItem.Add(entity) ;
			return entity;
		}
		...
		/// </summary>
		protected Cust_Xmjl_MO_BomChangeItem(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			:base(info,context)
		{
		}
		...
		public  static Cust_Xmjl_MO_BomChangeItem CreateDefault(UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChange parentEntity) {
		#if Test		
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChangeItem");
			}
		}
		...
		#region EntityKey
		/// <summary>
		/// Strong Class Cust_Xmjl_MO_BomChangeItem EntityKey 
		/// </summary>
		[Serializable()]
	    [DataContract(Name = "EntityKey", Namespace = "UFSoft.UBF.Business.BusinessEntity")]
		public new partial class EntityKey : UFSoft.UBF.Business.BusinessEntity.EntityKey
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChangeItem")
			{}
			...
			/// </summary>
			public new Cust_Xmjl_MO_BomChangeItem GetEntity()
			{
				return (Cust_Xmjl_MO_BomChangeItem)base.GetEntity();
			}
		...
		/// </summary>
		public new partial class EntityFinder : UFSoft.UBF.Business.BusinessEntity.EntityFinder<Cust_Xmjl_MO_BomChangeItem> 
		{
		...
		/// EntityList
		/// </summary>
		public partial class EntityList :UFSoft.UBF.Business.Entity.EntityList<Cust_Xmjl_MO_BomChangeItem>{
		    #region constructor 
		    /// <summary>
		...
		{
		    //private Cust_Xmjl_MO_BomChangeItem ContainerEntity ;
		    public  new Cust_Xmjl_MO_BomChangeItem ContainerEntity 
		    {
				get { return  (Cust_Xmjl_MO_BomChangeItem)base.ContainerEntity ;}
				set { base.ContainerEntity = value ;}
		    }
		    
		    public EntityOriginal(Cust_Xmjl_MO_BomChangeItem container)
		    {
				if (container == null )
		...
		public  UFIDA.U9.CBO.SCM.Supplier.Supplier.EntityKey SupplierKey
		{
			...
			public  System.Decimal DistQty
			{
				get
				{
					System.Decimal value  = (System.Decimal)base.GetValue("DistQty");
					return value;
						}
			}
		...
		/// </summary>
		[Obsolete("")]
		public  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChangeItem")  ;}	}
		#endregion 		
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("DistQty")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_DistQty　{ get { return EntityRes.GetResource("DistQty");　}　}
		/// <summary>
		...
		public class EntityRes
		{
			...
			/// EntityName的名称
			/// </summary>
			public static string BE_Name { get { return "Cust_Xmjl_MO_BomChangeItem";　}　}
			
			/// <summary>
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChangeItem";　}　}
			...
			/// 属性: 发料数量 的名称
			/// </summary>
			public static string DistQty　{ get { return "DistQty";　}　}
        ...
        public override void IniData()
        {
			...
			this.exdMultiLangAttrs.Add("DistQty","DistQty");
		...
		private void DeSerializeKey(Cust_Xmjl_MO_BomChangeItemData data)
		{
        ...
        {
			Cust_Xmjl_MO_BomChangeItemData data = dto as Cust_Xmjl_MO_BomChangeItemData ;
			if (data == null)
				return ;
		...
		/// </summary>
		public void FromEntityData(Cust_Xmjl_MO_BomChangeItemData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(Cust_Xmjl_MO_BomChangeItemData data,IDictionary dict)
		{
			if (data == null)
				return;
			...
			//ID与系统字段不处理 --Sysversion需要处理。
								...
								this.SetTypeValue("DistQty",data.DistQty);
		...
		/// </summary>
		public Cust_Xmjl_MO_BomChangeItemData ToEntityData()
		{
		...
		/// </summary>
		public Cust_Xmjl_MO_BomChangeItemData ToEntityData(Cust_Xmjl_MO_BomChangeItemData data, IDictionary dict){
			if (data == null)
				data = new Cust_Xmjl_MO_BomChangeItemData();
			
			if (dict == null ) dict = new Hashtable() ;
			//就直接用ID,如果不同实体会出现相同ID，则到时候要改进。? ID一定要有。
			dict["UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChangeItem"+this.ID.ToString()] = data;
			...
			{
				object obj =this.GetValue("DistQty");
				if (obj != null)
					data.DistQty=(System.Decimal)obj;
			}
