...
namespace UFIDA.U9.Cust.XMJLBomChangeBE
{
	...
	/// </summary>
	[Serializable]	
	public  partial class Cust_Xmjl_MO_BomChangeManufactureNo : UFSoft.UBF.Business.BusinessEntity
	{
		...
		/// Constructor
		/// </summary>
		public Cust_Xmjl_MO_BomChangeManufactureNo(){
		}
		...
		public  static Cust_Xmjl_MO_BomChangeManufactureNo Create(UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChange parentEntity) {
			Cust_Xmjl_MO_BomChangeManufactureNo entity = (Cust_Xmjl_MO_BomChangeManufactureNo)UFSoft.UBF.Business.Entity.Create(CurrentClassKey, parentEntity);
			if (parentEntity == null)
				throw new ArgumentNullException("parentEntity");
			entity.Cust_Xmjl_MO_BomChange = parentEntity ;
			parentEntity.Cust_Xmjl_MO_BomChangeManufactureNo.Add(entity) ;
			return entity;
		}
		...
		/// </summary>
		protected Cust_Xmjl_MO_BomChangeManufactureNo(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			:base(info,context)
		{
		}
		...
		public  static Cust_Xmjl_MO_BomChangeManufactureNo CreateDefault(UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChange parentEntity) {
		#if Test		
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChangeManufactureNo");
			}
		}
		...
		#region EntityKey
		/// <summary>
		/// Strong Class Cust_Xmjl_MO_BomChangeManufactureNo EntityKey 
		/// </summary>
		[Serializable()]
	    [DataContract(Name = "EntityKey", Namespace = "UFSoft.UBF.Business.BusinessEntity")]
		public new partial class EntityKey : UFSoft.UBF.Business.BusinessEntity.EntityKey
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChangeManufactureNo")
			{}
			...
			/// </summary>
			public new Cust_Xmjl_MO_BomChangeManufactureNo GetEntity()
			{
				return (Cust_Xmjl_MO_BomChangeManufactureNo)base.GetEntity();
			}
		...
		/// </summary>
		public new partial class EntityFinder : UFSoft.UBF.Business.BusinessEntity.EntityFinder<Cust_Xmjl_MO_BomChangeManufactureNo> 
		{
		...
		/// EntityList
		/// </summary>
		public partial class EntityList :UFSoft.UBF.Business.Entity.EntityList<Cust_Xmjl_MO_BomChangeManufactureNo>{
		    #region constructor 
		    /// <summary>
		...
		{
		    //private Cust_Xmjl_MO_BomChangeManufactureNo ContainerEntity ;
		    public  new Cust_Xmjl_MO_BomChangeManufactureNo ContainerEntity 
		    {
				get { return  (Cust_Xmjl_MO_BomChangeManufactureNo)base.ContainerEntity ;}
				set { base.ContainerEntity = value ;}
		    }
		    
		    public EntityOriginal(Cust_Xmjl_MO_BomChangeManufactureNo container)
		    {
				if (container == null )
			...
			/// </summary>
			/// <value></value>
			public  UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChange Cust_Xmjl_MO_BomChange
			{
				get
				{
					if (Cust_Xmjl_MO_BomChangeKey == null)
						return null ;
					UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChange value =  (UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChange)Cust_Xmjl_MO_BomChangeKey.GetEntity();
					return value ;
				}
			}
   		...
   		private UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChange.EntityKey m_Cust_Xmjl_MO_BomChangeKey ;
		/// <summary>
		/// EntityKey 属性
		/// 缺件变更单 的Key (该属性可为空,且无默认值)
		/// 缺件变更车号行.Misc.缺件变更单
		/// </summary>
		/// <value></value>
		public  UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChange.EntityKey Cust_Xmjl_MO_BomChangeKey
		{
			get 
			{
				object obj = base.GetValue("Cust_Xmjl_MO_BomChange") ;
				if (obj == null || (Int64)obj==UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag || (Int64)obj==0)
					return null ;
				Int64 key = (System.Int64)obj ;
				if (m_Cust_Xmjl_MO_BomChangeKey==null || m_Cust_Xmjl_MO_BomChangeKey.ID != key )
					m_Cust_Xmjl_MO_BomChangeKey = new UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChange.EntityKey(key); 
				return m_Cust_Xmjl_MO_BomChangeKey ;
			}
		}
			...
			public  UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChange Cust_Xmjl_MO_BomChange
		{
			get
			{
				object  obj = this.GetRelation("Cust_Xmjl_MO_BomChange");
				if (obj == null)
				{
					return null ;
				}
				...
				{
					UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChange value  = (UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChange)obj;
					return value;
				 }
			}
				internal set
			{
				...
				this.SetRelation("Cust_Xmjl_MO_BomChange", value);
		...
		public  UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChange.EntityKey Cust_Xmjl_MO_BomChangeKey
		{
			...
			set
			{	
				if (Cust_Xmjl_MO_BomChangeKey==value)
					return ;
				this.SetRelation("Cust_Xmjl_MO_BomChange", null);
				m_Cust_Xmjl_MO_BomChangeKey = value ;
				if (value != null) 
				{
					base.SetValue("Cust_Xmjl_MO_BomChange",value.ID);
				}
				else
					base.SetValue("Cust_Xmjl_MO_BomChange",UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag);
			}
		}
		...
		/// </summary>
		[Obsolete("")]
		public  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChangeManufactureNo")  ;}	}
		#endregion 		
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("Cust_Xmjl_MO_BomChange")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_Cust_Xmjl_MO_BomChange　{ get { return EntityRes.GetResource("Cust_Xmjl_MO_BomChange");　}　}
		/// <summary>
		...
		public class EntityRes
		{
			...
			/// EntityName的名称
			/// </summary>
			public static string BE_Name { get { return "Cust_Xmjl_MO_BomChangeManufactureNo";　}　}
			
			/// <summary>
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChangeManufactureNo";　}　}
			...
			/// 属性: 缺件变更单 的名称
			/// </summary>
			public static string Cust_Xmjl_MO_BomChange　{ get { return "Cust_Xmjl_MO_BomChange";　}　}
        ...
        public override void IniData()
        {
			...
			this.exdMultiLangAttrs.Add("Cust_Xmjl_MO_BomChange","Cust_Xmjl_MO_BomChange");
		...
		private void DeSerializeKey(Cust_Xmjl_MO_BomChangeManufactureNoData data)
		{
        ...
        {
			Cust_Xmjl_MO_BomChangeManufactureNoData data = dto as Cust_Xmjl_MO_BomChangeManufactureNoData ;
			if (data == null)
				return ;
		...
		/// </summary>
		public void FromEntityData(Cust_Xmjl_MO_BomChangeManufactureNoData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(Cust_Xmjl_MO_BomChangeManufactureNoData data,IDictionary dict)
		{
			if (data == null)
				return;
			...
			#region 组件内属性
					...
					if (data.Cust_Xmjl_MO_BomChange!=null)
			{
				UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChange child = dict[data.Cust_Xmjl_MO_BomChange] as UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChange ;
				if (child == null)
				{
					if (data.Cust_Xmjl_MO_BomChange.ID>0)
					{
						if (data.Cust_Xmjl_MO_BomChange.SysState != UFSoft.UBF.PL.Engine.ObjectState.Inserted)
							child = (UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChange)(new UFSoft.UBF.Business.BusinessEntity.EntityKey(data.Cust_Xmjl_MO_BomChange.ID,data.Cust_Xmjl_MO_BomChange.SysEntityType).GetEntity());
						if (child==null) child = (UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChange)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(data.Cust_Xmjl_MO_BomChange.SysEntityType,null,data.Cust_Xmjl_MO_BomChange.ID,true) ;
					}
					else
					{
 						child = (UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChange)UFSoft.UBF.Business.Entity.CreateTransientObjWithKey(data.Cust_Xmjl_MO_BomChange.SysEntityType,null,null,true) ;				
 					}
					
					child.FromEntityData(data.Cust_Xmjl_MO_BomChange,dict);
				}
				this.Cust_Xmjl_MO_BomChange = child ;
			}
		...
		/// </summary>
		public Cust_Xmjl_MO_BomChangeManufactureNoData ToEntityData()
		{
		...
		/// </summary>
		public Cust_Xmjl_MO_BomChangeManufactureNoData ToEntityData(Cust_Xmjl_MO_BomChangeManufactureNoData data, IDictionary dict){
			if (data == null)
				data = new Cust_Xmjl_MO_BomChangeManufactureNoData();
			
			if (dict == null ) dict = new Hashtable() ;
			//就直接用ID,如果不同实体会出现相同ID，则到时候要改进。? ID一定要有。
			dict["UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChangeManufactureNo"+this.ID.ToString()] = data;
			...
			{
				object oID = this.GetValue("Cust_Xmjl_MO_BomChange");
				if (oID != null && (Int64)oID > 0 )
				{
					UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChangeData _Cust_Xmjl_MO_BomChange = dict["UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChange"+oID.ToString()] as UFIDA.U9.Cust.XMJLBomChangeBE.Cust_Xmjl_MO_BomChangeData;			
					data.Cust_Xmjl_MO_BomChange = (_Cust_Xmjl_MO_BomChange != null) ? _Cust_Xmjl_MO_BomChange : (this.Cust_Xmjl_MO_BomChange==null?null:this.Cust_Xmjl_MO_BomChange.ToEntityData(null,dict));
				}
			}
