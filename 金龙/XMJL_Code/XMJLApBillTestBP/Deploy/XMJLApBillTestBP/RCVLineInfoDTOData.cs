...
namespace UFIDA.U9.Cust.XMJL.XMJLApBillTestBP
{
	...
	/// 
	/// </summary>
	[DataContract(Name = "UFIDA.U9.Cust.XMJL.XMJLApBillTestBP.RCVLineInfoDTOData", Namespace = "http://www.UFIDA.org/EntityData",IsReference=true)]
	[Serializable]
	...
	public partial class RCVLineInfoDTOData : UFSoft.UBF.Business.DataTransObjectBase
	{
		...
		/// </summary>
		public RCVLineInfoDTOData(  System.Int64 rCVLine  , System.Decimal amount  , System.Decimal totalMoney  )
		{
			initData();
