...
namespace UFIDA.U9.Cust.XMJL.ItemSV.Proxy
{
	...
	[Serializable]    
    public class GetItemStoreProxy : ServiceProxyBase//, UFIDA.U9.Cust.XMJL.ItemSV.Proxy.IGetItemStore
    {
	#region Fields	
	...
	#region Constructors
        ...
        {
  			InitKeyList() ;
			List<UFIDA.U9.Cust.XMJL.ItemSV.ItemStoreDTOData> result = (List<UFIDA.U9.Cust.XMJL.ItemSV.ItemStoreDTOData>)InvokeBySite<UFIDA.U9.Cust.XMJL.ItemSV.Proxy.IGetItemStore>(targetSite);
        ...
        {
  			InitKeyList() ;
			List<UFIDA.U9.Cust.XMJL.ItemSV.ItemStoreDTOData> result = (List<UFIDA.U9.Cust.XMJL.ItemSV.ItemStoreDTOData>)InvokeByOrg<UFIDA.U9.Cust.XMJL.ItemSV.Proxy.IGetItemStore>(targetOrgId);
			return GetRealResult(result);
        }
		#endregion end跨组织调用
        ...
        {
  			InitKeyList() ;
 			List<UFIDA.U9.Cust.XMJL.ItemSV.ItemStoreDTOData> result = (List<UFIDA.U9.Cust.XMJL.ItemSV.ItemStoreDTOData>)InvokeAgent<UFIDA.U9.Cust.XMJL.ItemSV.Proxy.IGetItemStore>();
			return GetRealResult(result);
        }
		...
		protected override object InvokeImplement<T>(T oChannel)
        {
            ...
            IGetItemStore channel = oChannel as IGetItemStore;
            if (channel != null)
            {
				return channel.Do(context, out returnMsgs, isSum, excludeWHCode, itemCode);
	    }
            return  null;
        }
		#endregion
