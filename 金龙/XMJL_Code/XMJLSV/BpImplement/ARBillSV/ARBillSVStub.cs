...
namespace ARBillSV
{
    ...
    public class ARBillSVStub : ServiceStubBase, IARBillSV
    {
        #region IARBillSV Members
        ...
        public System.String DoEx(ICommonDataContract commonData, List<System.Int64> arBillHeadKey)
        {
            ...
            try
            {
                BeforeInvoke("ARBillSV.ARBillSV");                
                ARBillSV objectRef = new ARBillSV();
            ...
            {
				FinallyInvoke("ARBillSV.ARBillSV");
            }
        }
	#endregion
    }
