...
namespace UFIDA.U9.Cust.XMJL.APBillSV
{
	...
	/// 
	/// </summary>
	[DataContract(Name = "UFIDA.U9.Cust.XMJL.APBillSV.CommonResultDTOData", Namespace = "http://www.UFIDA.org/EntityData",IsReference=true)]
	[Serializable]
	...
	public partial class CommonResultDTOData : UFSoft.UBF.Business.DataTransObjectBase
	{
		...
		/// </summary>
		public CommonResultDTOData(  System.Boolean success  , System.String message  , System.Object resultObj  )
		{
			initData();
