...
namespace UFIDA.U9.Cust.XMJL.Bom
{
	...
	/// 
	/// </summary>
	[DataContract(Name = "UFIDA.U9.Cust.XMJL.Bom.BomHeadData", Namespace = "http://www.UFIDA.org/EntityData",IsReference=true)]	
	[Serializable]
    [KnownType("GetKnownTypes")]
	public partial class BomHeadData : UFSoft.UBF.Business.DataTransObjectBase
	{
	    ...
	    public static IList<Type> GetKnownTypes()
        {
            IList<Type> knownTypes = new List<Type>();
                                        ...
                                        knownTypes.Add(typeof(UFIDA.U9.Cust.XMJL.Bom.BomMainData));
                                        knownTypes.Add(typeof(List<UFIDA.U9.Cust.XMJL.Bom.BomLineData>));
		...
		{
			get { return "UFIDA.U9.Cust.XMJL.Bom.BomHead" ;}
		}
		#endregion
		...
		/// </summary>
		[DataMember(IsRequired=false)]
		private UFIDA.U9.Cust.XMJL.Bom.BomMainData m_bomMain;
		public UFIDA.U9.Cust.XMJL.Bom.BomMainData BomMain
		{
			get	
			{	
				return m_bomMain ;
		...
		/// </summary>
		[DataMember(IsRequired=false)]
		private List<UFIDA.U9.Cust.XMJL.Bom.BomLineData> m_bomLine;
		public List<UFIDA.U9.Cust.XMJL.Bom.BomLineData> BomLine
		{
			get	
			{	
				if (m_bomLine == null)
				{
					List<UFIDA.U9.Cust.XMJL.Bom.BomLineData> m_list = new List<UFIDA.U9.Cust.XMJL.Bom.BomLineData>() ;
					m_bomLine = m_list;
				}
				return m_bomLine ;
			}
