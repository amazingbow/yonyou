...
namespace UFIDA.U9.Cust.XMJL.Bom
{
	...
	/// 
	/// </summary>
	[DataContract(Name = "UFIDA.U9.Cust.XMJL.Bom.BomLineData", Namespace = "http://www.UFIDA.org/EntityData",IsReference=true)]	
	[Serializable]
    [KnownType("GetKnownTypes")]
	public partial class BomLineData : UFSoft.UBF.Business.DataTransObjectBase
	{
	    ...
	    public static IList<Type> GetKnownTypes()
        {
            IList<Type> knownTypes = new List<Type>();
                                        ...
                                        knownTypes.Add(typeof(UFIDA.U9.Cust.XMJL.Bom.BomHeadData));
		...
		{
			get { return "UFIDA.U9.Cust.XMJL.Bom.BomLine" ;}
		}
		#endregion
		...
		/// </summary>
		[DataMember(IsRequired=false)]
		private UFIDA.U9.Cust.XMJL.Bom.BomHeadData m_bomHead;
		public UFIDA.U9.Cust.XMJL.Bom.BomHeadData BomHead
		{
			get	
			{	
				return m_bomHead ;
