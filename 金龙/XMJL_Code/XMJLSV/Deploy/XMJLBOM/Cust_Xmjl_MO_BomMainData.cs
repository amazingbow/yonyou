...
namespace UFIDA.U9.Cust.XMJL.BomBE
{
	...
	/// 
	/// </summary>
	[DataContract(Name = "UFIDA.U9.Cust.XMJL.BomBE.Cust_Xmjl_MO_BomMainData", Namespace = "http://www.UFIDA.org/EntityData",IsReference=true)]	
	[Serializable]
    [KnownType("GetKnownTypes")]
	public partial class Cust_Xmjl_MO_BomMainData : UFSoft.UBF.Business.DataTransObjectBase
	{
	    ...
	    public static IList<Type> GetKnownTypes()
        {
            IList<Type> knownTypes = new List<Type>();
                                        ...
                                        knownTypes.Add(typeof(List<UFIDA.U9.Cust.XMJL.BomBE.Cust_Xmjl_MO_BomHeadData>));
		...
		{
			get { return "UFIDA.U9.Cust.XMJL.BomBE.Cust_Xmjl_MO_BomMain" ;}
		}
		#endregion
		...
		/// </summary>
		[DataMember(IsRequired=false)]
		private List<UFIDA.U9.Cust.XMJL.BomBE.Cust_Xmjl_MO_BomHeadData> m_bomHead;
		public List<UFIDA.U9.Cust.XMJL.BomBE.Cust_Xmjl_MO_BomHeadData> BomHead
		{
			get	
			{	
				if (m_bomHead == null)
				{
					List<UFIDA.U9.Cust.XMJL.BomBE.Cust_Xmjl_MO_BomHeadData> m_list = new List<UFIDA.U9.Cust.XMJL.BomBE.Cust_Xmjl_MO_BomHeadData>() ;
					m_bomHead = m_list;
				}
				return m_bomHead ;
			}
