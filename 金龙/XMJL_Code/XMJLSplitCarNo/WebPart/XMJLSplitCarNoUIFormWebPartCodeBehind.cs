    ...
    public partial class XMJLSplitCarNoUIFormWebPart
    {
        ...
        private void BtnSave_Click_DefaultImpl(object sender, EventArgs e)
        {
			...
			//throw new NotImplementedException() ;
				...
				//MethodName:BtnDelete_Click ActionName:
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        ...
        #region Grid控件DataGrid6的分页事件	
        void UFGridDataGrid6_GridMakePageEventHandler(Object sender, GridMakePageEventArgs  e)
        {
            //Grid的首页、下页、上页、末页处理逻辑
			UFIDA.U9.UI.Commands.CommandFactory.DoCommand("GridMakePage",this.Action,this.DataGrid6,e);
        }
        #endregion

        #region Grid控件DataGrid6的客户化筛选事件	
        void UFGridDataGrid6_GridCustomFilterHandler(Object sender, GridCustomFilterArgs  e)
        {
            //Grid的客户化筛选，首条、上一条、下一条、末条处理逻辑
			UFIDA.U9.UI.Commands.CommandFactory.DoCommand("GridCustomFilter",this.Action,this.DataGrid6,e);
        }
        #endregion
	
        #region Grid控件DataGrid7的分页事件	
        void UFGridDataGrid7_GridMakePageEventHandler(Object sender, GridMakePageEventArgs  e)
        {
            //Grid的首页、下页、上页、末页处理逻辑
			UFIDA.U9.UI.Commands.CommandFactory.DoCommand("GridMakePage",this.Action,this.DataGrid7,e);
        }
        #endregion

        #region Grid控件DataGrid7的客户化筛选事件	
        void UFGridDataGrid7_GridCustomFilterHandler(Object sender, GridCustomFilterArgs  e)
        {
            //Grid的客户化筛选，首条、上一条、下一条、末条处理逻辑
			UFIDA.U9.UI.Commands.CommandFactory.DoCommand("GridCustomFilter",this.Action,this.DataGrid7,e);
        }
        #endregion
