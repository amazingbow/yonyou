...
namespace UFIDA.U9.Cust.XMJL.BommBE
{
	...
	/// </summary>
	[Serializable]	
	public  partial class Cust_Xmjl_MO_BomHead : UFSoft.UBF.Business.BusinessEntity
	{
		...
		public  static Cust_Xmjl_MO_BomHead Create(UFIDA.U9.Cust.XMJL.BommBE.Cust_Xmjl_MO_BomMain parentEntity) {
			Cust_Xmjl_MO_BomHead entity = (Cust_Xmjl_MO_BomHead)UFSoft.UBF.Business.Entity.Create(CurrentClassKey, parentEntity);
			if (parentEntity == null)
				throw new ArgumentNullException("parentEntity");
			entity.Cust_Xmjl_MO_BomMain = parentEntity ;
			parentEntity.Cust_Xmjl_MO_BomHead.Add(entity) ;
			return entity;
		}
		...
		/// </summary>
		protected Cust_Xmjl_MO_BomHead(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			:base(info,context)
		{
		}
		...
		public  static Cust_Xmjl_MO_BomHead CreateDefault(UFIDA.U9.Cust.XMJL.BommBE.Cust_Xmjl_MO_BomMain parentEntity) {
		#if Test		
        ...
        {
            get { return "UFIDA.U9.Cust.XMJL.BommBE.Cust_Xmjl_MO_BomHead"; }    
        }
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.XMJL.BommBE.Cust_Xmjl_MO_BomHead");
			}
		}
		...
		#region EntityKey
		/// <summary>
		/// Strong Class Cust_Xmjl_MO_BomHead EntityKey 
		/// </summary>
		[Serializable()]
	    [DataContract(Name = "EntityKey", Namespace = "UFSoft.UBF.Business.BusinessEntity")]
		public new partial class EntityKey : UFSoft.UBF.Business.BusinessEntity.EntityKey
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.XMJL.BommBE.Cust_Xmjl_MO_BomHead")
			{}
			...
			/// </summary>
			public new Cust_Xmjl_MO_BomHead GetEntity()
			{
				return (Cust_Xmjl_MO_BomHead)base.GetEntity();
			}
		...
		/// </summary>
		public new partial class EntityFinder : UFSoft.UBF.Business.BusinessEntity.EntityFinder<Cust_Xmjl_MO_BomHead> 
		{
		...
		/// EntityList
		/// </summary>
		public partial class EntityList :UFSoft.UBF.Business.Entity.EntityList<Cust_Xmjl_MO_BomHead>{
		    #region constructor 
		    /// <summary>
		...
		{
		    //private Cust_Xmjl_MO_BomHead ContainerEntity ;
		    public  new Cust_Xmjl_MO_BomHead ContainerEntity 
		    {
				get { return  (Cust_Xmjl_MO_BomHead)base.ContainerEntity ;}
				set { base.ContainerEntity = value ;}
		    }
		    
		    public EntityOriginal(Cust_Xmjl_MO_BomHead container)
		    {
				if (container == null )
		...
		public  UFIDA.U9.CBO.SCM.Warehouse.Warehouse.EntityKey WareHouseKey
		{
			...
			public  System.Int32 Qty
			{
				get
				{
					System.Int32 value  = (System.Int32)base.GetValue("Qty");
					return value;
						}
			}
			...
			public  System.Int32 DisbursedQty
			{
				get
				{
					System.Int32 value  = (System.Int32)base.GetValue("DisbursedQty");
					return value;
						}
			}
		...
		public  UFIDA.U9.Cust.XMJL.BommBE.Cust_Xmjl_MO_BomLine.EntityList Cust_Xmjl_MO_BomLine
		{
			...
			{
				if (m_Cust_Xmjl_MO_BomLine == null)
					m_Cust_Xmjl_MO_BomLine = new UFIDA.U9.Cust.XMJL.BommBE.Cust_Xmjl_MO_BomLine.EntityList("Cust_Xmjl_MO_BomHead",this,"Cust_Xmjl_MO_BomLine",(IList)this.GetRelation("Cust_Xmjl_MO_BomLine"));
				else
		...
		/// </summary>
		[Obsolete("")]
		public  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.XMJL.BommBE.Cust_Xmjl_MO_BomHead")  ;}	}
		#endregion 		
		...
		public class EntityRes
		{
			...
			/// EntityName的名称
			/// </summary>
			public static string BE_Name { get { return "Cust_Xmjl_MO_BomHead";　}　}
			
			/// <summary>
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.XMJL.BommBE.Cust_Xmjl_MO_BomHead";　}　}
		...
		private void DeSerializeKey(Cust_Xmjl_MO_BomHeadData data)
		{
        ...
        {
			Cust_Xmjl_MO_BomHeadData data = dto as Cust_Xmjl_MO_BomHeadData ;
			if (data == null)
				return ;
		...
		/// </summary>
		public void FromEntityData(Cust_Xmjl_MO_BomHeadData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(Cust_Xmjl_MO_BomHeadData data,IDictionary dict)
		{
			if (data == null)
				return;
		...
		/// </summary>
		public Cust_Xmjl_MO_BomHeadData ToEntityData()
		{
		...
		/// </summary>
		public Cust_Xmjl_MO_BomHeadData ToEntityData(Cust_Xmjl_MO_BomHeadData data, IDictionary dict){
			if (data == null)
				data = new Cust_Xmjl_MO_BomHeadData();
			
			if (dict == null ) dict = new Hashtable() ;
			//就直接用ID,如果不同实体会出现相同ID，则到时候要改进。? ID一定要有。
			dict["UFIDA.U9.Cust.XMJL.BommBE.Cust_Xmjl_MO_BomHead"+this.ID.ToString()] = data;
	    ...
	    
			{
				...
				if (obj != null)
					data.DisbursedQty=(System.Int32)obj;
			}
