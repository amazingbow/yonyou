...
namespace UFIDA.U9.Cust.XMJL.BommBE
{
	...
	public  partial class Cust_Xmjl_MO_BomMain : UFIDA.U9.Base.Doc.Doc
	{
		...
		public new partial class EntityOriginal:  UFIDA.U9.Base.Doc.Doc.EntityOriginal
		{
			...
			/// </summary>
			/// <value></value>
			public  UFIDA.U9.Cust.XMJL.BOMDocTypeBE.Cust_Xmjl_DocumentType BOMDocumentType
			{
				get
				{
					if (BOMDocumentTypeKey == null)
						return null ;
					UFIDA.U9.Cust.XMJL.BOMDocTypeBE.Cust_Xmjl_DocumentType value =  (UFIDA.U9.Cust.XMJL.BOMDocTypeBE.Cust_Xmjl_DocumentType)BOMDocumentTypeKey.GetEntity();
					return value ;
				}
			}
   		...
   		private UFIDA.U9.Cust.XMJL.BOMDocTypeBE.Cust_Xmjl_DocumentType.EntityKey m_BOMDocumentTypeKey ;
		/// <summary>
		/// EntityKey 属性
		...
		/// </summary>
		/// <value></value>
		public  UFIDA.U9.Cust.XMJL.BOMDocTypeBE.Cust_Xmjl_DocumentType.EntityKey BOMDocumentTypeKey
		{
			get 
			{
				object obj = base.GetValue("BOMDocumentType") ;
				if (obj == null || (Int64)obj==UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag || (Int64)obj==0)
					return null ;
				Int64 key = (System.Int64)obj ;
				if (m_BOMDocumentTypeKey==null || m_BOMDocumentTypeKey.ID != key )
					m_BOMDocumentTypeKey = new UFIDA.U9.Cust.XMJL.BOMDocTypeBE.Cust_Xmjl_DocumentType.EntityKey(key); 
				return m_BOMDocumentTypeKey ;
			}
		}
		...
		public  UFIDA.U9.CBO.SCM.ProjectTask.Project.EntityKey ManufactureNoKey
		{
			...
			/// </summary>
			/// <value></value>
			public  UFIDA.U9.Base.UserRole.User DisburseBY
			{
				get
				{
					if (DisburseBYKey == null)
						return null ;
					UFIDA.U9.Base.UserRole.User value =  (UFIDA.U9.Base.UserRole.User)DisburseBYKey.GetEntity();
					return value ;
				}
			}
   		...
   		private UFIDA.U9.Base.UserRole.User.EntityKey m_DisburseBYKey ;
		/// <summary>
		/// EntityKey 属性
		...
		/// </summary>
		/// <value></value>
		public  UFIDA.U9.Base.UserRole.User.EntityKey DisburseBYKey
		{
			get 
			{
				...
				if (m_DisburseBYKey==null || m_DisburseBYKey.ID != key )
					m_DisburseBYKey = new UFIDA.U9.Base.UserRole.User.EntityKey(key); 
			...
			public  UFIDA.U9.Cust.XMJL.BOMDocTypeBE.Cust_Xmjl_DocumentType BOMDocumentType
		{
			get
			{
				object  obj = this.GetRelation("BOMDocumentType");
				if (obj == null)
				{
					return null ;
				}
				...
				{
					UFIDA.U9.Cust.XMJL.BOMDocTypeBE.Cust_Xmjl_DocumentType value  = (UFIDA.U9.Cust.XMJL.BOMDocTypeBE.Cust_Xmjl_DocumentType)obj;
					return value;
				 }
			}
				set
			{
				...
				this.SetRelation("BOMDocumentType", value);
		...
		public  UFIDA.U9.Cust.XMJL.BOMDocTypeBE.Cust_Xmjl_DocumentType.EntityKey BOMDocumentTypeKey
		{
			...
			set
			{	
				if (BOMDocumentTypeKey==value)
					return ;
				this.SetRelation("BOMDocumentType", null);
				m_BOMDocumentTypeKey = value ;
				if (value != null) 
				{
					base.SetValue("BOMDocumentType",value.ID);
				}
				else
					base.SetValue("BOMDocumentType",UFSoft.UBF.PL.Tool.Constant.ID_NULL_Flag);
			}
		}
		...
		/// <summary>
		/// 这种已经被取消，请使用这块代码的人自己调整程序，改为引用EntityRes.GetResource("BOMDocumentType")的方式取资源
		/// </summary>
		[Obsolete("")]
		public string Res_BOMDocumentType　{ get { return EntityRes.GetResource("BOMDocumentType");　}　}
		/// <summary>
		...
		public class EntityRes
		{
			...
			/// 属性: 单据类型 的名称
			/// </summary>
			public static string BOMDocumentType　{ get { return "BOMDocumentType";　}　}
        ...
        public override void IniData()
        {
			...
			this.exdMultiLangAttrs.Add("BOMDocumentType","BOMDocumentType");
		...
		private void DeSerializeKey(Cust_Xmjl_MO_BomMainData data)
		{
			...
			if (data.BOMDocumentType == -1 && data.BOMDocumentType_SKey!=null)
				data.BOMDocumentType = data.BOMDocumentType_SKey.GetEntity().ID ;
		...
		public void FromEntityData(Cust_Xmjl_MO_BomMainData data,IDictionary dict)
		{
			...
			DeSerializeKey(data);
			#region 组件外属性
								this.SetTypeValue("BOMDocumentType",data.BOMDocumentType);
		...
		public Cust_Xmjl_MO_BomMainData ToEntityData(Cust_Xmjl_MO_BomMainData data, IDictionary dict){
			...
			{
				object obj =this.GetValue("BOMDocumentType");
				if (obj != null)
					data.BOMDocumentType=(System.Int64)obj;
			}
