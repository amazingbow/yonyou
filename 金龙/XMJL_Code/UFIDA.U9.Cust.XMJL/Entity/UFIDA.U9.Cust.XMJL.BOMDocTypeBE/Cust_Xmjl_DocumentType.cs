...
namespace UFIDA.U9.Cust.XMJL.BOMDocTypeBE
{
	...
	/// </summary>
	[Serializable]	
	public  partial class Cust_Xmjl_DocumentType : UFIDA.U9.Base.Doc.DocType
	{
		...
		public  static Cust_Xmjl_DocumentType Create() {
			Cust_Xmjl_DocumentType entity = (Cust_Xmjl_DocumentType)UFSoft.UBF.Business.Entity.Create(CurrentClassKey, null);
		...
		/// </summary>
		protected Cust_Xmjl_DocumentType(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			:base(info,context)
		{
		}
		...
		public static Cust_Xmjl_DocumentType CreateDefault() {
		#if Test		
		...
		public static Cust_Xmjl_DocumentType CreateDefaultComponent(){
		#if Test		
        ...
        {
            get { return "UFIDA.U9.Cust.XMJL.BOMDocTypeBE.Cust_Xmjl_DocumentType"; }    
        }
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.XMJL.BOMDocTypeBE.Cust_Xmjl_DocumentType");
			}
		}
		...
		#region EntityKey
		/// <summary>
		/// Strong Class Cust_Xmjl_DocumentType EntityKey 
		/// </summary>
		[Serializable()]
	    [DataContract(Name = "EntityKey", Namespace = "UFSoft.UBF.Business.BusinessEntity")]
		public new partial class EntityKey : UFIDA.U9.Base.Doc.DocType.EntityKey
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.XMJL.BOMDocTypeBE.Cust_Xmjl_DocumentType")
			{}
			...
			/// </summary>
			public new Cust_Xmjl_DocumentType GetEntity()
			{
				return (Cust_Xmjl_DocumentType)base.GetEntity();
			}
		...
		/// </summary>
		public new partial class EntityFinder : UFSoft.UBF.Business.BusinessEntity.EntityFinder<Cust_Xmjl_DocumentType> 
		{
			...
			/// </summary>
			public Cust_Xmjl_DocumentType FindByBusinessKey(  System.String code  , UFIDA.U9.Base.Organization.Organization.EntityKey org  )
			{
			...
			public Cust_Xmjl_DocumentType FindByBusinessKey(  System.String code  , UFIDA.U9.Base.Organization.Organization org  )
			{
				BusinessKeyParameter　parameter = new BusinessKeyParameter() ;
								parameter.Code = code ;				
			...
			/// </summary>
			public Cust_Xmjl_DocumentType FindByBusinessKey(BusinessKeyParameter parameter)
			{
                if (parameter == null)
			...
			/// <summary>
			/// UFIDA_U9_Cust_XMJL_BomBE_Cust_Xmjl_DocumentType_BusinessKey_Index索引查询参数类型
			/// </summary>
			public class UFIDAU9CustXMJLBomBECustXmjlDocumentTypeBusinessKeyIndexParameter
			{
				private System.String m_Code ;
				public  System.String Code
				{
			...
			/// <summary>
			/// 通过索引UFIDA_U9_Cust_XMJL_BomBE_Cust_Xmjl_DocumentType_BusinessKey_Index进行查询(参数对象接口)
			/// </summary>
			public Cust_Xmjl_DocumentType FindByUFIDAU9CustXMJLBomBECustXmjlDocumentTypeBusinessKeyIndex(UFIDAU9CustXMJLBomBECustXmjlDocumentTypeBusinessKeyIndexParameter parameter)
			{
                if (parameter == null)
                    throw new ArgumentException("parameter");
		...
		/// EntityList
		/// </summary>
		public new partial class EntityList :UFSoft.UBF.Business.Entity.EntityList<Cust_Xmjl_DocumentType>{
		    #region constructor 
		    /// <summary>
		...
		{
		    //private Cust_Xmjl_DocumentType ContainerEntity ;
		    public  new Cust_Xmjl_DocumentType ContainerEntity 
		    {
				get { return  (Cust_Xmjl_DocumentType)base.ContainerEntity ;}
				set { base.ContainerEntity = value ;}
		    }
		    
		    public EntityOriginal(Cust_Xmjl_DocumentType container):base(container)
		    {
				if (container == null )
		...
		/// </summary>
		[Obsolete("")]
		public  new  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.XMJL.BOMDocTypeBE.Cust_Xmjl_DocumentType")  ;}	}
		#endregion 		
		...
		public class EntityRes
		{
			...
			/// EntityName的名称
			/// </summary>
			public static string BE_Name { get { return "Cust_Xmjl_DocumentType";　}　}
			
			/// <summary>
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.XMJL.BOMDocTypeBE.Cust_Xmjl_DocumentType";　}　}
		...
		private void DeSerializeKey(Cust_Xmjl_DocumentTypeData data)
		{
        ...
        {
			Cust_Xmjl_DocumentTypeData data = dto as Cust_Xmjl_DocumentTypeData ;
			if (data == null)
				return ;
		...
		/// </summary>
		public void FromEntityData(Cust_Xmjl_DocumentTypeData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(Cust_Xmjl_DocumentTypeData data,IDictionary dict)
		{
			if (data == null)
				return;
		...
		/// </summary>
		public new Cust_Xmjl_DocumentTypeData ToEntityData()
		{
		...
		/// </summary>
		public Cust_Xmjl_DocumentTypeData ToEntityData(Cust_Xmjl_DocumentTypeData data, IDictionary dict){
			if (data == null)
				data = new Cust_Xmjl_DocumentTypeData();
			base.ToEntityData(data, dict);
			
			if (dict == null ) dict = new Hashtable() ;
			//就直接用ID,如果不同实体会出现相同ID，则到时候要改进。? ID一定要有。
			dict["UFIDA.U9.Cust.XMJL.BOMDocTypeBE.Cust_Xmjl_DocumentType"+this.ID.ToString()] = data;
