...
namespace UFIDA.U9.Cust.XMJL.BommBE
{
	...
	/// 
	/// </summary>
	[DataContract(Name = "UFIDA.U9.Cust.XMJL.BommBE.Cust_Xmjl_MO_BomHeadData", Namespace = "http://www.UFIDA.org/EntityData",IsReference=true)]	
	[Serializable]
	...
	public partial class Cust_Xmjl_MO_BomHeadData : UFSoft.UBF.Business.DataTransObjectBase
	{
		...
		private void initData()
		{
			//设置默认值
	     							...
	     							SysVersion= 0; 			     							RowNo= 0; 			     			
	     			
	     			
	     			
	     							Status= 1; 			     							Qty= 0; 			     							DisbursedQty= 0; 			     			
