...
{
    public partial class XMJLBomChangeBListUIModelAction
    {
        ...
        {
            string dataId = this.CurrentModel.Cust_Xmjl_MO_BomChange.FocusedRecord["mainid"].ToString();
            OnNavigatCard("Browse", dataId, "UFIDA.U9.Cust.XMJL.XMJLBOMChangeUIModel.XMJLBOMChangeUIFormWebPart");
