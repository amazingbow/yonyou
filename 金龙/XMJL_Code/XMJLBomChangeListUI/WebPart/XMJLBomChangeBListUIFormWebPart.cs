...
/***********************************************************************************************
 * Form ID:8dde1c7b-911a-4c8f-9909-b59618aaa0c8 
 * Form Name:XMJLBomChangeBListUIForm
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace UFIDA.U9.Cust.XMJL.XMJLBomChangeListUI.XMJLBomChangeBListUIModel
{
	[FormRegister("UFIDA.U9.Cust.XMJL.XMJLBomChangeListUI","UFIDA.U9.Cust.XMJL.XMJLBomChangeListUI.XMJLBomChangeBListUIModel.XMJLBomChangeBListUIFormWebPart", "UFIDA.U9.Cust.XMJL.XMJLBomChangeListUI.WebPart", "8dde1c7b-911a-4c8f-9909-b59618aaa0c8","WebPart", "True", 992, 504)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.XMJL.XMJLBomChangeListUI', 'UFIDA.U9.Cust.XMJL.XMJLBomChangeListUI.XMJLBomChangeBListUIModel.XMJLBomChangeBListUIFormWebPart', 'UFIDA.U9.Cust.XMJL.XMJLBomChangeListUI.WebPart', '8dde1c7b-911a-4c8f-9909-b59618aaa0c8')
	///<siteMapNode url="~/erp/simple.aspx?lnk=8dde1c7b-911a-4c8f-9909-b59618aaa0c8" title="XMJLBomChangeBListUIForm"/>
    public partial class XMJLBomChangeBListUIFormWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(XMJLBomChangeBListUIFormWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new XMJLBomChangeBListUIModelAction Action
		{
			get { return (XMJLBomChangeBListUIModelAction)base.Action; }
			set { base.Action = value; }
		}
		XMJLBomChangeBListUIModelModel _uimodel=null;
		public new XMJLBomChangeBListUIModelModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new XMJLBomChangeBListUIModelModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as XMJLBomChangeBListUIModelModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public XMJLBomChangeBListUIFormWebPart()
        {
            FormID = "8dde1c7b-911a-4c8f-9909-b59618aaa0c8";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new XMJLBomChangeBListUIModelModel();
				}
			...
			{
				//去除.已经移入到OnInit()中.
				//this.Model = (XMJLBomChangeBListUIModelModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new XMJLBomChangeBListUIModelAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"XMJLBomChangeBListUIForm",true,992,504);
        ...
        private void _BuilderControl_Toolbar1(IUFContainer container)
        {
            ...
            ///foreach Toolbar下的所有控件，增加到此容器
                            this.BtnNew = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnNew", "True", "True", 35, 28,"1", "N",true,false,"19478b02-d2a9-4d7e-b7af-00070c61ff2d","19478b02-d2a9-4d7e-b7af-00070c61ff2d","047bf479-d490-4dfa-9385-15254e821c6d");
		
            UIControlBuilder.SetButtonAccessKey(this.BtnNew);
            this.BtnNew.UIModel = this.Model.ElementID;
            this.BtnNew.Action = "OnNew";
	                            this.BtnDelete = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnDelete", "True", "True", 35, 28,"2", "R",true,false,"0467218f-229b-4954-b2d4-3c5976467f76","0467218f-229b-4954-b2d4-3c5976467f76","fd680d95-47da-4634-8fcc-784ee4e14a1d");
            ...
            this.BtnDelete.Action = "OnDelete";
	                            _Toolbar.Controls.Add(new UFWebToolbarSeparatorAdapter());
			                            this.BtnOutPut = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnOutPut", "True", "True", 35, 28,"4", "O",true,false,"688fd549-5a92-49cc-8072-6d5377f6409a","688fd549-5a92-49cc-8072-6d5377f6409a","6d6d4b22-bab1-4686-8e3b-465c8419f380");
            ...
            this.BtnOutPut.Action = "OnOutPut";
	                            this.BtnPrint = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnPrint", "True", "True", 35, 28,"5", "P",true,false,"27b5c615-cde5-458c-be74-833317249568","27b5c615-cde5-458c-be74-833317249568","c6dd8bea-50fa-45f3-afab-ded17fb33ad3");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card0",false,"FunctionBar", true, true, "3","","3d072aa6-ffc6-4198-88e1-53c70e1f2f03");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 80, 20, 13, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","e5236999-e012-499a-ae12-92cd2762ac62");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "2");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 120, 20, 15, 0, 1, 1, "100",true,false,"","","499d6c09-54b6-448f-b4e8-e28de399f9a0");
			...
			UIControlBuilder.BuilderUFControl(this.DDLCase, "3");		
				...
				this.OnLookCase = UIControlBuilder.BuilderUFButton(_UFCard, true, "OnLookCase", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"OnLookCase",false,"5cfb0da4-be20-427b-9c9b-3266d8a6751c","5cfb0da4-be20-427b-9c9b-3266d8a6751c","42a7007b-1d22-48dc-8bf9-6f45d3ada52b");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card3",false,"none", true, true, "2","","d9c4363d-914c-4857-8813-83947f5c0954");
		...
		{
			QryService.BindEnum("DDLCase", this, "6106f73a-2539-40a4-a7ee-ce91b584b1e2");
		}
