...
namespace UFIDA.U9.Cust.XMJL.BommBE
{
    ...
    public sealed class BomMainType
    {
        ...
        private static void InitData()
        {
            ...
            manualImport = new BomMainType(3,"ManualImport") ;
            innerEnums.Add(3,manualImport) ;
        ...
        private static BomMainType manualImport ;
        /// <summary>
        /// 枚举值: 手工导入  Value:3  
        /// 缺件发料主表发料类型.Misc.手工导入
        /// </summary>
        public static BomMainType ManualImport
        {
            get
            {
                return  manualImport ;
		...
		/// </summary>
        [Obsolete("")]
		public string Res_ManualImport　{ get {return EnumRes.GetResource("ManualImport");}　}
		#endregion 
