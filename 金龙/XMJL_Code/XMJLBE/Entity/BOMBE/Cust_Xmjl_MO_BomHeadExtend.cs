...
namespace UFIDA.U9.Cust.XMJL.BommBE
{
    ...
    public partial class Cust_Xmjl_MO_BomHead
    {
		...
		*/
        ...
        protected override void OnInserting()
        {
            ...
            if (this.Status.Value != 0 && this.Status.Value != 1 && this.Status.Value != 2 && this.Status.Value != 3)
            {
                throw new Exception("料号" + this.Item.Code + "发料状态出错！");
            }
        }
        ...
        private static Cust_Xmjl_MO_BomHead CreateDefault_Extend(UFIDA.U9.Cust.XMJL.BommBE.Cust_Xmjl_MO_BomMain parentEntity)
        {
