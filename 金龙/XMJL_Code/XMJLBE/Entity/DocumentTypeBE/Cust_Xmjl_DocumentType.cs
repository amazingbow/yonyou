...
namespace UFIDA.U9.Cust.XMJL.DocumentTypeBE
{
	...
	public  partial class Cust_Xmjl_DocumentType : UFIDA.U9.Base.Doc.DocType
	{
		...
		{
			get {
				return  UFSoft.UBF.PL.ClassKeyFacatory.CreateKey("UFIDA.U9.Cust.XMJL.DocumentTypeBE.Cust_Xmjl_DocumentType");
			}
		}
		...
		{
			public EntityKey(long id): this(id, "UFIDA.U9.Cust.XMJL.DocumentTypeBE.Cust_Xmjl_DocumentType")
			{}
		...
		/// </summary>
		[Obsolete("")]
		public  new  static string Res_EntityNameS {	get {return EntityRes.GetResource("UFIDA.U9.Cust.XMJL.DocumentTypeBE.Cust_Xmjl_DocumentType")  ;}	}
		#endregion 		
		...
		public class EntityRes
		{
			...
			/// Entity　的全名. 
			/// </summary>
			public static string BE_FullName { get { return "UFIDA.U9.Cust.XMJL.DocumentTypeBE.Cust_Xmjl_DocumentType";　}　}
		...
		public Cust_Xmjl_DocumentTypeData ToEntityData(Cust_Xmjl_DocumentTypeData data, IDictionary dict){
			...
			dict["UFIDA.U9.Cust.XMJL.DocumentTypeBE.Cust_Xmjl_DocumentType"+this.ID.ToString()] = data;
