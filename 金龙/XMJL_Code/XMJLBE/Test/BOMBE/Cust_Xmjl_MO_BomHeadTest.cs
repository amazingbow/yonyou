...
namespace UFIDA.U9.Cust.XMJL.BommBE.TestSuite{
	...
	/// <summary>
	/// Cust_Xmjl_MO_BomHead Auto Test Class
	/// </summary>
	[TestFixture]
	public partial class Cust_Xmjl_MO_BomHeadTest{
		/// <summary>
		/// test Create
		/// </summary>
		//[Test]
		public void Cust_Xmjl_MO_BomHeadCRUD() {
		/*	using (TransactionScope scope = new TransactionScope())
			{
				...
				using (ISession session = Session.Open()) {
					#region __merge CreateCust_Xmjl_MO_BomHead
					...
					Assert.IsNotNull(obj, " Create <" + typeof(Cust_Xmjl_MO_BomHead).ToString() + "> failed.");
					session.Commit();
				}
				...
				using (ISession session = Session.Open()) {
					#region __merge RemoveCust_Xmjl_MO_BomHead	
					obj.Remove();
