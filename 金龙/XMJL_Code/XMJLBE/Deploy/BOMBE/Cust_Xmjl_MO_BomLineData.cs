...
namespace UFIDA.U9.Cust.XMJL.BommBE
{
	...
	/// 
	/// </summary>
	[DataContract(Name = "UFIDA.U9.Cust.XMJL.BommBE.Cust_Xmjl_MO_BomLineData", Namespace = "http://www.UFIDA.org/EntityData",IsReference=true)]	
	[Serializable]
	...
	public partial class Cust_Xmjl_MO_BomLineData : UFSoft.UBF.Business.DataTransObjectBase
	{
	    ...
	    public static IList<Type> GetKnownTypes()
        {
            IList<Type> knownTypes = new List<Type>();
                                        ...
                                        knownTypes.Add(typeof(UFIDA.U9.Cust.XMJL.BommBE.Cust_Xmjl_MO_BomHeadData));
                                        knownTypes.Add(typeof(UFIDA.U9.Cust.XMJL.BommBE.Cust_Xmjl_MO_BomHead_BakData));
		...
		#region Properties Inner Component
			...
			private UFSoft.UBF.Business.BusinessEntity.EntityKey m_cust_Xmjl_MO_BomHead_SKey ;
			/// <summary>
			/// 缺件发料单 序列化Key属性。（传递跨组织序列列字段）
			/// 缺件发料单子行.Misc.缺件发料单
			/// </summary>
			[DataMember(IsRequired=false)]
			public UFSoft.UBF.Business.BusinessEntity.EntityKey Cust_Xmjl_MO_BomHead_SKey
			{
				get 
				{
					return m_cust_Xmjl_MO_BomHead_SKey ;					
				}
				set
				{
					m_cust_Xmjl_MO_BomHead_SKey = value ;	
				}
			}
		/// <summary>
		/// 缺件发料单
		...
		/// </summary>
		[DataMember(IsRequired=false)]
		private UFIDA.U9.Cust.XMJL.BommBE.Cust_Xmjl_MO_BomHeadData m_cust_Xmjl_MO_BomHead;
		public UFIDA.U9.Cust.XMJL.BommBE.Cust_Xmjl_MO_BomHeadData Cust_Xmjl_MO_BomHead
		{
			get	
			{	
			...
			private UFSoft.UBF.Business.BusinessEntity.EntityKey m_cust_Xmjl_MO_BomHead_Bak_SKey ;
			/// <summary>
			/// 缺件发料单备份 序列化Key属性。（传递跨组织序列列字段）
			/// 缺件发料单子行.Misc.缺件发料单备份
			/// </summary>
			[DataMember(IsRequired=false)]
			public UFSoft.UBF.Business.BusinessEntity.EntityKey Cust_Xmjl_MO_BomHead_Bak_SKey
			{
				get 
				{
					return m_cust_Xmjl_MO_BomHead_Bak_SKey ;					
				}
				set
				{
					m_cust_Xmjl_MO_BomHead_Bak_SKey = value ;	
				}
			}
		/// <summary>
		/// 缺件发料单备份
		...
		/// </summary>
		[DataMember(IsRequired=false)]
		private UFIDA.U9.Cust.XMJL.BommBE.Cust_Xmjl_MO_BomHead_BakData m_cust_Xmjl_MO_BomHead_Bak;
		public UFIDA.U9.Cust.XMJL.BommBE.Cust_Xmjl_MO_BomHead_BakData Cust_Xmjl_MO_BomHead_Bak
		{
			get	
			{	
				return m_cust_Xmjl_MO_BomHead_Bak ;
			}
			set	
			{	
				m_cust_Xmjl_MO_BomHead_Bak = value ;
			}
		}		
