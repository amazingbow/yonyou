...
namespace UFIDA.U9.Cust.XMJL.XMJLBomDispExecUIModel
{
    public partial class XMJLBomDispExecUIFormWebPart
    {
        #region eventBind
				...
				//MethodName:BtnDispExec_Click ActionName:DispExecClick
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void BtnDispExec_Click(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,BtnDispExec_Click_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void BtnDispExec_Click_DefaultImpl(object sender, EventArgs e)
        {
		...
		Action.DispExecClick(sender,new UIActionEventArgs());

		
			
        }
		 
				//MethodName:Button1_Click ActionName:
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
