/**************************************************************
 * Description:
 * XMJLBatchIssueUIModelAction.cs
 * Product: U9
 * Co.    : UFIDA Group
...
{
	public partial class XMJLBatchIssueUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(XMJLBatchIssueUIModelAction));
		//强类型化基类Model属性.
		public new XMJLBatchIssueUIModelModel CurrentModel 
		{
			get {
				return (XMJLBatchIssueUIModelModel)base.CurrentModel;
			}
			set {
		...
		public XMJLBatchIssueUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public XMJLBatchIssueUIModelAction(XMJLBatchIssueUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 
