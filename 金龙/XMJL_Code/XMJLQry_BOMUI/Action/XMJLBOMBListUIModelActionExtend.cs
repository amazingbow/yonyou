...
{
    public partial class XMJLBOMBListUIModelAction
    {
        ...
        {
            string DataID = this.CurrentModel.Cust_Xmjl_MO_BomMain.FocusedRecord["mainid"].ToString();
            string CardPageID = "Cust.XMJL.MO.BomURL";//在这里CardPageID表示卡片的URI
        ...
        private void OnNavigatCard(string type, string dataID, string formID)
        {
            ...
            else
            {
                ...
                this.CurrentPart.NavigatePage(FormID, nameValCol);
            }
        }
