...
namespace UFIDA.U9.Cust.XMJL.Qry.XMJLBOMBListUIModel
{
    public partial class XMJLBOMBListUIFormWebPart
    {
		...
		Action.OnLookCase(sender,new UIActionEventArgs());
				...
				//MethodName:BtnChangeWH_Click ActionName:
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void BtnChangeWH_Click(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,BtnChangeWH_Click_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void BtnChangeWH_Click_DefaultImpl(object sender, EventArgs e)
        {
			//Template (tpl) Code here...
			...
			//throw new NotImplementedException() ;
				...
				//MethodName:BtnUpdateSup_Click ActionName:
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void BtnUpdateSup_Click(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,BtnUpdateSup_Click_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void BtnUpdateSup_Click_DefaultImpl(object sender, EventArgs e)
        {
			//Template (tpl) Code here...
			...
			//throw new NotImplementedException() ;
				...
				//MethodName:BtnUpdateStat_Click ActionName:
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void BtnUpdateStat_Click(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,BtnUpdateStat_Click_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void BtnUpdateStat_Click_DefaultImpl(object sender, EventArgs e)
        {
			//Template (tpl) Code here...
			...
			//throw new NotImplementedException() ;
				...
				//MethodName:BtnBatchIssue_Click ActionName:
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void BtnBatchIssue_Click(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,BtnBatchIssue_Click_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void BtnBatchIssue_Click_DefaultImpl(object sender, EventArgs e)
        {
			//Template (tpl) Code here...
			...
			//throw new NotImplementedException() ;
				...
				//MethodName:BtnRefresh_Click ActionName:
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void BtnRefresh_Click(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,BtnRefresh_Click_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void BtnRefresh_Click_DefaultImpl(object sender, EventArgs e)
        {
			//Template (tpl) Code here...
			...
			//throw new NotImplementedException() ;
				...
				//MethodName:BtnResetWH_Click ActionName:
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void BtnResetWH_Click(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,BtnResetWH_Click_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void BtnResetWH_Click_DefaultImpl(object sender, EventArgs e)
        {
			//Template (tpl) Code here...
