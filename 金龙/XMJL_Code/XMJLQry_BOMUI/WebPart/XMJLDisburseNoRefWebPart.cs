...
/***********************************************************************************************
 * Form ID:0e3bce97-f8bf-458f-a536-c89d20f3f9d7 
 * Form Name:XMJLDisburseNoRef
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace XMJLDisburseNoRef
{
	[FormRegister("UFIDA.U9.Cust.XMJL.Qry.BOMUI","XMJLDisburseNoRef.XMJLDisburseNoRefWebPart", "UFIDA.U9.Cust.XMJL.Qry.BOMUI.WebPart", "0e3bce97-f8bf-458f-a536-c89d20f3f9d7","WebPart", "False", 580, 408)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.XMJL.Qry.BOMUI', 'XMJLDisburseNoRef.XMJLDisburseNoRefWebPart', 'UFIDA.U9.Cust.XMJL.Qry.BOMUI.WebPart', '0e3bce97-f8bf-458f-a536-c89d20f3f9d7')
	///<siteMapNode url="~/erp/simple.aspx?lnk=0e3bce97-f8bf-458f-a536-c89d20f3f9d7" title="XMJLDisburseNoRef"/>
    public partial class XMJLDisburseNoRefWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(XMJLDisburseNoRefWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new XMJLDisburseNoRefAction Action
		{
			get { return (XMJLDisburseNoRefAction)base.Action; }
			set { base.Action = value; }
		}
		XMJLDisburseNoRefModel _uimodel=null;
		public new XMJLDisburseNoRefModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new XMJLDisburseNoRefModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as XMJLDisburseNoRefModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public XMJLDisburseNoRefWebPart()
        {
            FormID = "0e3bce97-f8bf-458f-a536-c89d20f3f9d7";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new XMJLDisburseNoRefModel();
				}
			...
			else
			{
				...
				//去除.已经移入到OnInit()中.
				//this.Model = (XMJLDisburseNoRefModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new XMJLDisburseNoRefAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"XMJLDisburseNoRef",true,580,408);
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card4",false,"none", true, true, "1","","7353e835-e58f-4cff-9cfd-02505b685ccb");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 45, 20, 0, 0, 1, 1, "100","9bf97f14-74b9-4a4f-b2fc-d5bfb9c95e3a","6d37b047-aa1d-45b1-96e3-3ce8756e195b");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "0");		
		        ...
		        this.SelectList = UIControlBuilder.BuilderDropDownList(_UFCard, "SelectList", "", true,  true, true, "Left", 0, 60, 0, 120, 20, 2, 0, 1, 1, "100",true,false,"","","83fd683c-e3c4-4227-86b0-d2c79e0b9c2f");
			...
			UIControlBuilder.BuilderUFControl(this.WizardControl0, "2");		
				...
				this.lblContinueCheckBox = UIControlBuilder.BuilderUFLabel(_UFCard, "lblContinueCheckBox", "", "False", "True", "Right", 80, 20, 6, 0, 1, 1, "100","0aead14b-b05a-4582-9aca-34da4f4bf7a0","7b084385-3494-4294-bc1f-b430680c54fd");
			...
			UIControlBuilder.BuilderUFControl(this.lblContinueCheckBox, "3");		
				...
				this.ContinueCheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "ContinueCheckBox", false, true, "Left", 60, 0, 30, 20, 8, 0, 1, 1, "100",true,"lblContinueCheckBox","","1e2ac35b-c2d1-4d9c-a106-247445da0291");
			...
			UIControlBuilder.BuilderUFControl(this.ContinueCheckBox, "4");		
				...
				this.FindButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "FindButton", true, true, 60, 20, 10, 0, 1, 1, "100","R", this.Model.ElementID,"",false,"27621430-7bc7-4c0e-979e-f0108439d13e","27621430-7bc7-4c0e-979e-f0108439d13e","8bc527a3-2104-4f19-816b-f9ff2ce03dee");
			...
			UIControlBuilder.BuilderUFControl(this.FindButton, "4");		
				...
				this.CheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "CheckBox", false, true, "Left", 60, 0, 30, 20, 0, 0, 1, 1, "100",false,"","","0e3dc35b-5736-4469-9a7a-755ea27ac634");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card6",false,"FunctionBar", true, true, "0","","8f5e5096-df57-4140-a028-8bc411a12438");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"CardForRefQueryCase",false,"none", true, true, "0","","cc584b09-73f9-4c1f-8248-8b7da7161308");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.QryButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "QryButton", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"",false,"3664768b-36ca-44ab-9583-8d85fb432e43","3664768b-36ca-44ab-9583-8d85fb432e43","794fa419-db51-4f54-a1f6-3a59ccfe58d6");
			...
			UIControlBuilder.BuilderUFControl(this.QryButton, "1");		
				...
				this.lbCase = UIControlBuilder.BuilderUFLabel(_UFCard, "lbCase", "", "True", "True", "Right", 80, 20, 3, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","9ab1e17f-1cc6-4a25-b8f9-071e0dfac71f");
			...
			UIControlBuilder.BuilderUFControl(this.lbCase, "1");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 150, 20, 5, 0, 1, 1, "100",true,false,"","","24069ba9-f67d-4734-8a2b-b1425bd744bb");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card1",false,"none", true, true, "0","","cdc1846f-b40a-4163-8937-4735d83b9d77");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.ConfirmButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "ConfirmButton", true, true, 80, 20, 0, 0, 1, 1, "100","O", this.Model.ElementID,"",false,"626ebf9b-f65a-4dd5-8f32-96f84919878c","626ebf9b-f65a-4dd5-8f32-96f84919878c","86ca353c-570a-4e97-9fdf-2ad0f270908c");
			...
			UIControlBuilder.BuilderUFControl(this.ConfirmButton, "3");		
				...
				this.CancelButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "CancelButton", true, true, 80, 20, 2, 0, 1, 1, "100","C", this.Model.ElementID,"",false,"020a5365-8f12-4970-b8df-17ce3ae60a68","020a5365-8f12-4970-b8df-17ce3ae60a68","b2ba0e79-a547-4973-b1ac-e08065433b28");
        ...
        private void _BuilderControl_DataGrid(IUFContainer container)
        {
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"ID0","NumberColumnModel", "", 0,this.Model.cRef.Fields["ID"]/*ID*/,"ID", true, false, true, false, false, true, 7, 80, "8",true, false,"","c1807baf-a761-4845-a9cc-b30996a287a7","c1807baf-a761-4845-a9cc-b30996a287a7","ea972bc8-5de4-45d9-a236-e6f9e8d7c708");
    ...
    if (this.UseQueryCase && UFIDA.UBF.Query.CommonService.RefQueryHelper.QueryCaseExist(this.Action, null))
    {
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"DescFlexField_PrivateDescSeg10","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["DescFlexField_PrivateDescSeg1"]/*DescFlexField_PrivateDescSeg1*/,"DescFlexField_PrivateDescSeg1", false, true, true, false, false, true, 0, 150, "5",true, false,"","45c85fbd-d9bd-4fa7-a15e-299daf5404f6","45c85fbd-d9bd-4fa7-a15e-299daf5404f6","aec6b8ad-335f-416e-af8a-a5191f6c78ad");
         
			GridControlBuilder.GridTextBoxColumnBuilder((IUFTextBoxColumn)column,"",TextAlign.Left, false,"",false,"1","1","5") ;          
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"Department_Name0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["Department_Name"]/*Department_Name*/,"Department_Name", false, true, true, false, false, true, 0, 150, "5",true, true,"","5a3deee5-520c-4418-82c3-8cfcbbf9cf19","5a3deee5-520c-4418-82c3-8cfcbbf9cf19","3af52c1f-dd6b-4808-8ebf-83f118230fd5");
         
			GridControlBuilder.GridTextBoxColumnBuilder((IUFTextBoxColumn)column,"",TextAlign.Left, false,"",false,"1","1","5") ;          
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"DisburseBY_Name0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["DisburseBY_Name"]/*DisburseBY_Name*/,"DisburseBY_Name", false, true, true, false, false, true, 0, 150, "5",true, true,"","1495017b-9b79-4e93-9b49-bfbccb799c4d","1495017b-9b79-4e93-9b49-bfbccb799c4d","2fe2c634-e058-431e-9d3b-63e40b0407bd");
	        ...
	        private void _BuilderControl_MatchTypeRadioBoxList(IUFContainer container)
        {
            ...
            listItem = UIControlBuilder.BuildListItem(container,"0", true,false,"130bc338-9958-4133-9b7f-9c185bc2455a","3f2280eb-ed2a-478b-a6bb-ac71a6e9aad2");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"1", true,false,"49790074-95af-497d-ae37-16bb697f3ce6","c8db6157-575e-4626-a507-640f1e3ca2ba");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"2", true,true,"517d6f15-ca0d-4e3b-aa58-3c85a5b2ae66","21e31459-40ee-421d-9ee7-efb0588fd74c");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"3", true,false,"ea7795fe-8961-4c3f-8ed1-b5128be2cd75","c3a72975-fcd3-4787-9c1d-96521b801cd5");
            _UFListControl.Items.Add(listItem);
        }
