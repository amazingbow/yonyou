...
/***********************************************************************************************
 * Form ID:5793f6a2-1489-4b7e-bae0-81634a59f09a 
 * Form Name:XMJLBomChangeRef
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace XMJLBomChangeRef
{
	[FormRegister("UFIDA.U9.Cust.XMJL.XMJLBOMChangeUI","XMJLBomChangeRef.XMJLBomChangeRefWebPart", "UFIDA.U9.Cust.XMJL.XMJLBOMChangeUI.WebPart", "5793f6a2-1489-4b7e-bae0-81634a59f09a","WebPart", "False", 580, 408)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.XMJL.XMJLBOMChangeUI', 'XMJLBomChangeRef.XMJLBomChangeRefWebPart', 'UFIDA.U9.Cust.XMJL.XMJLBOMChangeUI.WebPart', '5793f6a2-1489-4b7e-bae0-81634a59f09a')
	///<siteMapNode url="~/erp/simple.aspx?lnk=5793f6a2-1489-4b7e-bae0-81634a59f09a" title="XMJLBomChangeRef"/>
    public partial class XMJLBomChangeRefWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(XMJLBomChangeRefWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new XMJLBomChangeRefAction Action
		{
			get { return (XMJLBomChangeRefAction)base.Action; }
			set { base.Action = value; }
		}
		XMJLBomChangeRefModel _uimodel=null;
		public new XMJLBomChangeRefModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new XMJLBomChangeRefModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as XMJLBomChangeRefModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public XMJLBomChangeRefWebPart()
        {
            FormID = "5793f6a2-1489-4b7e-bae0-81634a59f09a";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new XMJLBomChangeRefModel();
				}
			...
			else
			{
				...
				//去除.已经移入到OnInit()中.
				//this.Model = (XMJLBomChangeRefModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new XMJLBomChangeRefAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"XMJLBomChangeRef",true,580,408);
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card4",false,"none", true, true, "1","","1d412721-d942-4bd4-852d-2bae29cdc095");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 45, 20, 0, 0, 1, 1, "100","9bf97f14-74b9-4a4f-b2fc-d5bfb9c95e3a","1223c647-1bbf-4ff5-99d6-8981b7f784fc");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "0");		
		        ...
		        this.SelectList = UIControlBuilder.BuilderDropDownList(_UFCard, "SelectList", "", true,  true, true, "Left", 0, 60, 0, 120, 20, 2, 0, 1, 1, "100",true,false,"","","d4088db2-5a0c-42be-971e-4dd6658d6dd3");
			...
			UIControlBuilder.BuilderUFControl(this.WizardControl0, "2");		
				...
				this.lblContinueCheckBox = UIControlBuilder.BuilderUFLabel(_UFCard, "lblContinueCheckBox", "", "False", "True", "Right", 80, 20, 6, 0, 1, 1, "100","0aead14b-b05a-4582-9aca-34da4f4bf7a0","c4424523-d83d-49a5-b7d5-4b8c9ad8c168");
			...
			UIControlBuilder.BuilderUFControl(this.lblContinueCheckBox, "3");		
				...
				this.ContinueCheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "ContinueCheckBox", false, true, "Left", 60, 0, 30, 20, 8, 0, 1, 1, "100",true,"lblContinueCheckBox","","078b3967-fc57-4f59-96c6-53d345e4829a");
			...
			UIControlBuilder.BuilderUFControl(this.ContinueCheckBox, "4");		
				...
				this.FindButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "FindButton", true, true, 60, 20, 10, 0, 1, 1, "100","R", this.Model.ElementID,"",false,"27621430-7bc7-4c0e-979e-f0108439d13e","27621430-7bc7-4c0e-979e-f0108439d13e","c71d9e0c-ac0f-4d6d-bc19-f2378802abdc");
			...
			UIControlBuilder.BuilderUFControl(this.FindButton, "4");		
				...
				this.CheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "CheckBox", false, true, "Left", 60, 0, 30, 20, 0, 0, 1, 1, "100",false,"","","8980f5aa-1c23-4c1f-b876-26b3cbd1b617");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card6",false,"FunctionBar", true, true, "0","","ca8002eb-36cc-4a65-989f-35ff7ff912fc");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"CardForRefQueryCase",false,"none", true, true, "0","","e4ca14c5-35e6-48f9-b585-33f998753609");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.QryButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "QryButton", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"",false,"3664768b-36ca-44ab-9583-8d85fb432e43","3664768b-36ca-44ab-9583-8d85fb432e43","74bdc6cc-7c64-4ce8-8786-8e3c95244b76");
			...
			UIControlBuilder.BuilderUFControl(this.QryButton, "1");		
				...
				this.lbCase = UIControlBuilder.BuilderUFLabel(_UFCard, "lbCase", "", "True", "True", "Right", 80, 20, 3, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","cfe3724a-347d-439e-a130-eff9027d556f");
			...
			UIControlBuilder.BuilderUFControl(this.lbCase, "1");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 150, 20, 5, 0, 1, 1, "100",true,false,"","","e1426110-b903-4ad2-9c46-4ef3b38acc30");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card1",false,"none", true, true, "0","","3f21092a-568c-4964-b58a-6c425faf7b97");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.ConfirmButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "ConfirmButton", true, true, 80, 20, 0, 0, 1, 1, "100","O", this.Model.ElementID,"",false,"626ebf9b-f65a-4dd5-8f32-96f84919878c","626ebf9b-f65a-4dd5-8f32-96f84919878c","ccdba0e2-c00b-4ed0-be5f-0c3c3919bba1");
			...
			UIControlBuilder.BuilderUFControl(this.ConfirmButton, "3");		
				...
				this.CancelButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "CancelButton", true, true, 80, 20, 2, 0, 1, 1, "100","C", this.Model.ElementID,"",false,"020a5365-8f12-4970-b8df-17ce3ae60a68","020a5365-8f12-4970-b8df-17ce3ae60a68","d1041972-b096-4844-a92a-369df6ef1640");
        ...
        private void _BuilderControl_DataGrid(IUFContainer container)
        {
			...
			InitViewBindingContainer(this, _UFGrid,  this.Model.cRef, "cRef", "", null, 13, "缺件变更单");
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"ID0","NumberColumnModel", "", 0,this.Model.cRef.Fields["ID"]/*ID*/,"ID", true, false, true, false, false, true, 7, 80, "8",true, false,"","86c4949c-2f9f-4320-ad3c-ba13a71465a5","86c4949c-2f9f-4320-ad3c-ba13a71465a5","b4b6a9d1-e8f6-4ade-ad46-c1429739c817");
    ...
    if (this.UseQueryCase && UFIDA.UBF.Query.CommonService.RefQueryHelper.QueryCaseExist(this.Action, null))
    {
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"DocNo0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["DocNo"]/*DocNo*/,"DocNo", false, true, true, false, false, true, 0, 80, "5",true, false,"","dc119c14-1467-4483-a533-5201f44ccef5","dc119c14-1467-4483-a533-5201f44ccef5","174e0d00-5abe-44bf-896a-9e86a9f615f8");
         
			GridControlBuilder.GridTextBoxColumnBuilder((IUFTextBoxColumn)column,"",TextAlign.Left, false,"",false,"1","1","5") ;          
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"ChangeReason0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["ChangeReason"]/*ChangeReason*/,"ChangeReason", false, true, true, false, false, true, 0, 160, "5",true, false,"","8475e446-98f6-41f0-bc7f-932670dbd1bc","8475e446-98f6-41f0-bc7f-932670dbd1bc","7311aff7-368c-4759-8a57-510ebb4d87de");
         
			GridControlBuilder.GridTextBoxColumnBuilder((IUFTextBoxColumn)column,"",TextAlign.Left, false,"",false,"1","1","5") ;          
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"ChangeDateTime0","DatePickerColumnModel", "", 0,this.Model.cRef.Fields["ChangeDateTime"]/*ChangeDateTime*/,"ChangeDateTime", false, true, true, false, false, true, 5, 80, "0",true, false,"","5aa23e7a-6150-45cb-879e-eda13a26a38f","5aa23e7a-6150-45cb-879e-eda13a26a38f","3621b60f-2176-49b3-ab7b-87d96ce9ecd5");
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"ChangeStat0","CheckBoxColumnModel", "", 0,this.Model.cRef.Fields["ChangeStat"]/*ChangeStat*/,"ChangeStat", false, true, true, false, false, true, 22, 80, "0",true, false,"","1fc6a5bb-7991-4d98-b5af-03182d25cafc","1fc6a5bb-7991-4d98-b5af-03182d25cafc","df929471-bd9d-4223-8a53-0da4a70679e6");
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"ChangePerson_Name0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["ChangePerson_Name"]/*ChangePerson_Name*/,"ChangePerson_Name", false, true, true, false, false, true, 0, 80, "5",true, false,"","63e7f89f-13c4-4e1b-bf11-e18c37093465","63e7f89f-13c4-4e1b-bf11-e18c37093465","a82c786f-c8a3-4772-94e3-9b3539e4241e");
         
			GridControlBuilder.GridTextBoxColumnBuilder((IUFTextBoxColumn)column,"",TextAlign.Left, false,"",false,"1","1","5") ;          
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"CreatedOn0","DatePickerColumnModel", "", 0,this.Model.cRef.Fields["CreatedOn"]/*CreatedOn*/,"CreatedOn", false, true, true, false, false, true, 5, 80, "0",true, false,"","22eb9b6d-e0a0-48ff-a809-cb575cac7a3c","22eb9b6d-e0a0-48ff-a809-cb575cac7a3c","0ad52698-a122-4b5c-b113-bacb5fd59ad6");
                   
			((IUFDatePickerColumn)column).DateTimeType = DateTimeType.DateTime;
            ((IUFDatePickerColumn)column).DateTimeFormat = CurrentState._I18N._DateTimeFormatInfo;
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"CreatedBy0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["CreatedBy"]/*CreatedBy*/,"CreatedBy", false, true, true, false, false, true, 0, 80, "0",true, false,"","fd72be5a-26b1-4d16-bfc5-1926ccce7580","fd72be5a-26b1-4d16-bfc5-1926ccce7580","339262be-0fa1-488c-9c52-56c60fe814bc");
         
			GridControlBuilder.GridTextBoxColumnBuilder((IUFTextBoxColumn)column,"",TextAlign.Left, false,"",false,"1","1","0") ;          
	        ...
	        private void _BuilderControl_MatchTypeRadioBoxList(IUFContainer container)
        {
            ...
            listItem = UIControlBuilder.BuildListItem(container,"0", true,false,"130bc338-9958-4133-9b7f-9c185bc2455a","0082e375-c709-4b02-a530-0729a335e814");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"1", true,false,"49790074-95af-497d-ae37-16bb697f3ce6","9bff5f06-f6e5-4a0f-96ba-45643c5ad31a");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"2", true,true,"517d6f15-ca0d-4e3b-aa58-3c85a5b2ae66","b3540952-0a0f-4368-9eb9-459d17897bbe");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"3", true,false,"ea7795fe-8961-4c3f-8ed1-b5128be2cd75","b29be32a-8cdf-4ea5-9c84-37f08cefbcc3");
            _UFListControl.Items.Add(listItem);
        }
