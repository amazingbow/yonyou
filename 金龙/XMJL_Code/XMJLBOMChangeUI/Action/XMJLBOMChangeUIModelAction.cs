...
{
	public partial class XMJLBOMChangeUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(XMJLBOMChangeUIModelAction));
		//强类型化基类Model属性.
		public new XMJLBOMChangeUIModelModel CurrentModel 
		{
			get {
				return (XMJLBOMChangeUIModelModel)base.CurrentModel;
			}
			set {
		...
		public XMJLBOMChangeUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public XMJLBOMChangeUIModelAction(XMJLBOMChangeUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 
