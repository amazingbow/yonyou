...
{
	public partial class BOMUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(BOMUIModelAction));
		//强类型化基类Model属性.
		public new BOMUIModelModel CurrentModel 
		{
			get {
				return (BOMUIModelModel)base.CurrentModel;
			}
			set {
		...
		public BOMUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public BOMUIModelAction(BOMUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 
