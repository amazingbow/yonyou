...
{
	public partial class DocumentTypeModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(DocumentTypeModelAction));
		//强类型化基类Model属性.
		public new DocumentTypeModelModel CurrentModel 
		{
			get {
				return (DocumentTypeModelModel)base.CurrentModel;
			}
			set {
		...
		public DocumentTypeModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public DocumentTypeModelAction(DocumentTypeModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 
