...
/***********************************************************************************************
 * Form ID:2b52251e-a16c-479a-b899-d52be784a92f 
 * Form Name:BOMUIRef
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace BOMUIRef
{
	[FormRegister("UFIDA.U9.Cust.XMJL.UI","BOMUIRef.BOMUIRefWebPart", "UFIDA.U9.Cust.XMJL.UI.WebPart", "2b52251e-a16c-479a-b899-d52be784a92f","WebPart", "False", 580, 408)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.XMJL.UI', 'BOMUIRef.BOMUIRefWebPart', 'UFIDA.U9.Cust.XMJL.UI.WebPart', '2b52251e-a16c-479a-b899-d52be784a92f')
	///<siteMapNode url="~/erp/simple.aspx?lnk=2b52251e-a16c-479a-b899-d52be784a92f" title="BOMUIRef"/>
    public partial class BOMUIRefWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(BOMUIRefWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new BOMUIRefAction Action
		{
			get { return (BOMUIRefAction)base.Action; }
			set { base.Action = value; }
		}
		BOMUIRefModel _uimodel=null;
		public new BOMUIRefModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new BOMUIRefModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as BOMUIRefModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public BOMUIRefWebPart()
        {
            FormID = "2b52251e-a16c-479a-b899-d52be784a92f";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			else
			{
				...
				//去除.已经移入到OnInit()中.
				//this.Model = (BOMUIRefModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new BOMUIRefAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"BOMUIRef",true,580,408);
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card4",false,"none", true, true, "1","","d517c978-9a72-449e-9564-96824f990077");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 45, 20, 0, 0, 1, 1, "100","9bf97f14-74b9-4a4f-b2fc-d5bfb9c95e3a","4fbaec14-5480-4f58-b44e-e8a03f3d1f06");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "0");		
		        ...
		        this.SelectList = UIControlBuilder.BuilderDropDownList(_UFCard, "SelectList", "", true,  true, true, "Left", 0, 60, 0, 120, 20, 2, 0, 1, 1, "100",true,false,"","","e5dff8ce-83d0-47b4-985b-d0fc567b80fa");
			...
			UIControlBuilder.BuilderUFControl(this.WizardControl0, "2");		
				...
				this.lblContinueCheckBox = UIControlBuilder.BuilderUFLabel(_UFCard, "lblContinueCheckBox", "", "False", "True", "Right", 80, 20, 6, 0, 1, 1, "100","0aead14b-b05a-4582-9aca-34da4f4bf7a0","2151e4fb-4675-4aaa-bc68-f269a5aea90b");
			...
			UIControlBuilder.BuilderUFControl(this.lblContinueCheckBox, "3");		
				...
				this.ContinueCheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "ContinueCheckBox", false, true, "Left", 60, 0, 30, 20, 8, 0, 1, 1, "100",true,"lblContinueCheckBox","","4997fa09-58fd-4a18-b338-18103c5c648d");
			...
			UIControlBuilder.BuilderUFControl(this.ContinueCheckBox, "4");		
				...
				this.FindButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "FindButton", true, true, 60, 20, 10, 0, 1, 1, "100","R", this.Model.ElementID,"",false,"27621430-7bc7-4c0e-979e-f0108439d13e","27621430-7bc7-4c0e-979e-f0108439d13e","23527223-40c3-4eb6-9f51-e60bf0cf562d");
			...
			UIControlBuilder.BuilderUFControl(this.FindButton, "4");		
				...
				this.CheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "CheckBox", false, true, "Left", 60, 0, 30, 20, 0, 0, 1, 1, "100",false,"","","24e55e93-7360-47da-adcf-09780daed792");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card6",false,"FunctionBar", true, true, "0","","5f705c86-40b7-41ad-93e4-4b9ee6cc2583");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"CardForRefQueryCase",false,"none", true, true, "0","","932de922-c127-4a56-bce7-da2acf6617b0");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.QryButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "QryButton", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"",false,"3664768b-36ca-44ab-9583-8d85fb432e43","3664768b-36ca-44ab-9583-8d85fb432e43","e48a14f0-1933-4028-985b-2b0b1f4afc1d");
			...
			UIControlBuilder.BuilderUFControl(this.QryButton, "1");		
				...
				this.lbCase = UIControlBuilder.BuilderUFLabel(_UFCard, "lbCase", "", "True", "True", "Right", 80, 20, 3, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","cfa18707-4381-4fd5-a7d2-effafafe5149");
			...
			UIControlBuilder.BuilderUFControl(this.lbCase, "1");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 150, 20, 5, 0, 1, 1, "100",true,false,"","","7a80c36c-733e-4403-9c25-14d3a0439aa9");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card1",false,"none", true, true, "0","","ee9313df-88a7-469e-992d-c0c67696ff59");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.ConfirmButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "ConfirmButton", true, true, 80, 20, 0, 0, 1, 1, "100","O", this.Model.ElementID,"",false,"626ebf9b-f65a-4dd5-8f32-96f84919878c","626ebf9b-f65a-4dd5-8f32-96f84919878c","7cff05d3-5fc3-492f-9be1-45f042a706d8");
			...
			UIControlBuilder.BuilderUFControl(this.ConfirmButton, "3");		
				...
				this.CancelButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "CancelButton", true, true, 80, 20, 2, 0, 1, 1, "100","C", this.Model.ElementID,"",false,"020a5365-8f12-4970-b8df-17ce3ae60a68","020a5365-8f12-4970-b8df-17ce3ae60a68","c31be109-c854-41e6-aa31-c9893674a5e8");
        ...
        private void _BuilderControl_DataGrid(IUFContainer container)
        {
			...
			InitViewBindingContainer(this, _UFGrid,  this.Model.cRef, "cRef", "", null, 13, "缺件发料主表");
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"ID0","NumberColumnModel", "", 0,this.Model.cRef.Fields["ID"]/*ID*/,"ID", true, false, true, false, false, true, 7, 80, "8",true, false,"","46049d10-1450-426f-9ae1-80e83c400b5a","46049d10-1450-426f-9ae1-80e83c400b5a","74e948fd-9d94-414d-8611-6494cc7360a6");
    ...
    if (this.UseQueryCase && UFIDA.UBF.Query.CommonService.RefQueryHelper.QueryCaseExist(this.Action, null))
    {
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"DocNo0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["DocNo"]/*DocNo*/,"DocNo", false, true, true, false, false, true, 0, 80, "5",true, false,"","3db4c5da-f7ff-4864-a586-a475d5506935","3db4c5da-f7ff-4864-a586-a475d5506935","0c5f379c-bbfe-41a8-a37b-8d1e26c9b255");
         
			GridControlBuilder.GridTextBoxColumnBuilder((IUFTextBoxColumn)column,"",TextAlign.Left, false,"",false,"1","1","5") ;          
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"ContractNo0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["ContractNo"]/*ContractNo*/,"ContractNo", false, true, true, false, false, true, 0, 80, "5",true, false,"","625e0d92-d48e-487a-a5fb-b736db093ae8","625e0d92-d48e-487a-a5fb-b736db093ae8","bb6c3484-9b34-4cb0-ac1c-8a9e992f8a15");
         
			GridControlBuilder.GridTextBoxColumnBuilder((IUFTextBoxColumn)column,"",TextAlign.Left, false,"",false,"1","1","5") ;          
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"CarType0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["CarType"]/*CarType*/,"CarType", false, true, true, false, false, true, 0, 80, "5",true, false,"","047ccadc-6f52-44ed-92a8-93877e4a298a","047ccadc-6f52-44ed-92a8-93877e4a298a","d5712db4-b277-425d-a2a7-213eac78d5d0");
	        ...
	        private void _BuilderControl_MatchTypeRadioBoxList(IUFContainer container)
        {
            ...
            listItem = UIControlBuilder.BuildListItem(container,"0", true,false,"130bc338-9958-4133-9b7f-9c185bc2455a","b8ed1e56-dffc-407a-8c2b-e90404da9c1e");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"1", true,false,"49790074-95af-497d-ae37-16bb697f3ce6","b2cce670-14e7-4df8-88e4-9dde8d35727b");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"2", true,true,"517d6f15-ca0d-4e3b-aa58-3c85a5b2ae66","7df91c4a-90cb-4fb0-92cb-418edba26c15");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"3", true,false,"ea7795fe-8961-4c3f-8ed1-b5128be2cd75","d2cc252a-fcfb-4a9f-bc31-8bd2b8dcd939");
            _UFListControl.Items.Add(listItem);
        }
