...
/***********************************************************************************************
 * Form ID:d9fe6a38-ce7d-4178-b66a-db6fed3dfee8 
 * Form Name:DocumentTypeRef
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace DocumentTypeRef
{
	[FormRegister("UFIDA.U9.Cust.XMJL.UI","DocumentTypeRef.DocumentTypeRefWebPart", "UFIDA.U9.Cust.XMJL.UI.WebPart", "d9fe6a38-ce7d-4178-b66a-db6fed3dfee8","WebPart", "False", 580, 408)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.XMJL.UI', 'DocumentTypeRef.DocumentTypeRefWebPart', 'UFIDA.U9.Cust.XMJL.UI.WebPart', 'd9fe6a38-ce7d-4178-b66a-db6fed3dfee8')
	///<siteMapNode url="~/erp/simple.aspx?lnk=d9fe6a38-ce7d-4178-b66a-db6fed3dfee8" title="DocumentTypeRef"/>
    public partial class DocumentTypeRefWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(DocumentTypeRefWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new DocumentTypeRefAction Action
		{
			get { return (DocumentTypeRefAction)base.Action; }
			set { base.Action = value; }
		}
		DocumentTypeRefModel _uimodel=null;
		public new DocumentTypeRefModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new DocumentTypeRefModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as DocumentTypeRefModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public DocumentTypeRefWebPart()
        {
            FormID = "d9fe6a38-ce7d-4178-b66a-db6fed3dfee8";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new DocumentTypeRefModel();
				}
			...
			else
			{
				...
				//去除.已经移入到OnInit()中.
				//this.Model = (DocumentTypeRefModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new DocumentTypeRefAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"DocumentTypeRef",true,580,408);
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card4",false,"none", true, true, "1","","523202bc-6a27-4250-a8f7-9045d9171fec");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 45, 20, 0, 0, 1, 1, "100","9bf97f14-74b9-4a4f-b2fc-d5bfb9c95e3a","9cf230aa-12eb-4ac6-927f-20fb3dc1e54f");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "0");		
		        ...
		        this.SelectList = UIControlBuilder.BuilderDropDownList(_UFCard, "SelectList", "", true,  true, true, "Left", 0, 60, 0, 120, 20, 2, 0, 1, 1, "100",true,false,"","","b7704a28-e27a-4f1d-881b-f8da3f7b24dd");
			...
			UIControlBuilder.BuilderUFControl(this.WizardControl0, "2");		
				...
				this.lblContinueCheckBox = UIControlBuilder.BuilderUFLabel(_UFCard, "lblContinueCheckBox", "", "False", "True", "Right", 80, 20, 6, 0, 1, 1, "100","0aead14b-b05a-4582-9aca-34da4f4bf7a0","6feeae14-6f33-40d8-ac0b-1623afa154cb");
			...
			UIControlBuilder.BuilderUFControl(this.lblContinueCheckBox, "3");		
				...
				this.ContinueCheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "ContinueCheckBox", false, true, "Left", 60, 0, 30, 20, 8, 0, 1, 1, "100",true,"lblContinueCheckBox","","c48d7860-541e-4a70-b0b4-da24ab16db4a");
			...
			UIControlBuilder.BuilderUFControl(this.ContinueCheckBox, "4");		
				...
				this.FindButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "FindButton", true, true, 60, 20, 10, 0, 1, 1, "100","R", this.Model.ElementID,"",false,"27621430-7bc7-4c0e-979e-f0108439d13e","27621430-7bc7-4c0e-979e-f0108439d13e","d74dc60f-4576-4014-861f-b06049959d9c");
			...
			UIControlBuilder.BuilderUFControl(this.FindButton, "4");		
				...
				this.CheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "CheckBox", false, true, "Left", 60, 0, 30, 20, 0, 0, 1, 1, "100",false,"","","497ee8ef-fd3f-44f7-85c6-243993a99948");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card6",false,"FunctionBar", true, true, "0","","e344694c-c1eb-40a5-b7bb-033485938c01");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"CardForRefQueryCase",false,"none", true, true, "0","","1fce6d30-2881-43a1-a84f-94e5754645de");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.QryButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "QryButton", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"",false,"3664768b-36ca-44ab-9583-8d85fb432e43","3664768b-36ca-44ab-9583-8d85fb432e43","800c3f37-b381-41b1-967c-7885ee52b58b");
			...
			UIControlBuilder.BuilderUFControl(this.QryButton, "1");		
				...
				this.lbCase = UIControlBuilder.BuilderUFLabel(_UFCard, "lbCase", "", "True", "True", "Right", 80, 20, 3, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","87ece4da-8a54-4797-ab93-58c88072e0c1");
			...
			UIControlBuilder.BuilderUFControl(this.lbCase, "1");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 150, 20, 5, 0, 1, 1, "100",true,false,"","","0c515fb8-9a70-44a0-b835-edd44400b186");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card1",false,"none", true, true, "0","","36c94eb0-594f-4aa6-be89-22c92c66c105");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.ConfirmButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "ConfirmButton", true, true, 80, 20, 0, 0, 1, 1, "100","O", this.Model.ElementID,"",false,"626ebf9b-f65a-4dd5-8f32-96f84919878c","626ebf9b-f65a-4dd5-8f32-96f84919878c","43d89bae-3293-47da-b846-b73b922b51cd");
			...
			UIControlBuilder.BuilderUFControl(this.ConfirmButton, "3");		
				...
				this.CancelButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "CancelButton", true, true, 80, 20, 2, 0, 1, 1, "100","C", this.Model.ElementID,"",false,"020a5365-8f12-4970-b8df-17ce3ae60a68","020a5365-8f12-4970-b8df-17ce3ae60a68","171d0c19-e886-47b5-a4bf-76ad17d94944");
        ...
        private void _BuilderControl_DataGrid(IUFContainer container)
        {
			...
			InitViewBindingContainer(this, _UFGrid,  this.Model.cRef, "cRef", "", null, 13, "单据类型");
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"ID0","NumberColumnModel", "", 0,this.Model.cRef.Fields["ID"]/*ID*/,"ID", true, false, true, false, false, true, 7, 80, "8",true, false,"","a847da09-d041-4d3b-8b18-8325c202d5e4","a847da09-d041-4d3b-8b18-8325c202d5e4","50ae6316-54e7-4f2c-895c-59e322941cb3");
    ...
    if (this.UseQueryCase && UFIDA.UBF.Query.CommonService.RefQueryHelper.QueryCaseExist(this.Action, null))
    {
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"Code0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["Code"]/*Code*/,"Code", false, true, true, false, false, true, 0, 80, "5",true, false,"","f123912d-554c-4d4a-84c1-17c051466005","f123912d-554c-4d4a-84c1-17c051466005","8403c90b-ce7a-4a69-a262-d73625b0fa4e");
         
			GridControlBuilder.GridTextBoxColumnBuilder((IUFTextBoxColumn)column,"",TextAlign.Left, false,"",false,"1","1","5") ;          
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"Name0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["Name"]/*Name*/,"Name", false, true, true, false, false, true, 0, 120, "5",true, true,"","fc4b042e-d858-444f-880e-f3c2a2bf4e91","fc4b042e-d858-444f-880e-f3c2a2bf4e91","5d74c93c-5bdd-4875-995e-7931c0d2a853");
	        ...
	        private void _BuilderControl_MatchTypeRadioBoxList(IUFContainer container)
        {
            ...
            listItem = UIControlBuilder.BuildListItem(container,"0", true,false,"130bc338-9958-4133-9b7f-9c185bc2455a","a736c902-eee3-4910-9cbe-79c1feffd449");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"1", true,false,"49790074-95af-497d-ae37-16bb697f3ce6","bee704a8-29b3-427c-a3e5-8a4695b06533");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"2", true,true,"517d6f15-ca0d-4e3b-aa58-3c85a5b2ae66","38aa4f39-030d-43fb-be9f-1067ca812fb1");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"3", true,false,"ea7795fe-8961-4c3f-8ed1-b5128be2cd75","e23f4c19-596e-4690-ae36-f7c8cfe167a1");
            _UFListControl.Items.Add(listItem);
        }
