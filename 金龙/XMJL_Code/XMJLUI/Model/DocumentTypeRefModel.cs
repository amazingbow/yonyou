...
{
	[Serializable]
	public partial class DocumentTypeRefModel : UIModel
	{
		#region Constructor
		public DocumentTypeRefModel() : base("DocumentTypeRef")
		{
			InitClass();
			this.SetResourceInfo("d9fe6a38-ce7d-4178-b66a-db6fed3dfee8");
            try{
			    AfterInitModel();
		...
		//just for Clone 
		private DocumentTypeRefModel(bool isInit) : base("DocumentTypeRef")
		{}
		protected override IUIModel CreateCloneInstance()
		{
			return new DocumentTypeRefModel(false);
		}
		#endregion
		#region member
		#region views
		...
		private void InitClass()
		{
			...
			this.viewcRef.SetResourceInfo("58398aca-fb3a-4a27-a2e9-0b1db611e4ae");
	...
	{
		#region Constructor
		public cRefView(IUIModel model) : base(model,"cRef","UFIDA.U9.Cust.XMJL.DocumentTypeBE.Cust_Xmjl_DocumentType", true)
		{
			InitClass();
		}
		//构造空实例,不进行初始化.目前为Clone使用.
		private cRefView():base(null,"cRef","UFIDA.U9.Cust.XMJL.DocumentTypeBE.Cust_Xmjl_DocumentType", true)
		{
		}
		...
		private void InitClass()
		{
			UIModelRuntimeFactory.AddNewUIField(this,"ID", typeof(Int64), false,"","System.Int64", "ID", true,true, false, "",false,(UIFieldType)1,"ba391065-6c27-4c82-acc8-b52b1c93a910","a847da09-d041-4d3b-8b18-8325c202d5e4");
			UIModelRuntimeFactory.AddNewUIField(this,"Code", typeof(String), false,"","System.String", "Code", true,true, false, "",false,(UIFieldType)1,"3d174255-fd12-47f7-8844-3b5e4fae9e8c","f123912d-554c-4d4a-84c1-17c051466005");
			UIModelRuntimeFactory.AddNewUIField(this,"Name", typeof(String), true,"","System.String", "Name", true,true, false, "",true,(UIFieldType)1,"3d174255-fd12-47f7-8844-3b5e4fae9e8c","fc4b042e-d858-444f-880e-f3c2a2bf4e91");
