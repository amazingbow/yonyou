...
namespace UFIDA.U9.Cust.XMQX.LaserLabScrapUI.LaserLabScrapUIModel
{
	...
	//获取档案版型结果: 
        ...
        private IUFCard _BuilderControl_Card0(IUFContainer container)
        {
			...
			UIControlBuilder.BuilderUFControl(this.TabControl2, "0");		
        ...
        {
            IUFTabControl _UFTabControl = UIControlBuilder.BuildTabControl(container,"TabControl2",true, true, "0",EventResponseType.Client,990, 498, 1, 1, 1, 1, "100");
        ...
        {
            IUFTabPage _UFTabPage = UIControlBuilder.BuildTabPageControl(container,"TabPage0",true, true, "0","0865b139-18bc-4a1a-978a-78d7c247e1d0","0865b139-18bc-4a1a-978a-78d7c247e1d0");
			...
			UIControlBuilder.BuildContainerGridLayout(_UFTabPage, 10,new GridColumnDef[]{new GridColumnDef(1,bool.Parse("False")),new GridColumnDef(100,bool.Parse("True")),new GridColumnDef(100,bool.Parse("True")),new GridColumnDef(15,bool.Parse("True")),new GridColumnDef(120,bool.Parse("True")),new GridColumnDef(80,bool.Parse("True")),new GridColumnDef(40,bool.Parse("True")),new GridColumnDef(40,bool.Parse("True")),new GridColumnDef(100,bool.Parse("True")),new GridColumnDef(100,bool.Parse("True")),new GridColumnDef(10,bool.Parse("True")),new GridColumnDef(100,bool.Parse("True")),new GridColumnDef(10,bool.Parse("True")),new GridColumnDef(100,bool.Parse("True")),new GridColumnDef(49,bool.Parse("True")),new GridColumnDef(1,bool.Parse("False")),},new GridRowDef[]{new GridRowDef(7,bool.Parse("False")),new GridRowDef(20,bool.Parse("True")),new GridRowDef(20,bool.Parse("True")),new GridRowDef(25,bool.Parse("True")),new GridRowDef(20,bool.Parse("True")),new GridRowDef(25,bool.Parse("True")),new GridRowDef(20,bool.Parse("True")),new GridRowDef(25,bool.Parse("True")),new GridRowDef(20,bool.Parse("True")),new GridRowDef(25,bool.Parse("True")),new GridRowDef(20,bool.Parse("True")),new GridRowDef(25,bool.Parse("True")),new GridRowDef(30,bool.Parse("True")),new GridRowDef(20,bool.Parse("True")),new GridRowDef(6,bool.Parse("False")),});
            ///foreach UFTab下的所有控件，增加到此容器
				...
				this.Line0 = UIControlBuilder.BuilderUFLine(_UFTabPage, "Line0", 455, "Horizontal", "True", 455, 20, 1, 1, 6, 1, "100","152207fd-5be3-4292-b431-2f799a017ba5","152207fd-5be3-4292-b431-2f799a017ba5");
			...
			UIControlBuilder.BuilderUFControl(this.Line0, "0");		
				...
				this.lblBN474 = UIControlBuilder.BuilderUFLabel(_UFTabPage, "lblBN474", "", "True", "True", "Right", 100, 25, 2, 3, 1, 1, "100","4c975f61-f4ee-4caf-9876-9b4359d7b26b","0cbd184c-0c2a-4dc6-ae69-3e6e9e0e6e6c");
			...
			UIControlBuilder.BuilderUFControl(this.lblBN474, "1");		
				...
				this.BN474 = UIControlBuilder.BuilderTextBox(_UFTabPage, "BN474", "True", "True", "True", "False", "Left", 0, 60, 0, 120, 25, 4, 3, 1, 1, "False", "100"
			...
			UIControlBuilder.BuilderUFControl(this.BN474, "2");		
				...
				this.lblType63 = UIControlBuilder.BuilderUFLabel(_UFTabPage, "lblType63", "", "True", "True", "Right", 100, 25, 2, 5, 1, 1, "100","1376e7c4-a051-4ef9-94ac-d83c5c695bff","29aa0577-9acb-4284-8613-381e75f008c2");
			...
			UIControlBuilder.BuilderUFControl(this.lblType63, "3");		
				...
				this.Type63 = UIControlBuilder.BuilderTextBox(_UFTabPage, "Type63", "True", "True", "True", "False", "Left", 0, 60, 0, 120, 25, 4, 5, 1, 1, "False", "100"
			...
			UIControlBuilder.BuilderUFControl(this.Type63, "4");		
				...
				this.lblDate69 = UIControlBuilder.BuilderUFLabel(_UFTabPage, "lblDate69", "", "True", "True", "Right", 100, 25, 2, 7, 1, 1, "100","f5c895a7-a541-45fa-903c-d19e4cd80716","a5fce98b-ae3f-4142-a718-9a817feaaadc");
			...
			UIControlBuilder.BuilderUFControl(this.lblDate69, "5");		
				...
				this.Date69 = UIControlBuilder.BuilderTextBox(_UFTabPage, "Date69", "True", "True", "True", "False", "Left", 0, 60, 0, 120, 25, 4, 7, 1, 1, "False", "100"
			...
			UIControlBuilder.BuilderUFControl(this.Date69, "6");		
				...
				this.lblTime87 = UIControlBuilder.BuilderUFLabel(_UFTabPage, "lblTime87", "", "True", "True", "Right", 100, 25, 2, 9, 1, 1, "100","6e0ea9cb-85bd-490b-8fb6-b5bb626ca104","738624df-98b0-4abf-a803-1ebd3197f968");
			...
			UIControlBuilder.BuilderUFControl(this.lblTime87, "7");		
				...
				this.Time87 = UIControlBuilder.BuilderTextBox(_UFTabPage, "Time87", "True", "True", "True", "False", "Left", 0, 60, 0, 120, 25, 4, 9, 1, 1, "False", "100"
			...
			UIControlBuilder.BuilderUFControl(this.Time87, "8");		
				...
				this.lblCP84 = UIControlBuilder.BuilderUFLabel(_UFTabPage, "lblCP84", "", "True", "True", "Right", 100, 25, 2, 11, 1, 1, "100","fe731b05-c454-4322-b510-1193e7616022","ddff217d-86b9-48e8-a8e9-88268bc02184");
			...
			UIControlBuilder.BuilderUFControl(this.lblCP84, "9");		
				...
				this.CP84 = UIControlBuilder.BuilderTextBox(_UFTabPage, "CP84", "True", "True", "True", "False", "Left", 0, 60, 0, 120, 25, 4, 11, 1, 1, "False", "100"
        ...
        private IUFCard _BuilderControl_Card1(IUFContainer container)
        {
			...
			CommonBuilder.GridLayoutPropBuilder(container, _UFCard, 510, 345, 7, 1, 9, 11, "100");
            CommonBuilder.ContainerGridLayoutPropBuilder(_UFCard, 6, 6, 0, 10, 0, 0, 0, 0);
			InitViewBindingContainer(this, _UFCard,  null, "", "", null, 1, "");
			UIControlBuilder.BuildContainerGridLayout(_UFCard, 10,new GridColumnDef[]{new GridColumnDef(5,bool.Parse("True")),new GridColumnDef(200,bool.Parse("True")),new GridColumnDef(100,bool.Parse("True")),new GridColumnDef(10,bool.Parse("True")),new GridColumnDef(100,bool.Parse("True")),new GridColumnDef(95,bool.Parse("True")),},new GridRowDef[]{new GridRowDef(1,bool.Parse("True")),new GridRowDef(140,bool.Parse("True")),new GridRowDef(25,bool.Parse("True")),new GridRowDef(20,bool.Parse("True")),new GridRowDef(25,bool.Parse("True")),new GridRowDef(20,bool.Parse("True")),});
            this.Card1 = _UFCard;
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label1 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label1", "", "True", "True", "Right", 100, 25, 2, 2, 1, 1, "100","c0aa36d6-8723-4f45-9411-f4872f2d15b3","c0aa36d6-8723-4f45-9411-f4872f2d15b3");
			...
			UIControlBuilder.BuilderUFControl(this.Label1, "0");		
				...
				this.TextBox1 = UIControlBuilder.BuilderTextBox(_UFCard, "TextBox1", "True", "True", "True", "False", "Left", 0, 60, 0, 100, 25, 4, 2, 1, 1, "False", "100"
			...
			UIControlBuilder.BuilderUFControl(this.TextBox1, "1");		
				...
				this.Label2 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label2", "", "True", "True", "Right", 100, 25, 2, 4, 1, 1, "100","ba2c11d8-4af0-4dfb-ba76-b823810b3026","ba2c11d8-4af0-4dfb-ba76-b823810b3026");
			...
			UIControlBuilder.BuilderUFControl(this.Label2, "2");		
				...
				this.DatePicker2 = UIControlBuilder.BuilderDatePicker(_UFCard, "DatePicker2", true, true, true, "DateTime","Left", 0, 60, 0, 100, 25, 4, 4, 1, 1, "100",true,false,"Label2","","acdaa90b-d2f7-4cf2-b6f9-b89546b8dcd2");
        ...
        {
            IUFTabPage _UFTabPage = UIControlBuilder.BuildTabPageControl(container,"TabPage1",true, true, "0","dfd85e7a-e81d-4042-b44c-fc8c468c54bb","dfd85e7a-e81d-4042-b44c-fc8c468c54bb");
			...
			UIControlBuilder.BuildContainerGridLayout(_UFTabPage, 5,new GridColumnDef[]{new GridColumnDef(1,bool.Parse("False")),new GridColumnDef(960,bool.Parse("True")),new GridColumnDef(1,bool.Parse("False")),},new GridRowDef[]{new GridRowDef(1,bool.Parse("True")),new GridRowDef(407,bool.Parse("False")),new GridRowDef(30,bool.Parse("True")),});
            ///foreach UFTab下的所有控件，增加到此容器
        ...
        {
            IUFTabPage _UFTabPage = UIControlBuilder.BuildTabPageControl(container,"TabPage2",true, true, "0","d005d408-2791-4664-a0da-ed5cea5f9e22","d005d408-2791-4664-a0da-ed5cea5f9e22");
            CommonBuilder.ContainerGridLayoutPropBuilder(_UFTabPage, 3, 3, 0, 5, 10, 10, 10, 10);
			InitViewBindingContainer(this, _UFTabPage,  null, "", "", null, 1, "");
