    ...
    public class LookScrapInfoBPStub : OperationStubBase, ILookScrapInfoBP
    {
        ...
        public List<UFIDA.U9.Cust.XMQX.LaserLabBP.LaserLabScrapBP.LookScrapInfoDTOData> DoEx(ICommonDataContract commonData)
        {
            ...
            try
            {
				...
				List<UFIDA.U9.Cust.XMQX.LaserLabBP.LaserLabScrapBP.LookScrapInfoDTOData> listEntityList = new List<UFIDA.U9.Cust.XMQX.LaserLabBP.LaserLabScrapBP.LookScrapInfoDTOData>();
				...
				DoSerializeKey(listEntityList, "UFIDA.U9.Cust.XMQX.LaserLabBP.LaserLabScrapBP.LookScrapInfoBP");
