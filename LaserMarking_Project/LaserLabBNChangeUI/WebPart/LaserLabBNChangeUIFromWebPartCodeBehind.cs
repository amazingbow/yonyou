...
namespace UFIDA.U9.Cust.XMJL.LaserLabBNChangeUI.LaserLabBNChangeUIModel
{
    public partial class LaserLabBNChangeUIFromWebPart
    {
        #region eventBind
				...
				//MethodName:BtnExectue_Click ActionName:
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void BtnExectue_Click(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,BtnExectue_Click_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void BtnExectue_Click_DefaultImpl(object sender, EventArgs e)
        {
        ...
        private void BtnClear_Click_DefaultImpl(object sender, EventArgs e)
        {
			...
			//throw new NotImplementedException() ;
				...
				//MethodName:AllBtnExecute_Click ActionName:
        /// <summary>
        /// Help Info : {varEvent.Help}
        /// </summary>
        public void AllBtnExecute_Click(object sender, EventArgs e)
        {
			...
			this.InvokeMethod(sender,e,AllBtnExecute_Click_Extend) ;
	
			
        }

        //default implement by tpl ...
        private void AllBtnExecute_Click_DefaultImpl(object sender, EventArgs e)
        {
			//Template (tpl) Code here...
