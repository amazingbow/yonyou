...
namespace UFIDA.U9.Cust.HeXingProjectBP.HeXingCreateVoucherBP
{
    ...
    public class CreateVoucherfromSAPStub : OperationStubBase, ICreateVoucherfromSAP
    {
        #region ICreateVoucherfromSAP Members
        ...
        public void DoEx(ICommonDataContract commonData)
        {
            ...
            try
            {
                BeforeInvoke("UFIDA.U9.Cust.HeXingProjectBP.HeXingCreateVoucherBP.CreateVoucherfromSAP");                
                CreateVoucherfromSAP objectRef = new CreateVoucherfromSAP();
            ...
            {
				FinallyInvoke("UFIDA.U9.Cust.HeXingProjectBP.HeXingCreateVoucherBP.CreateVoucherfromSAP");
            }
        }
	#endregion
    }
