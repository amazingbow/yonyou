...
namespace UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV
{
	...
	public  partial class SAPU9GLVoucherDTO  : UFSoft.UBF.Business.DTOBase
	{
		...
		public System.Int32 PostedPeriod
		{
			get	
			{	
				return (System.Int32)base.GetValue("PostedPeriod",typeof(System.Int32));
			}
		...
		/// </summary>
		/// <value></value>
		public List<UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV.SAPU9GLVoucherLineDTO> SAPU9GLVoucherLineDTOS
		{
			get	
			{	
				return (List<UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV.SAPU9GLVoucherLineDTO>)base.GetValue("SAPU9GLVoucherLineDTOS",typeof(List<UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV.SAPU9GLVoucherLineDTO>));
			}
		...
		public void FromEntityData(SAPU9GLVoucherDTOData data,IDictionary dict)
		{
			...
			{	
				List<UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV.SAPU9GLVoucherLineDTO> listSAPU9GLVoucherLineDTOS = new List<UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV.SAPU9GLVoucherLineDTO>();
				foreach(UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV.SAPU9GLVoucherLineDTOData obj in data.SAPU9GLVoucherLineDTOS ){

					UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV.SAPU9GLVoucherLineDTO child = dict[obj] as UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV.SAPU9GLVoucherLineDTO;
					if (child == null)
					{
						child = new UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV.SAPU9GLVoucherLineDTO();
		...
		public SAPU9GLVoucherDTOData ToEntityData(SAPU9GLVoucherDTOData data, IDictionary dict){
			...
			{	
				List<UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV.SAPU9GLVoucherLineDTOData> listSAPU9GLVoucherLineDTOS = new List<UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV.SAPU9GLVoucherLineDTOData>();
				foreach(UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV.SAPU9GLVoucherLineDTO obj in this.SAPU9GLVoucherLineDTOS ){
					if (obj==null) continue ;

					UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV.SAPU9GLVoucherLineDTOData old = dict[obj] as UFIDA.U9.Cust.HXPPSV.CreateSAPVoucherSV.SAPU9GLVoucherLineDTOData;
