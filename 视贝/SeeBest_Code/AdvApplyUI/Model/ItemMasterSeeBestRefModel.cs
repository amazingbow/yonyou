...
{
	[Serializable]
	public partial class ItemMasterSeeBestRefModel : UIModel
	{
		#region Constructor
		public ItemMasterSeeBestRefModel() : base("ItemMasterSeeBestRef")
		{
			InitClass();
			this.SetResourceInfo("40f9b5a0-1f46-4c51-8036-11e1fcd8ab08");
            try{
			    AfterInitModel();
		...
		//just for Clone 
		private ItemMasterSeeBestRefModel(bool isInit) : base("ItemMasterSeeBestRef")
		{}
		protected override IUIModel CreateCloneInstance()
		{
			return new ItemMasterSeeBestRefModel(false);
		}
		#endregion
		#region member
		#region views
		...
		private void InitClass()
		{
			...
			this.viewcRef.SetResourceInfo("db0d55e4-5a8b-4521-aff4-896b4e923ce1");
	...
	public partial class cRefView : UIView
	{
		...
		private void InitClass()
		{
			UIModelRuntimeFactory.AddNewUIField(this,"ID", typeof(Int64), false,"","System.Int64", "ID", true,true, false, "",false,(UIFieldType)1,"ba391065-6c27-4c82-acc8-b52b1c93a910","01798e62-60ff-4a97-816b-31caefd86733");
			UIModelRuntimeFactory.AddNewUIField(this,"Code", typeof(String), false,"","System.String", "Code", true,true, false, "",false,(UIFieldType)1,"3d174255-fd12-47f7-8844-3b5e4fae9e8c","ad98b09f-803c-4b1b-a616-2375da4f12b1");
			UIModelRuntimeFactory.AddNewUIField(this,"Name", typeof(String), false,"","System.String", "Name", true,true, false, "",false,(UIFieldType)1,"3d174255-fd12-47f7-8844-3b5e4fae9e8c","a54b37e2-9022-4479-b9ee-81e44251bdb8");
			UIModelRuntimeFactory.AddNewUIField(this,"Description", typeof(String), true,"","System.String", "Description", true,true, false, "",true,(UIFieldType)1,"3d174255-fd12-47f7-8844-3b5e4fae9e8c","b5ec011c-51f8-4ad6-9f22-5502ab8dbd3a");
