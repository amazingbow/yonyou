...
{
	[Serializable]
	public partial class AdvApplyDocTypeRefModel : UIModel
	{
		#region Constructor
		public AdvApplyDocTypeRefModel() : base("AdvApplyDocTypeRef")
		{
			InitClass();
			this.SetResourceInfo("11ab3eef-9012-47dd-8cc2-f377e148a2c1");
            try{
			    AfterInitModel();
		...
		//just for Clone 
		private AdvApplyDocTypeRefModel(bool isInit) : base("AdvApplyDocTypeRef")
		{}
		protected override IUIModel CreateCloneInstance()
		{
			return new AdvApplyDocTypeRefModel(false);
		}
		#endregion
		#region member
		#region views
		...
		private void InitClass()
		{
			...
			this.viewcRef.SetResourceInfo("fcc1bf42-c1a5-46bf-ac33-e9e4b882581a");
	...
	public partial class cRefView : UIView
	{
		...
		private void InitClass()
		{
			UIModelRuntimeFactory.AddNewUIField(this,"ID", typeof(Int64), false,"","System.Int64", "ID", true,true, false, "",false,(UIFieldType)1,"ba391065-6c27-4c82-acc8-b52b1c93a910","7fd9a776-1f59-4b71-b1fb-c6fc7a327b64");
			UIModelRuntimeFactory.AddNewUIField(this,"AdvDocEnum", typeof(Int32), false,"","UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyDocTypeBE.AdvDocEnum", "AdvDocEnum", true,true, false, "",false,(UIFieldType)2,"5b384422-00ff-4599-9ae5-e1d3f50cfcbe","9e24b83a-9a22-497f-a4d3-58082f27774b");
			UIModelRuntimeFactory.AddNewUIField(this,"Code", typeof(String), false,"","System.String", "Code", true,true, false, "",false,(UIFieldType)1,"3d174255-fd12-47f7-8844-3b5e4fae9e8c","55471368-a6a1-43a7-ad5f-18f0255d6d92");
			UIModelRuntimeFactory.AddNewUIField(this,"Name", typeof(String), true,"","System.String", "Name", true,true, false, "",true,(UIFieldType)1,"3d174255-fd12-47f7-8844-3b5e4fae9e8c","7d1b08c0-9ef2-49d0-b7f8-42a58b8eafe8");
			UIModelRuntimeFactory.AddNewUIField(this,"Org_Code", typeof(String), false,"","System.String", "Org.Code", false,true, false, "",false,(UIFieldType)1,"3d174255-fd12-47f7-8844-3b5e4fae9e8c","84a6aed6-c5df-4cb1-86dc-cc2add887238");
	...
	public class cRefRecord : UIRecord
	{
		...
		{
			get{
				//object value = this[this.uiviewcRef.FieldOrg_Code] ;
				//return (String)value;
				return GetValue<String>(this.uiviewcRef.FieldOrg_Code);
			}
			set{
				this[this.uiviewcRef.FieldOrg_Code] = value;
			}
		}
		#endregion
	}
	...
	public class cRefDefaultFilterFilter : UIFilter
	{
		...
		public cRefDefaultFilterFilter(IUIView view) 
			: base("DefaultFilter",view,@"AdvDocEnum=1",@"")
		{
			InitClass();
		}
