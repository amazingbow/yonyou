...
{
	public partial class AdvApplyUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(AdvApplyUIModelAction));
		//强类型化基类Model属性.
		public new AdvApplyUIModelModel CurrentModel 
		{
			get {
				return (AdvApplyUIModelModel)base.CurrentModel;
			}
			set {
		...
		public AdvApplyUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public AdvApplyUIModelAction(AdvApplyUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 
