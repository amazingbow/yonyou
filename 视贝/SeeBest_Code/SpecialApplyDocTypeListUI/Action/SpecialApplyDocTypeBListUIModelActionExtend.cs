...
{
	public partial class SpecialApplyDocTypeBListUIModelAction 
	{
...
this.OnOutPut_DefaultImpl(sender,e);								
		...
		private void OnGridRowDbClick_Extend(object sender, UIActionEventArgs e)
		{
            ...
            string dataId = this.CurrentModel.SpecialApplyDocType.FocusedRecord["id"].ToString();
            OnNavigatCard("Browse", dataId, "UFIDA.U9.Cust.SpecialApplyUI.SpecialApplyDocTypeURI");
...
this.OnGridRowDbClick_DefaultImpl(sender,e);								
		...
		private void OnNew_Extend(object sender, UIActionEventArgs e)
		{
            ...
            this.CurrentPart.NavigatePage("UFIDA.U9.Cust.SpecialApplyUI.SpecialApplyDocTypeURI", null);
