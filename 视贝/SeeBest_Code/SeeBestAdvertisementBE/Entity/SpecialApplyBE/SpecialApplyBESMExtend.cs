...
namespace UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE
{
    ...
    {
        public partial class SpecialApplyBEStateMachine
        {
            ...
            private State OpenLState_SubmitEventDrivenImp(UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.SubmitEvent ev)
            {
                // To do ...
            ...
            private State ApprovingState_ApproveEventDrivenImp(UFIDA.U9.GeneralEvents.ApprovalResultEvent ev)
            {
                // To do ...
                State toState = CurrentState;
                //TODO:实现转移条件
            ...
            private State ApprovedState_UndoApproveEventDrivenImp(UFIDA.U9.Cust.SeeBestAdvertisementBE.SpecialApplyBE.UndoApproveEvent ev)
            {
                // To do ...
                State toState = CurrentState;
                //TODO:实现转移条件
            ...
            private void ChangeEntityState()
            {
				switch (this.CurrentState)
				{
					case State.OpenLState:
						// To do ...
                        this.Entity.Status = SpecialApplyStatusEnum.OpenL;
						break;
					case State.ApprovingState:
						// To do ...
                        this.Entity.Status = SpecialApplyStatusEnum.Approving;
						break;
					case State.ApprovedState:
						// To do ...
                        this.Entity.Status = SpecialApplyStatusEnum.Approved;
						break;
				}
            }
        }
            ...
            if (args.Length == 1)
            {
                ...
                if (ev != null)
                {
                    if (this.EntityKey.ID == ev.EntityKey.ID)
                    {
                        ...
                        {
                            SpecialApplyBE entity = this.EntityKey.GetEntity() as SpecialApplyBE;
                            entity.StateMachineInstance.ApprovingState_ApproveEventDriven(ev);
