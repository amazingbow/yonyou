...
namespace UFIDA.U9.Cust.SeeBestAdvertisementBE.AdvertisementApproveBE
{
	...
	public partial class UndoApproveEventData : UFSoft.UBF.Eventing.EventData
	{
		...
		/// Default Constructor
		/// </summary>
		//public UndoApproveEventData():this("UFIDA.U9.Cust.SeeBestAdvertisementBE.AdvertisementApproveBE.UndoApproveEvent,UFIDA.U9.Cust.SeeBestAdvertisementBE")
		//{
		//}
		...
		public override string EventType {
			get {
				return "UFIDA.U9.Cust.SeeBestAdvertisementBE.AdvertisementApproveBE.UndoApproveEvent";
			}
		}
