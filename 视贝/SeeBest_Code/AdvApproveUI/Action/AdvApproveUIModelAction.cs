...
{
	public partial class AdvApproveUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(AdvApproveUIModelAction));
		//强类型化基类Model属性.
		public new AdvApproveUIModelModel CurrentModel 
		{
			get {
				return (AdvApproveUIModelModel)base.CurrentModel;
			}
			set {
		...
		public AdvApproveUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public AdvApproveUIModelAction(AdvApproveUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 
