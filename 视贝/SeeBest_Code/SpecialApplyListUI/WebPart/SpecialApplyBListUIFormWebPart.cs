...
namespace UFIDA.U9.Cust.SpecialApplyListUI.SpecialApplyBListUIModel
{
    ...
    public partial class SpecialApplyBListUIFormWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
        ...
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(SpecialApplyBListUIFormWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new SpecialApplyBListUIModelAction Action
		{
			get { return (SpecialApplyBListUIModelAction)base.Action; }
			set { base.Action = value; }
		}
		SpecialApplyBListUIModelModel _uimodel=null;
		public new SpecialApplyBListUIModelModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new SpecialApplyBListUIModelModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as SpecialApplyBListUIModelModel;
            }
        }
		#endregion 
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new SpecialApplyBListUIModelModel();
				}
			...
			{
				//去除.已经移入到OnInit()中.
				//this.Model = (SpecialApplyBListUIModelModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new SpecialApplyBListUIModelAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"SpecialApplyBListUIForm",true,992,504);
