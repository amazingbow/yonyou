...
{
	public partial class SpecialApplyBListUIModelAction 
	{
...
this.OnOutPut_DefaultImpl(sender,e);								
		...
		private void OnGridRowDbClick_Extend(object sender, UIActionEventArgs e)
		{
            ...
            string dataId = this.CurrentModel.SpecialApplyBE.FocusedRecord["mainid"].ToString();
            OnNavigatCard("Browse", dataId, "UFIDA.U9.Cust.SpecialApplyUI.SpecialApplyURI");
...
this.OnGridRowDbClick_DefaultImpl(sender,e);								
		...
		private void OnNew_Extend(object sender, UIActionEventArgs e)
		{
            ...
            this.CurrentPart.NavigatePage("UFIDA.U9.Cust.SpecialApplyUI.SpecialApplyURI", null);
...
this.OnPrint_DefaultImpl(sender,e);								
		...
		private void OnDelete_Extend(object sender, UIActionEventArgs e)
		{
            ...
            listhelper.Delete_Doc(this, e, GetMainID(selectedSecords), "SysVersion", this.CurrentModel.SpecialApplyBE.EntityFullName);
...
this.OnLoadData_DefaultImpl(sender,e);			
        ...
        private string CustomFilterOpath_Extend(string filterOpath)
        {
            if (string.IsNullOrEmpty(filterOpath))
                ...
                filterOpath = filterOpath + " and Org=" + UFIDA.U9.UI.PDHelper.PDContext.Current.OrgID;
