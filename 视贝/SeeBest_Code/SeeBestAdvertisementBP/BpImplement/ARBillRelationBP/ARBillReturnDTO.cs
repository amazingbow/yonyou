...
namespace UFIDA.U9.Cust.SeeBestAdvertisementBP.ARBillRelationBP
{
	...
	/// 
	/// </summary>
	public  partial class ARBillReturnDTO  : UFSoft.UBF.Business.DTOBase
	{
		#region Constructor
		...
		private void DeSerializeKey(ARBillReturnDTOData data)
		{
		...
		/// </summary>
		public void FromEntityData(ARBillReturnDTOData data)
		{
			this.FromEntityData(data,new Hashtable());
		}
		//used by ubf..
		public void FromEntityData(ARBillReturnDTOData data,IDictionary dict)
		{
			if (data == null)
				return;
		...
		/// </summary>
		public ARBillReturnDTOData ToEntityData()
		{
		...
		/// </summary>
		public ARBillReturnDTOData ToEntityData(ARBillReturnDTOData data, IDictionary dict){
			if (data == null)
				data = new ARBillReturnDTOData();
			if (dict == null ) 
				dict = new Hashtable() ;
			else
            {
                ...
                {
                    data = (ARBillReturnDTOData)dict[this];
                    return data;
                }
            }
			dict[this] = data;
