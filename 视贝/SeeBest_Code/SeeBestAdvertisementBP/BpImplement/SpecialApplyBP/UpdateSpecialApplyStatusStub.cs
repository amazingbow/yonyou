...
namespace UFIDA.U9.Cust.SeeBestAdvertisementBP.SpecialApplyBP
{
    ...
    public class UpdateSpecialApplyStatusStub : OperationStubBase, IUpdateSpecialApplyStatus
    {
        #region IUpdateSpecialApplyStatus Members
        ...
        public System.Boolean DoEx(ICommonDataContract commonData, System.Int64 iD, System.Int64 sysVersion)
        {
            ...
            try
            {
                BeforeInvoke("UFIDA.U9.Cust.SeeBestAdvertisementBP.SpecialApplyBP.UpdateSpecialApplyStatus");                
                UpdateSpecialApplyStatus objectRef = new UpdateSpecialApplyStatus();
            ...
            {
				FinallyInvoke("UFIDA.U9.Cust.SeeBestAdvertisementBP.SpecialApplyBP.UpdateSpecialApplyStatus");
            }
        }
	#endregion
    }
