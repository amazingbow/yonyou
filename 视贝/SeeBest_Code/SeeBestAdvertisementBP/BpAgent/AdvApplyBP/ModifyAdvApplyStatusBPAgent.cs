...
namespace UFIDA.U9.Cust.SeeBestAdvertisementBP.AdvApplyBP.Proxy
{
	...
	[Serializable]    
    public class ModifyAdvApplyStatusBPProxy : OperationProxyBase//, UFIDA.U9.Cust.SeeBestAdvertisementBP.AdvApplyBP.Proxy.IModifyAdvApplyStatusBP
    {
	#region Fields	
	...
	#region Constructors
        public ModifyAdvApplyStatusBPProxy()
        {
        }
        #endregion
        ...
        {
  			InitKeyList() ;
 			System.Boolean result = (System.Boolean)InvokeAgent<UFIDA.U9.Cust.SeeBestAdvertisementBP.AdvApplyBP.Proxy.IModifyAdvApplyStatusBP>();
		...
		protected override object InvokeImplement<T>(T oChannel)
        {
            ...
            IModifyAdvApplyStatusBP channel = oChannel as IModifyAdvApplyStatusBP;
            if (channel != null)
            {
