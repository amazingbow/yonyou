/**************************************************************
 * Description:
 * SpecialApplyDocTypeUIModelAction.cs
 * Product: U9
 * Co.    : UFIDA Group
...
{
	public partial class SpecialApplyDocTypeUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(SpecialApplyDocTypeUIModelAction));
		//强类型化基类Model属性.
		public new SpecialApplyDocTypeUIModelModel CurrentModel 
		{
			get {
				return (SpecialApplyDocTypeUIModelModel)base.CurrentModel;
			}
			set {
		...
		public SpecialApplyDocTypeUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public SpecialApplyDocTypeUIModelAction(SpecialApplyDocTypeUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 
