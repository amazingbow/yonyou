...
namespace UFIDA.U9.Cust.SpecialApplyUI.SpecialApplyUIModel
{
    public partial class SpecialApplyUIFormWebPart
    {
        ...
        void UFGridDataGrid14_GridMakePageEventHandler(Object sender, GridMakePageEventArgs  e)
        {
			...
			UFIDA.U9.UI.Commands.CommandFactory.DoCommand("GridMakePage",this.Action,this.DataGrid14,e);
        }
        #endregion

        #region Grid控件DataGrid14的客户化筛选事件	
        void UFGridDataGrid14_GridCustomFilterHandler(Object sender, GridCustomFilterArgs  e)
        {
            //Grid的客户化筛选，首条、上一条、下一条、末条处理逻辑
			UFIDA.U9.UI.Commands.CommandFactory.DoCommand("GridCustomFilter",this.Action,this.DataGrid14,e);
        }
        #endregion
