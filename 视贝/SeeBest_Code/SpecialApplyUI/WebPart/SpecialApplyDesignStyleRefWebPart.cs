...
/***********************************************************************************************
 * Form ID:ec8b028e-04ad-4548-81fc-f65262c2b3bf 
 * Form Name:SpecialApplyDesignStyleRef
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace SpecialApplyDesignStyleRef
{
	[FormRegister("UFIDA.U9.Cust.SpecialApplyUI","SpecialApplyDesignStyleRef.SpecialApplyDesignStyleRefWebPart", "UFIDA.U9.Cust.SpecialApplyUI.WebPart", "ec8b028e-04ad-4548-81fc-f65262c2b3bf","WebPart", "False", 580, 408)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.SpecialApplyUI', 'SpecialApplyDesignStyleRef.SpecialApplyDesignStyleRefWebPart', 'UFIDA.U9.Cust.SpecialApplyUI.WebPart', 'ec8b028e-04ad-4548-81fc-f65262c2b3bf')
	///<siteMapNode url="~/erp/simple.aspx?lnk=ec8b028e-04ad-4548-81fc-f65262c2b3bf" title="SpecialApplyDesignStyleRef"/>
    public partial class SpecialApplyDesignStyleRefWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(SpecialApplyDesignStyleRefWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new SpecialApplyDesignStyleRefAction Action
		{
			get { return (SpecialApplyDesignStyleRefAction)base.Action; }
			set { base.Action = value; }
		}
		SpecialApplyDesignStyleRefModel _uimodel=null;
		public new SpecialApplyDesignStyleRefModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new SpecialApplyDesignStyleRefModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as SpecialApplyDesignStyleRefModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public SpecialApplyDesignStyleRefWebPart()
        {
            FormID = "ec8b028e-04ad-4548-81fc-f65262c2b3bf";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new SpecialApplyDesignStyleRefModel();
				}
			...
			else
			{
				...
				//去除.已经移入到OnInit()中.
				//this.Model = (SpecialApplyDesignStyleRefModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new SpecialApplyDesignStyleRefAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"SpecialApplyDesignStyleRef",true,580,408);
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card4",false,"none", true, true, "1","","01f4fd90-b6d2-4253-80c9-64e4eb702b53");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 45, 20, 0, 0, 1, 1, "100","9bf97f14-74b9-4a4f-b2fc-d5bfb9c95e3a","5dee6f31-c50c-4537-815a-6fd72e747715");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "0");		
		        ...
		        this.SelectList = UIControlBuilder.BuilderDropDownList(_UFCard, "SelectList", "", true,  true, true, "Left", 0, 60, 0, 120, 20, 2, 0, 1, 1, "100",true,false,"","","8e51515c-6f74-4e77-9953-fef2af9faba8");
			...
			UIControlBuilder.BuilderUFControl(this.WizardControl0, "2");		
				...
				this.lblContinueCheckBox = UIControlBuilder.BuilderUFLabel(_UFCard, "lblContinueCheckBox", "", "False", "True", "Right", 80, 20, 6, 0, 1, 1, "100","0aead14b-b05a-4582-9aca-34da4f4bf7a0","a2f8fe26-3b34-4dfd-a779-36987f1854f3");
			...
			UIControlBuilder.BuilderUFControl(this.lblContinueCheckBox, "3");		
				...
				this.ContinueCheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "ContinueCheckBox", false, true, "Left", 60, 0, 30, 20, 8, 0, 1, 1, "100",true,"lblContinueCheckBox","","f04c2fbf-b072-4aff-926b-5f71a0fba281");
			...
			UIControlBuilder.BuilderUFControl(this.ContinueCheckBox, "4");		
				...
				this.FindButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "FindButton", true, true, 60, 20, 10, 0, 1, 1, "100","R", this.Model.ElementID,"",false,"27621430-7bc7-4c0e-979e-f0108439d13e","27621430-7bc7-4c0e-979e-f0108439d13e","4e25d727-e89e-4b11-b3dd-23d620c94628");
			...
			UIControlBuilder.BuilderUFControl(this.FindButton, "4");		
				...
				this.CheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "CheckBox", false, true, "Left", 60, 0, 30, 20, 0, 0, 1, 1, "100",false,"","","9c40d3f5-2553-4d3c-8ad1-a25b82c4e62d");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card6",false,"FunctionBar", true, true, "0","","9d00160a-b8e3-49a0-90ab-981c5164602f");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"CardForRefQueryCase",false,"none", true, true, "0","","1d53cc14-4caa-4e21-ab6c-c805e8c2196c");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.QryButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "QryButton", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"",false,"3664768b-36ca-44ab-9583-8d85fb432e43","3664768b-36ca-44ab-9583-8d85fb432e43","8c8f16e5-c804-454d-9844-0df9a8e3fd83");
			...
			UIControlBuilder.BuilderUFControl(this.QryButton, "1");		
				...
				this.lbCase = UIControlBuilder.BuilderUFLabel(_UFCard, "lbCase", "", "True", "True", "Right", 80, 20, 3, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","53427ea0-3c10-49c3-81b9-844dd18f6dad");
			...
			UIControlBuilder.BuilderUFControl(this.lbCase, "1");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 150, 20, 5, 0, 1, 1, "100",true,false,"","","4b29833e-cade-4a54-8e1d-73f00c79c69a");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card1",false,"none", true, true, "0","","3f616578-f8d3-4bc7-97b6-60febbf88ba8");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.ConfirmButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "ConfirmButton", true, true, 80, 20, 0, 0, 1, 1, "100","O", this.Model.ElementID,"",false,"626ebf9b-f65a-4dd5-8f32-96f84919878c","626ebf9b-f65a-4dd5-8f32-96f84919878c","fbcc73d9-36a9-4394-b6fb-2a22a3c1540c");
			...
			UIControlBuilder.BuilderUFControl(this.ConfirmButton, "3");		
				...
				this.CancelButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "CancelButton", true, true, 80, 20, 2, 0, 1, 1, "100","C", this.Model.ElementID,"",false,"020a5365-8f12-4970-b8df-17ce3ae60a68","020a5365-8f12-4970-b8df-17ce3ae60a68","029b126a-0792-488f-9a37-4a863f61c768");
        ...
        private void _BuilderControl_DataGrid(IUFContainer container)
        {
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"ID0","NumberColumnModel", "", 0,this.Model.cRef.Fields["ID"]/*ID*/,"ID", true, false, true, false, false, true, 7, 80, "8",true, false,"","e2c279cc-630e-4230-8cb9-80dc69cc7725","e2c279cc-630e-4230-8cb9-80dc69cc7725","00bc1e3d-5358-486d-87c3-ddf7eda365cd");
    ...
    if (this.UseQueryCase && UFIDA.UBF.Query.CommonService.RefQueryHelper.QueryCaseExist(this.Action, null))
    {
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"Code0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["Code"]/*Code*/,"Code", false, true, true, false, false, true, 0, 150, "5",true, false,"","aef32f71-7206-4aed-bbf6-1e39dfd7d73d","aef32f71-7206-4aed-bbf6-1e39dfd7d73d","ccf5f7e4-7e93-407c-9ff3-7d4dacb17e53");
         
			GridControlBuilder.GridTextBoxColumnBuilder((IUFTextBoxColumn)column,"",TextAlign.Left, false,"",false,"1","1","5") ;          
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"Name0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["Name"]/*Name*/,"Name", false, true, true, false, false, true, 0, 350, "5",true, true,"","efa422f0-30d2-4541-be51-61eb1a33381d","efa422f0-30d2-4541-be51-61eb1a33381d","0f7da16b-53e0-408b-b275-e74029a2dd90");
	        ...
	        private void _BuilderControl_MatchTypeRadioBoxList(IUFContainer container)
        {
            ...
            listItem = UIControlBuilder.BuildListItem(container,"0", true,false,"130bc338-9958-4133-9b7f-9c185bc2455a","0c2b7208-cd40-4979-972e-6287630e7eb7");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"1", true,false,"49790074-95af-497d-ae37-16bb697f3ce6","5b328f94-8687-4ccf-a206-ed3073cc523e");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"2", true,true,"517d6f15-ca0d-4e3b-aa58-3c85a5b2ae66","8af38f7a-9580-4f0c-b731-d68d47133a2f");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"3", true,false,"ea7795fe-8961-4c3f-8ed1-b5128be2cd75","408963a0-da46-45d3-b57b-43d41d8e2380");
            _UFListControl.Items.Add(listItem);
        }
